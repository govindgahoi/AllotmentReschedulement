    ...
    public partial class UC_DataFacts : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (lblServiceReqNo.Text.Length>0)
            {
                ...
                else if (ServiceId == "1001")
                {
                    ...
                    DataTable temp_notice_details = new DataTable();
                    temp_notice_details.TableName = "temp_notice_details";
                    temp_notice_details.Columns.Add(new DataColumn("NoticeRefNo", typeof(string)));
                    temp_notice_details.Columns.Add(new DataColumn("NoticeDate", typeof(string)));
                    ViewState["temp_notice_details"] = temp_notice_details;
                    temp_notice_details_DataBind();
        ...
        public void GetAllotteeDetailForBuilding()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("DetailsForBuildingPlanLetter '" + lblServiceReqNo.Text + "'", con);
                SqlDataAdapter adp = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
        ...
        protected void check_CheckedChanged(object sender, EventArgs e)
        {
            ...
            GridViewRow row = (GridViewRow)chk.NamingContainer;
            RadioButton ddl2 = (RadioButton)row.FindControl("check");
            ...
            if (ddl2.Checked == true)
            {
                ...
                txtChooseplot.Text = PlotNumber;
                txtChoosePlotArea.Text = PlotArea;
            }
        ...
        protected void LockAllotmentData_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ValidateAllotmnetDataFacts())
                {
                    ...
                    command.Parameters.AddWithValue("@FirstInstallmentDate", txtFirstInstallmentDate.Text);
        ...
        public void temp_notice_details_DataBind()
        {

            DataTable dt = (DataTable)ViewState["temp_notice_details"];
            ...
            if (dt.Rows.Count == 0)
            {
                ...
                dt.Rows.Add(dr);
                gridNotices.DataSource = dt;
                gridNotices.DataBind();
                gridNotices.Rows[0].Visible = false;
                dt.Rows.Clear();
                dt.AcceptChanges();
            }
            else
        ...
        protected void insert_notices_details(object sender, EventArgs e)
        {
            DataTable dt = (DataTable)ViewState["temp_notice_details"];
            
            
            string NoticeRefNo = (gridNotices.FooterRow.FindControl("txtNoticeRefNo_insert") as TextBox).Text.Replace(",", ""); ;
            string NoticeDate  = (gridNotices.FooterRow.FindControl("txtNoticeDate_insert") as TextBox).Text.Replace(",","");
            ...
            if (NoticeRefNo != "")
            {
                if (NoticeDate != "")
                {
                    ...
                    DataRow dr = dt.NewRow();
                    dr["NoticeRefNo"] = NoticeRefNo;
                    dr["NoticeDate"] = NoticeDate;
                    ...
                    ViewState["temp_notice_details"] = dt;
                    temp_notice_details_DataBind();

                }
                else
                {
                    System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "call_show", "alert('Please Provide Notice Ref No');", true);
                    return;
                }
            ...
            {
                System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "call_show", "alert('Please Provide Notice Date');", true);
                return;
            }
        ...
        protected void insert_clause_details(object sender, EventArgs e)
        {
            ...
            string Clause = (ClauseGrid.FooterRow.FindControl("txtClause_insert") as TextBox).Text.Replace(",", ""); ;
        ...
        protected void NoticeDelete_Click(object sender, GridViewDeleteEventArgs e)
        {
            DataTable dt = (DataTable)ViewState["temp_notice_details"];
        ...
        protected void btnLockPlotCancel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable temp = (DataTable)ViewState["temp_notice_details"];
                ...
                if (retVal1 >= 0)
                {
                    ...
                    if (temp.Rows.Count > 0)
                    {
                        ...
                        {
                            string NoticeRefNo = dr1["NoticeRefNo"].ToString();
                            DateTime NoticeDate = Convert.ToDateTime(dr1["NoticeDate"].ToString());


                            objServiceTimelinesBEL.ServiceRequestNO = ServiceRequestNo.Trim();
                            objServiceTimelinesBEL.NoticeRefNo = NoticeRefNo.Trim();
                            objServiceTimelinesBEL.NoticeDate = NoticeDate;


                            retval = objServiceTimelinesBLL.SavePlotNoticesDetails(objServiceTimelinesBEL);
            ...
            try
            {
                ...
                if (dt0.Rows.Count > 0)
                {
                    ...
                    if (dt2.Rows.Count >0)
                    {
                        ...
                        if (ViewState["temp_notice_details"] == null || ViewState["temp_notice_details"].Equals(""))
                        {
                            DataTable temp_notice_details = new DataTable();
                            temp_notice_details.TableName = "temp_notice_details";
                            temp_notice_details.Columns.Add(new DataColumn("NoticeRefNo", typeof(string)));
                            temp_notice_details.Columns.Add(new DataColumn("NoticeDate", typeof(DateTime)));
                            ViewState["temp_notice_details"] = temp_notice_details;

                            ViewState["temp_notice_details"] = dt2;
                            temp_notice_details_DataBind();
                        }
