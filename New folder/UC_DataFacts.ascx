<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_DataFacts.ascx.cs" Inherits="Allotment.UC_DataFacts" %>
...
<div class="row" runat="server" id="TransferDiv" visible="false">
    ...
    <div class="col-md-4 col-sm-4 col-xs-6 check-left">
        <div class="div-checklist assess-min-height" style="border: 1px solid #ccc;">
            <div class="panel-heading font-bold">Clause - I
                <asp:Button runat="server" Text="Save" ID="btn_Submit" CssClass="btn btn-sm btn-primary" OnClick="btn_Submit_Click" Style="float: right; padding: 0px 8px !important;" /></div>
    ...
    <div class="col-md-8 col-sm-8 col-xs-6 check-right">
        <div class="div-assesment-applicant assess-min-height" style="">
            <div class="div-view div-scroll" style="max-height:700px;overflow-y:auto;border: 1px solid #ccc; background: #fff;">
...
<div class="row" runat="server" id="AllotmentDiv" visible="false">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Select Plot For Allotment</h4>
            </div>
                    ...
                    <asp:GridView ID="GridPlot" runat="server"  AutoGenerateColumns="false"
																				...
																				<Columns>
																					...
																					--%>	
                                                                                           ...
                                                                                           <asp:RadioButton runat="server" ID="check" AutoPostBack="true" GroupName="GP" Class="product-list" OnCheckedChanged="check_CheckedChanged" onclick = "RadioCheck(this);" aria-hidden="true"  ToolTip="Click here to Choose Plot " /> 
																						</ItemTemplate>
            ...
            <div class="modal-footer">
                <div class="pull-right border-buttons">
                    ...
                    <button type="button" class="btn btn-primary btn-popup" data-dismiss="modal" style="margin-right: 0;">Cancel</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4 col-sm-4 col-xs-6 check-left">
        <div class="div-checklist assess-min-height" style="border: 1px solid #ccc;">
            <div class="panel-heading font-bold">Facts
                <asp:Button runat="server" Text="Lock Data" ID="LockAllotmentData" CssClass="btn btn-sm btn-primary" OnClick="LockAllotmentData_Click"  Style="float: right;padding: 0px 8px !important;background: #ffc511;color: #000;" /></div>
            <div>
                <div class="panel panel-default"><div class="panel-heading">
                    <!--<div class="col-md-6">Choose Plot to Allot</div>-->
                    <div class="col-md-12">
                        <a href="#" class="btn btn-primary ey-bg btn-sm " style="width:123px;padding: 0px 8px !important;background: #ffc511;color: #000;" data-toggle="modal" data-target="#PlotModal" data-backdrop="static">Choose Plot to Allot</a>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <asp:TextBox ID="txtChooseplot" runat="server" CssClass="PlotNo input-sm similar-select1"  data-toggle="modal" data-target="#PlotModal" data-backdrop="static" disabled></asp:TextBox>
                    </div>
                    <label class="col-md-3">
                        Plot Area
                    </label>
                    ...
                    <div class="row">
                        <div class="col-md-12" style="padding:0px !important;">
                            <table class="table table-striped table-responsive table-bordered table-hover request-table">
                                ...
                                <tr><th colspan="4"><div class="panel-heading font-bold">Clause-3</div></th></tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox runat="server" ID="txtFirstInstallmentDate" Style="font-size:10px;" Enabled="false" CssClass="FirstInstallment input-sm" Width="80%" AutoPostBack="true" OnTextChanged="txtFirstInstallmentDate_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis13" visible="false"></i><i class="fa fa-check" runat="server" id="IApp13" visible="false"></i></td>
                                </tr>
                                 <tr><th colspan="4"><div class="panel-heading font-bold">Clause-3(a)</div></th></tr>
                                ...
                                <tr>
                                 ...
                                 <tr><th colspan="4"><div class="panel-heading font-bold">Clause-4</div></th></tr>
                                ...
                                <tr><th colspan="4"><div class="panel-heading font-bold">Clause-5</div></th></tr>
                                 <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <asp:TextBox runat="server" ID="txtInstallment"  Enabled="false" Width="80%" AutoPostBack="true" OnTextChanged="txtInstallment_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis22" visible="false"></i><i class="fa fa-check" runat="server" id="IApp22" visible="false"></i></td>
                                </tr>
                                 <tr>
                                    <td>Rebate (In %)</td>
                                    <td>
                                 ...
                                 <tr><th colspan="4"><div class="panel-heading font-bold">Clause-7(a)</div></th></tr>
                                 <tr>
                                    <td>Interest (In %)</td>
                                    <td>
                                  ...
                                  <tr><th colspan="4"><div class="panel-heading font-bold">Clause-7(c) & 8(c)</div></th></tr>
                                 <tr>
                                ...
                                <tr><th colspan="4"><div class="panel-heading font-bold">Clause-20 (Lease Rent)</div></th></tr>
                                 <tr style="display:none;">
                                ...
                                <tr style="display:none;">
                                    ...
                                    <td>
                                        <asp:Label ID="lblLeaseRent2" runat="server" CssClass="input-sm similar-select1" onkeypress="return isDecimalKey(event);"></asp:Label></td>
                                    <td>
                                ...
                                <tr><td colspan="4"> <asp:GridView ID="LeaseRentGrid" runat="server" CssClass="table table-striped table-responsive table-bordered table-hover request-table"
                                 ...
                                 <tr><th colspan="4"><div class="panel-heading font-bold">Clause-23</div></th></tr>
                                 <tr>
    ...
    <div class="col-md-8 col-sm-8 col-xs-6 check-right">
        <div class="div-assesment-applicant assess-min-height" style="">
            <div class="div-view div-scroll" style="max-height:900px;overflow-y:auto;border: 1px solid #ccc; background: #fff;">
...
<div  runat="server" id="BuildingDiv" visible="false">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 check-right">
        <div class="div-assesment-applicant assess-min-height" style="">
            <div class="div-view div-scroll" style="max-height:700px;overflow-y:auto;border: 1px solid #ccc; background: #fff;">
                    ...
                    <div class="">
                        <div class="col-md-12" style="padding:0px !important;">
                            ...
                            <div class="Notices_table">
                             <asp:GridView ID="gridNotices" ViewStateMode="Enabled" CssClass="table table-striped table-responsive table-bordered table-hover request-table" ShowFooterWhenEmpty="true" ShowHeaderWhenEmpty="true" runat="server" ShowFooter="true" AutoGenerateColumns="false" OnRowDeleting="NoticeDelete_Click">
																	                            <Columns>
																		                            ...
																		                            <asp:TemplateField HeaderText="Notice Ref No" FooterStyle-CssClass="hide_me">
																			                            ...
																			                            <FooterTemplate>
																				                            <asp:TextBox ID="txtNoticeRefNo_insert" CssClass="input-sm similar-select1" runat="server"></asp:TextBox>
																			                            </FooterTemplate>
																		                            </asp:TemplateField>
																		                            ...
																		                            <asp:TemplateField  HeaderText="Notice Date" FooterStyle-CssClass="hide_me">
																			                            <ItemTemplate>
																				                            <asp:Label ID="lblNoticeDate" runat="server" Text='<%#Eval("NoticeDate") %>'></asp:Label>
																			                            </ItemTemplate>
																			                            <FooterTemplate>
																				                            <asp:TextBox ID="txtNoticeDate_insert" runat="server"  CssClass="input-sm similar-select1"  placeholder="dd/mm/yyyy" ></asp:TextBox>
																			                            </FooterTemplate>
																		                            </asp:TemplateField>
																		                            ...
																		                            <asp:TemplateField FooterStyle-CssClass="hide_me" ItemStyle-CssClass="hide_me" HeaderStyle-CssClass="hide_me">
																			                            ...
																			                            <FooterTemplate>
																				                               <asp:Button runat="server" ID="BtnSave" OnClick="insert_notices_details" CssClass="btn btn-sm btn-primary" Text="Add" Style="padding: 0px 10px !important;" />
                             ...
                             <asp:GridView ID="ClauseGrid" ViewStateMode="Enabled" CssClass="table table-striped table-responsive table-bordered table-hover request-table" ShowFooterWhenEmpty="true" ShowHeaderWhenEmpty="true" runat="server" ShowFooter="true" AutoGenerateColumns="false" OnRowDeleting="ClauseDelete_Click">
																	                            <Columns>
																		                            ...
																		                            <asp:TemplateField HeaderText="Clause" FooterStyle-CssClass="hide_me">
																			                            ...
																			                            <FooterTemplate>
																				                            <asp:TextBox ID="txtClause_insert" Style="height:138px !important;" TextMode="MultiLine" Width="100%" CssClass="input-sm similar-select1 margin-left-z" runat="server"></asp:TextBox>
																			                            </FooterTemplate>
																		                            </asp:TemplateField>
...
<script>
    ...
    function AnyChangeCallMe() {
        ...
        var SystemPlotSize = (isNaN(parseFloat($(".SystemPlotSize").text()))) ? 0 : parseFloat($(".SystemPlotSize").text());
        var ChoosenSize = (isNaN(parseFloat($(".PlotSize").val()))) ? 0 : parseFloat($(".PlotSize").val());


        var LeaseRent1 = (isNaN(parseInt($(".LeaseRent1").val()))) ? 0 : parseInt($(".LeaseRent1").val());
        var LeaseRent2 = (isNaN(parseInt($(".LeaseRent2").val()))) ? 0 : parseInt($(".LeaseRent2").val());
        var LeaseRent3 = (isNaN(parseInt($(".LeaseRent3").val()))) ? 0 : parseInt($(".LeaseRent3").val());
       ...
       // var PrePercentage = (parseFloat(EmdRatePer) + parseFloat(ReservationMoneyPer)).toFixed(2);
        ...
        var totalPremium = RateofPlot * PlotSize;

        var Reservationamount = (totalPremium) * ((ReservationMoneyPer - EmdRatePer) / 100);
        ...
        $(".lblPlotNo").html(PlotNo.toString());
        ...
        $(".ChargePer").html(ChargePer);
        $(".RemPremiumPer").html(RemPremiumPer);
        $(".Depreciation").html(Depreciation);
        $(".LeaseRent1").html(LeaseRent1);
        $(".LeaseRent2").html(LeaseRent2);
        $(".LeaseRent3").html(LeaseRent3);
    ...
    function RadioCheck(rb) {
        ...
        var gv = document.getElementById("<%=GridPlot.ClientID%>");
