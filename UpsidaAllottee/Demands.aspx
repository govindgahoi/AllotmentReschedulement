<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Demands.aspx.cs" Inherits="UpsidaAllottee.Demands" %>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px; font-size: 16px">
                <div style="background: #ececec; margin-top: 0px; padding: 10px 0;">
                  ...
                  <div class="table-responsive" style="overflow-y: auto;  max-height: 390px;">
                      ...
                      <div class="table-responsive" style="overflow-y: auto; max-height: 390px;">
                      <asp:GridView ID="Grid_OTSscheme1" runat="server" BackColor="#ffe6e6"
                          CssClass="table table-striped table-bordered table-hover request-table "
                          ClientIDMode="Static"
                          AllowSorting="True"
                          AutoGenerateColumns="False"
                          DataKeyNames="ComplaintID"
                          GridLines="Horizontal"
                          OnRowDataBound="Grid_OTSscheme1_RowDataBound"
                          OnRowCommand="Grid_OTSschem1_RowCommand"
                          ...
                          <Columns>
                              ...
                              <asp:TemplateField HeaderText="Action" HeaderStyle-HorizontalAlign="Center">
                                  <ItemTemplate>
                                      <asp:HyperLink ID="hlnkView1" Visible="true" Text="View" runat="server"></asp:HyperLink>
                                  </ItemTemplate>
                              </asp:TemplateField>
                              <asp:BoundField DataField="ComplaintID" HeaderText="Complaint ID"  />
                              <%--<asp:BoundField DataField="AllotteeName" HeaderText="Allottee Name" />--%>
                              ...
                              <asp:BoundField DataField="ComplaintDescription" HeaderText="Complaint Description"  />
                               <asp:TemplateField HeaderText="Days Remaining" HeaderStyle-CssClass="text-center-imp" ItemStyle-CssClass="text-center-imp" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                  <ItemTemplate>
                                      <asp:HiddenField ID="DaysStatus1" runat="server" Value='<%# Eval("DaysStatus").ToString()%>' />

                                      <asp:Label ID="IsPositive1" runat="server" Text='<%# Eval("DaysLeft").ToString()%>' CssClass='<%# (Eval("DaysStatus").ToString())=="False" ? "Red"  : "Green" %>'></asp:Label>
                                  </ItemTemplate>
                              </asp:TemplateField>
                              <asp:BoundField DataField="Status" HeaderText="Status"  />
                              <asp:TemplateField>
                                <HeaderStyle />
                                <HeaderTemplate>
                                    <asp:Label ID="hlblimg1" runat="server" Text="Document(Allottee)"></asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblView1"     runat="server" CommandArgument='<%# (Container.DataItemIndex) %>' CommandName="selectDocument"  usesubmitbehavior="true" Text='<i class="fa fa-download" aria-hidden="true"></i>' /> / 
                                    <asp:LinkButton ID="lblView11"    runat="server" CommandArgument='<%# (Container.DataItemIndex) %>' CommandName="ViewDocument"  usesubmitbehavior="true"   Text =''><i class="fa fa-eye" aria-hidden="true"></i></asp:LinkButton> / 
                                   <%-- <asp:LinkButton ID="lbDelete"   runat="server" CommandArgument='<%# (Container.DataItemIndex) %>' CommandName="Delete"      OnClientClick="javascript:return confirm('Are you sure wanted to delete?');"  usesubmitbehavior="true"    Text='<i class="fa fa-times" aria-hidden="true"></i>' />--%>
							...
							<asp:TemplateField>
                                <HeaderStyle />
                                <HeaderTemplate>
                                    <asp:Label ID="hlblimg2" runat="server" Text="Document(RM)"></asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblView2"     runat="server" CommandArgument='<%# (Container.DataItemIndex) %>' CommandName="selectDocument1"  usesubmitbehavior="true" Text='<i class="fa fa-download" aria-hidden="true"></i>' /> / 
                                    <asp:LinkButton ID="lblView22"    runat="server" CommandArgument='<%# (Container.DataItemIndex) %>' CommandName="ViewDocument1"  usesubmitbehavior="true"   Text =''><i class="fa fa-eye" aria-hidden="true"></i></asp:LinkButton> / 
                                   <%-- <asp:LinkButton ID="lbDelete"   runat="server" CommandArgument='<%# (Container.DataItemIndex) %>' CommandName="Delete"      OnClientClick="javascript:return confirm('Are you sure wanted to delete?');"  usesubmitbehavior="true"    Text='<i class="fa fa-times" aria-hidden="true"></i>' />--%>
