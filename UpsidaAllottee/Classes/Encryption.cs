...
namespace Allotment
{
    ...
    {
        private static string encryptionKey = "#UPSIDA@2023knp";
        public  string Encrypt(string clearText)
        {
            ...
            clearText = CompressString(clearText);
            return clearText;
        }
        public  string Decrypt(string cipherText)
        {
            cipherText = DecompressString(cipherText);
