<%@ Page Title="" Language="C#"  ValidateRequest="false"  MasterPageFile="~/MainUser.Master"  EnableViewState="true" CodeBehind="IAServicesAssessment.aspx.cs" Inherits="UpsidaAllottee.IAServicesAssessment" %>
        ...
        $(document).ready(function () {
            ...
            var role = '<%=Session["Type"].ToString()%>';
                 ...
                 $.ajax({
                    ...
                    if (SerArray1[1] == '1012' && response == 'RM') {
                        alert("hello");
                        $('#btnRejectM').show();
                        $('#btnApprove').show();
                    }
