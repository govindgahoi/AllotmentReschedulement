            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="gridView" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField  DataField="EstimatedCostOfProject" HeaderText="Estimated Cost Of Project (In Lacs)" HtmlEncode="true" >
                        <ItemStyle  />
                        </asp:BoundField>
                        <asp:BoundField  DataField="EstimatedEmploymentGeneration" HeaderText="Estimated Employment Generation" HtmlEncode="true" >
                        <ItemStyle  />
                        </asp:BoundField>
                ...
                <asp:Panel ID="pnlAddEdit" runat="server" CssClass="modalPopup" Style="display: block; width:700px;padding:10px; margin:20px 50px 20px 50px;">
                    <div style="text-align:center">
                        <asp:Label Font-Bold="true" ID="Label4" runat="server" Text="UPDATE INFORMATION"></asp:Label>
                    </div>
                    
                    <br />
                    <table id="tblPopup" style="margin:0px 50px 0px 50px;">
                        ...
                        <tr style="padding-bottom:15px">
                            <td>
                                <asp:Label ID="Label10" runat="server" Text="Allottee Letter No"></asp:Label>
                            </td>
                            <td >          
                                <asp:TextBox ID="txtAllotmentletterno" CssClass="form-control" Width="280px" runat="server"></asp:TextBox>
                            </td>                           
                        </tr>
                        ...
                        <tr style="margin-bottom:25px">
                            <td style="width:500px; text-align:left;">
                                <asp:Label ID="Label8" runat="server" Width="300px" Text="Estimated Cost Of the project(In Lacs)"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtestimatedcost"  CssClass="form-control" Width="280px" runat="server"> </asp:TextBox>
                        ...
                        <tr style="margin-bottom:25px">
                            <td>
                                <asp:Label ID="Label9" runat="server" Width="300px" Text="Estimated employment generation"></asp:Label>
                            </td>
                            <td>
                                
                                <asp:TextBox ID="txtestimatedemployment"  CssClass="form-control" Width="280px" runat="server"></asp:TextBox>
                            </td>
                        </tr>
