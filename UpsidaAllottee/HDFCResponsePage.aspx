<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HDFCResponsePage.aspx.cs" Inherits="UpsidaAllottee.HDFCResponsePage" %>
                                            ...
                                            <div class="main-content-inner">
                                                <div class="page-content">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        <div  id="DivP" runat="server" style="padding: 15px 25px; margin: 25px 10%; background: #fbfbfb; border: 1px solid #ccc;">
                                                ...
                                                <asp:Label runat="server" ID="lblUPSIDCTran"   Visible="false"></asp:Label>
                                                 ...
                                                 <div class="text-center">
                                                    <asp:Button ID="btnContinue" runat="server" Text="Continue" class="btn-primary btn-sm ey-bg" OnClick="btnContinue_Click" Enabled="false"  />
                                                 </div>
