<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_DataFacts.ascx.cs" Inherits="UpsidaAllottee.RMPanel.UC_DataFacts" %>
                    ...
                    <div class="">
                        <div class="col-md-12" style="padding: 0px !important;">
                            <table class="table table-striped table-responsive table-bordered table-hover request-table">
                                ...
                                <tr>
                                    <td>Plot No </td>
                                    <td><asp:Label ID="lbblPlotNo" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtPlotNo" Enabled="false" CssClass="PlotNo input-sm" Width="80%" AutoPostBack="true" OnTextChanged="txtVerifiedPlot_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="I1" visible="false"></i><i class="fa fa-check" runat="server" id="I2" visible="false"></i></td>
                                </tr>
                        ...
                        <div class="col-md-12" style="padding: 0px !important;">
                            <table class="table table-striped table-responsive table-bordered table-hover request-table">
                                ...
                                <tr style="display: none;">
                                    <td>Plot No </td>
                                    <td><asp:Label ID="lblPlotNo" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtPlotNoVerified" Enabled="false" CssClass="PlotNo input-sm" Width="80%" AutoPostBack="true" OnTextChanged="txtPlotNoVerified_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis11" visible="false"></i><i class="fa fa-check" runat="server" id="IApp11" visible="false"></i></td>
                                </tr>

                                <tr style="display: none;">
                                    <td>Plot Size (In Sq Mtr)</td>
                                    <td><asp:Label ID="lblPlotArea" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtPlotAreaVerified" Enabled="false" CssClass="input-sm" Width="80%" AutoPostBack="true" OnTextChanged="txtPlotAreaVerified_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis12" visible="false"></i><i class="fa fa-check" runat="server" id="IApp12" visible="false"></i></td>
                                </tr>

                                <tr>
                                    <td>Allotment Date</td>
                                    <td><asp:Label ID="lblAllotmentDate" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtAllotmentDate" CssClass="AllotmentDate input-sm" Width="80%" AutoPostBack="true"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="I5" visible="false"></i><i class="fa fa-check" runat="server" id="I6" visible="false"></i></td>
                                </tr>
                                <tr>
                                    <td>Application Date</td>
                                    <td><asp:Label ID="lblApplicationDate" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtApplicationDate" CssClass="txtApplicationDateNew input-sm" Width="80%" AutoPostBack="true"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="I20" visible="false"></i><i class="fa fa-check" runat="server" id="I30" visible="false"></i></td>
                                </tr>
                                
                                <tr>
                                    <td>Address</td>
                                    <td><asp:Label ID="lblAddress" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtAddress" CssClass="txtAddress input-sm" Width="80%" AutoPostBack="true"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="I33" visible="false"></i><i class="fa fa-check" runat="server" id="I34" visible="false"></i></td>
                                </tr>
                                <tr>
                                    <td>Product</td>
                                    <td><asp:Label ID="lblProduct" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtProduct" CssClass="txtProduct input-sm" Width="80%" AutoPostBack="true"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="I37" visible="false"></i><i class="fa fa-check" runat="server" id="I38" visible="false"></i></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><asp:Label ID="lblFirstInstallmentDate" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtFirstInstallmentDate" Enabled="true" CssClass="txtFirstInstallmentDate input-sm" Width="80%" AutoPostBack="true" OnTextChanged="txtFirstInstallmentDate_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis13" visible="false"></i><i class="fa fa-check" runat="server" id="IApp13" visible="false"></i></td>                                
                                </tr>
                                <tr>
                                    <th colspan="3">
                                ...
                                <tr>
                                    ...
                                    <td><asp:Label ID="lblConstructionValueVerified" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtConstructionValueVerified" Enabled="false" CssClass="ExistingConstructionValue input-sm" Width="80%" AutoPostBack="true" ></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis14" visible="false"></i><i class="fa fa-check" runat="server" id="IApp14" visible="false"></i></td>
                                </tr>
                                <tr>
                                    <th colspan="3">
                                ...
                                <tr>
                                    <td>Rate Of Plot</td>
                                    <td><asp:Label ID="lblPlotRate" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtPlotRate" Enabled="false" CssClass="RateOfPlot input-sm" Width="80%" AutoPostBack="true" OnTextChanged="txtPlotRateVerified_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis15" visible="false"></i><i class="fa fa-check" runat="server" id="IApp15" visible="false"></i></td>
                                </tr>
                                
                                <tr>
                                    <td>Reservation Money (In %)</td>
                                    <td><asp:Label ID="lblReservationMoneyPer" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtReservationMoneyPer" Enabled="false" CssClass="txtTotalReservationMoneyPer input-sm" Width="80%" AutoPostBack="true" OnTextChanged="txtReservationMoneyVerified_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis16" visible="false"></i><i class="fa fa-check" runat="server" id="IApp16" visible="false"></i></td>
                                </tr>
                                <tr>
                                    <td>No.of days to deposit Reservation Money</td>
                                    <td><asp:Label ID="lblReservationMoneyDepositDays" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtReservationMoneyDepositDays" Enabled="false" CssClass="ReservationMoneyDepositDays input-sm" Width="80%" AutoPostBack="true" OnTextChanged="txtEmdDepositDaysVerified_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis18" visible="false"></i><i class="fa fa-check" runat="server" id="IApp18" visible="false"></i></td>
                                </tr>

                                <tr>
                                    <td>EMD Rate (In %)</td>
                                    <td><asp:Label ID="lblEMDRate" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtEMDRate" Enabled="true" CssClass="txtEMDRate input-sm" Width="80%" AutoPostBack="true"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="I71" visible="false"></i><i class="fa fa-check" runat="server" id="I72" visible="false"></i></td>                                    
                                </tr>
                                <tr>
                                    <td>EMD Amount</td>
                                    <td><asp:Label ID="lblEMDAmount" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtEMDAmount" CssClass="TxtEMDAmount input-sm" Width="80%" AutoPostBack="true"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="I69" visible="false"></i><i class="fa fa-check" runat="server" id="I70" visible="false"></i></td>
                                </tr>
                                <tr>
                                    <td>EMD Amount Date</td>
                                    <td><asp:Label ID="lblEMDAmountDate" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtEMDAmountDate" CssClass="txtEMDAmountDate input-sm" Width="80%" AutoPostBack="true"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="I59" visible="false"></i><i class="fa fa-check" runat="server" id="I60" visible="false"></i></td>
                                </tr>                                
                                <tr>
                                    <td>Location Charge (In Rs)</td>
                                    <td><asp:Label ID="lblLocationChargeRate" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtLocationChargeRate" Enabled="false" CssClass="LocationChargeRate input-sm" Width="80%" AutoPostBack="true" OnTextChanged="txtLocationChargeRateVerified_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis19" visible="false"></i><i class="fa fa-check" runat="server" id="IApp19" visible="false"></i>
                                    </td>
                                </tr>
                                <tr style="display:none;">
                                    <td>Location Charge (In %)</td>
                                    <td><asp:Label ID="lblLocationChargePer" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtLocationChargePer" Enabled="false" CssClass="ChargePer input-sm" Width="80%" AutoPostBack="true" OnTextChanged="txtChargePerVerified_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis20" visible="false"></i><i class="fa fa-check" runat="server" id="IApp20" visible="false"></i></td>
                                </tr>
                                <tr>
                                    <th colspan="3">
                                ...
                                <tr>
                                    ...
                                    <td><asp:Label ID="lblRemPremiumPer" runat="server"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtRemPremiumPer" Enabled="false" CssClass="RemPremiumPer input-sm" Width="80%" AutoPostBack="true" OnTextChanged="txtRemPremiumPerVerified_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis21" visible="false"></i><i class="fa fa-check" runat="server" id="IApp21" visible="false"></i></td>
                                </tr>
                                <tr>
                                    <td>No of Installments</td>
                                    <td><asp:Label ID="lblNoInstallment" runat="server" onkeypress="return isDecimalKey(event);"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtNoInstallment"  CssClass="NoOfInsatallment input-sm" Enabled="false" Width="80%" AutoPostBack="true" OnTextChanged="txtInstallment_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis22" visible="false"></i><i class="fa fa-check" runat="server" id="IApp22" visible="false"></i></td>
                                </tr>
                                <tr>
                                    <td>Rebate (In %)</td>
                                    <td><asp:Label ID="lblRebatePer" runat="server" onkeypress="return isDecimalKey(event);"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtRebatePer" CssClass="RebatePer input-sm" Enabled="false" Width="80%" AutoPostBack="true" OnTextChanged="txtRebate_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis221" visible="false"></i><i class="fa fa-check" runat="server" id="IApp221" visible="false"></i></td>
                                </tr>
                                <tr>
                                    <th colspan="3">
                                ...
                                <tr>
                                    <td>Interest (In %)</td>
                                    <td><asp:Label ID="lblInterest" runat="server" onkeypress="return isDecimalKey(event);"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtInterestRate" CssClass="IntrestRatePer input-sm" Enabled="false" Width="80%" AutoPostBack="true" OnTextChanged="txtInterestRate_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis23" visible="false"></i><i class="fa fa-check" runat="server" id="IApp23" visible="false"></i></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><asp:Label ID="lblDepreciation" runat="server" onkeypress="return isDecimalKey(event);"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtDepreciation" CssClass="Depreciation input-sm" Enabled="false" Width="80%" AutoPostBack="true" OnTextChanged="txtDepreciation_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis24" visible="false"></i><i class="fa fa-check" runat="server" id="IApp24" visible="false"></i></td>
                                </tr>
                                ...
                                <tr >
                                    ...
                                    <td><asp:Label ID="lblLeaseRent1" runat="server" onkeypress="return isDecimalKey(event);"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtLeaseRent1" CssClass="LeaseRent1 input-sm" Enabled="false" Width="80%" AutoPostBack="true" OnTextChanged="txtLeaseRent1_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis25" visible="false"></i><i class="fa fa-check" runat="server" id="IApp25" visible="false"></i></td>
                                </tr>
                                <tr >
                                    <td>Lease Rent (31-60 years)</td>
                                    <td><asp:Label ID="lblLeaseRent2" runat="server" onkeypress="return isDecimalKey(event);"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtLeaseRent2" CssClass="LeaseRent2 input-sm" Enabled="false" Width="80%" AutoPostBack="true" OnTextChanged="txtLeaseRent2_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis26" visible="false"></i><i class="fa fa-check" runat="server" id="IApp26" visible="false"></i></td>
                                </tr>
                                <tr >
                                    <td>Lease Rent (61-90 years)</td>
                                    <td><asp:Label ID="lblLeaseRent3" runat="server" onkeypress="return isDecimalKey(event);"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtLeaseRent3" CssClass="LeaseRent3 input-sm" Enabled="false" Width="80%" AutoPostBack="true" OnTextChanged="txtLeaseRent3_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis27" visible="false"></i><i class="fa fa-check" runat="server" id="IApp27" visible="false"></i></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><asp:Label ID="lblCoveredArea" runat="server" CssClass="input-sm similar-select1" onkeypress="return isDecimalKey(event);"></asp:Label></td>
                                    <td><asp:TextBox runat="server" ID="txtCoveredArea" CssClass="CoveredArea input-sm" Enabled="false" Width="80%" AutoPostBack="true" OnTextChanged="txtCoveredArea_TextChanged"></asp:TextBox>&nbsp;<i class="fa fa-times" runat="server" id="IDis28" visible="false"></i><i class="fa fa-check" runat="server" id="IApp28" visible="false"></i></td>
                                </tr>
