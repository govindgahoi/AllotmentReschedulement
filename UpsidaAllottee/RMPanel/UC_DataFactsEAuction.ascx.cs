...
namespace UpsidaAllottee.RMPanel
{
    ...
    public partial class UC_DataFactsEAuction : System.Web.UI.UserControl
    {
        SqlConnection con;
        ...
        public void GetAllotteeDetail()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("usp_mappedRecord '" + lblServiceReqNo.Text + "'", con);
        ...
        public void GetAllotteeDetailForAllotment()
        {
            ...
            try
            {
                ...
                { cmd = new SqlCommand("Sp_RMofficedetails'" + lblServiceReqNo.Text + "'", con); }
                ...
                if (dt1.Rows.Count > 0)
                {
                    ...
                    txtChooseplot.Text = dt1.Rows[0]["PlotNumber"].ToString();
                    ...
                    htmlContent = htmlContent.Replace("{{lblRebate}}", txtRebate.Text);
        ...
        public void GetAllotmentletterAllotment()
        {
            string htmlContent = "";
...
<table Class='table table-hover table-bordered request-table' style='width:100%;'>
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (strSender == "NewSystem")
                    { command = new SqlCommand(@"[Sp_InsertServiceCustomSetApplicantDataNewEAuction]", con, transaction); }
        ...
        public void disableallcontrol()
        {
            ...
            txtLeaseRent2.Enabled = false;
            txtLeaseRent3.Enabled = false;
            txtPoductionStartPeriod.Enabled = false;
        }
        ...
        protected void LockAllotmentData_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ValidateAllotmnetDataFacts())
                {
                    ...
                    if (strSender == "NewSystem")
                    { command = new SqlCommand(@"[InsertAndUpdateProcedureE_Auctionservice]", con, transaction); }

                    else { command = new SqlCommand(@"[Sp_InsertServiceCustomSetApplicantDataAllottment]", con, transaction); }
                   
                    DateTime datetime = DateTime.ParseExact(txtFirstInstallmentDate.Text, "dd/MM/yyyy", null);
                    datetime = Convert.ToDateTime(datetime, System.Globalization.CultureInfo.GetCultureInfo("hi-IN").DateTimeFormat);

                    command.CommandType = CommandType.StoredProcedure;


                    string E_AuctionServiceReqNo = "SER/EAUC/" + ServiceRequestNo;
                    command.Parameters.AddWithValue("@ServiceRequestNo", E_AuctionServiceReqNo);
                    command.Parameters.AddWithValue("@IAId", int.Parse(ServiceRequestNo));
                    command.Parameters.AddWithValue("@PlotNo", txtChooseplot.Text);
                    command.Parameters.AddWithValue("@PlotSize", Convert.ToDouble(txtChoosePlotArea.Text));
                    ...
                    command.Parameters.AddWithValue("@LocationChage", txtChargePerVerified.Text);
                     command.Parameters.AddWithValue("@FirstInstallmentDate", datetime);
                    ...
                    command.Parameters.AddWithValue("@ProductionStarPeriod", txtPoductionStartPeriod.Text.Trim());
                    command.Parameters.AddWithValue("@EAuctionid", int.Parse(ServiceRequestNo));
                    ...
                    //        command = new SqlCommand(@"[Sp_InsertServiceCustomTrasferLeaseData]", con, transaction);
                    //        command.CommandType = CommandType.StoredProcedure;
                    //        command.Parameters.AddWithValue("@ServiceReqNo", Convert.ToString(lblServiceReqNo.Text));
                    //        command.Parameters.AddWithValue("@Rate", Rate);
                    //        command.Parameters.AddWithValue("@MinPeriod", MinPeriod);
                    //        command.Parameters.AddWithValue("@MaxPeriod", MaxPeriod);
                    //        command.Parameters.AddWithValue("@CreatedBy", UserName);
                ...
                if (transactionResult)
                {
                    ...
                    System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "call_show", "alert('" + message + "');", true);
                    //Response.Write("<script>alert('Data Facts Locked Successfully');</script>");
                    //disableallcontrol();
        ...
        protected void txtAddress_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                IDis29.Visible = true;
                IApp29.Visible = false;
            }
            else
            {
                IDis29.Visible = false;
                IApp29.Visible = true;
            }
        }
        ...
        protected void txtProduct_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                IDis30.Visible = true;
                IApp30.Visible = false;
            }
            else
            {
                IDis30.Visible = false;
                IApp30.Visible = true;
            }
        }
    }
