...
{
    public partial class UC_DataFacts : System.Web.UI.UserControl
    {
        SqlConnection con;
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            if (lblServiceReqNo.Text.Length > 0)
            {
                ...
                if (ServiceId == "1000")
                {
                    ...
                    AllotmentDiv.Visible = true;
                    BuildingDiv.Visible = false;
                    GetAllotteeDetailForAllotment();
        ...
        public void GetAllotteeDetailForAllotment()
        {
            ...
            try
            {
                ...
                { cmd = new SqlCommand("GetAllotmentLetterAuction'" + lblServiceReqNo.Text + "'", con); }
                ...
                if (dt8.Rows.Count > 0)
                {
                    //DataTable rate1 = dt8.Select("MinPeriod=1 and MaxPeriod=30").CopyToDataTable();
                    //lblLeaseRent1.Text = rate1.Rows[0]["Rate"].ToString();
                    //txtLeaseRent1.Text = rate1.Rows[0]["Rate"].ToString();
                    //DataTable rate2 = dt8.Select("MinPeriod=31 and MaxPeriod=60").CopyToDataTable();
                    //txtLeaseRent2.Text = rate2.Rows[0]["Rate"].ToString();
                    //lblLeaseRent2.Text = rate2.Rows[0]["Rate"].ToString();
                    //DataTable rate3 = dt8.Select("MinPeriod=61 and MaxPeriod=90").CopyToDataTable();
                    //txtLeaseRent3.Text = rate3.Rows[0]["Rate"].ToString();
                    //lblLeaseRent3.Text = rate3.Rows[0]["Rate"].ToString();

                    string RegionalOffice = dt8.Rows[0]["RegionalOffice"].ToString();
                    string OfficeAddress1 = dt8.Rows[0]["OfficeAddress1"].ToString();
                    string OfficeAddress2 = dt8.Rows[0]["OfficeAddress2"].ToString();
                    string OfficePhone = dt8.Rows[0]["OfficePhoneNo"].ToString();
                    string OfficeEmailId = dt8.Rows[0]["OfficeEmailId"].ToString();
                    string RefNo = dt8.Rows[0]["Auction_No"].ToString();
                    string IAName = dt8.Rows[0]["IAName"].ToString();

                    string AllotmentDate = dt8.Rows[0]["AllotmentDate"].ToString();
                    lblAllotmentDate.Text = AllotmentDate;
                    txtAllotmentDate.Text = AllotmentDate;
                    
                    string AllotteeName = dt8.Rows[0]["Winner_Bidder"].ToString();

                    string Address = dt8.Rows[0]["Address"].ToString();
                    lblAddress.Text = Address;
                    txtAddress.Text = Address;
                    
                    string ApplicationDate = dt8.Rows[0]["ApplicationDate"].ToString();
                    lblApplicationDate.Text = ApplicationDate;
                    txtApplicationDate.Text = ApplicationDate;

                    string PlotNo = dt8.Rows[0]["PlotNo"].ToString();
                    lbblPlotNo.Text = PlotNo;
                    txtPlotNo.Text = PlotNo;

                    string PlotSize = dt8.Rows[0]["PlotSize"].ToString();
                    lblPlotArea.Text = PlotSize;

                    string PlotRate = dt8.Rows[0]["PlotRate"].ToString();
                    txtPlotRate.Text = PlotSize;
                    txtPlotRate.Text = PlotSize;

                    string Product = dt8.Rows[0]["Product"].ToString();
                    lblProduct.Text = Product;
                    txtProduct.Text = Product;

                    string FirstInstallmentDate = dt8.Rows[0]["FirstInstallmentDate"].ToString();
                    lblFirstInstallmentDate.Text = FirstInstallmentDate;
                    txtFirstInstallmentDate.Text = FirstInstallmentDate;

                    string ExistingConstructionValue = dt8.Rows[0]["ExistingConstructionValue"].ToString();
                    lblConstructionValueVerified.Text = ExistingConstructionValue;
                    txtConstructionValueVerified.Text = ExistingConstructionValue;

                    string EMDRate = dt8.Rows[0]["EMDRate"].ToString();
                    lblEMDRate.Text = EMDRate;
                    txtEMDRate.Text = EMDRate;

                    string EMDAmount = dt8.Rows[0]["EMDAmount"].ToString();
                    lblEMDAmount.Text = EMDAmount;
                    txtEMDAmount.Text = EMDAmount;

                    string EmdAmountDate = dt8.Rows[0]["EmdAmountDate"].ToString();
                    lblEMDAmountDate.Text = EmdAmountDate;
                    txtEMDAmountDate.Text = EmdAmountDate;

                    string ReservationMoneyPer = dt8.Rows[0]["ReservationMoneyPer"].ToString();
                    lblReservationMoneyPer.Text = ReservationMoneyPer;
                    txtReservationMoneyPer.Text = ReservationMoneyPer;

                    string ReservationMoneyDepositDays = dt8.Rows[0]["ReservationMoneyDepositDays"].ToString();
                    lblReservationMoneyDepositDays.Text = ReservationMoneyDepositDays;
                    txtReservationMoneyDepositDays.Text = ReservationMoneyDepositDays;                    

                    string PlotRate1 = dt8.Rows[0]["PlotRate"].ToString();
                    lblEMDAmountDate.Text = PlotRate1;
                    txtEMDAmountDate.Text = PlotRate1;

                    string LocationChargeRate = dt8.Rows[0]["LocationChargeRate"].ToString();
                    lblEMDAmountDate.Text = LocationChargeRate;
                    txtEMDAmountDate.Text = LocationChargeRate;

                    string LocationChargePer = dt8.Rows[0]["LocationChargePer"].ToString();
                    lblLocationChargePer.Text = LocationChargePer;
                    txtLocationChargePer.Text = LocationChargePer;


                    string RemPremiumPer = dt8.Rows[0]["RemPremiumPer"].ToString();
                    lblRemPremiumPer.Text = RemPremiumPer;
                    txtRemPremiumPer.Text = RemPremiumPer;

                    string NoInstallment = dt8.Rows[0]["NoInstallment"].ToString();
                    lblNoInstallment.Text = NoInstallment;
                    txtNoInstallment.Text = NoInstallment;

                    string InterestPerAnnum = dt8.Rows[0]["InterestPerAnnum"].ToString();
                    lblInterestRate.Text = ApplicationDate;
                    txtInterestRate.Text = ApplicationDate;

                    string RebatePer = dt8.Rows[0]["RebatePer"].ToString();
                    txtRebatePer.Text = RebatePer;
                    txtRebatePer.Text = RebatePer;

                    string PoductionStartPeriod = dt8.Rows[0]["PoductionStartPeriod"].ToString();
                    lblPoductionStartPeriod.Text = PoductionStartPeriod;
                    txtPoductionStartPeriod.Text = PoductionStartPeriod;

                    string LeaseRent1 = dt8.Rows[0]["LeaseRent1"].ToString();
                    lblLeaseRent1.Text = LeaseRent1;
                    txtLeaseRent1.Text = LeaseRent1;

                    string LeaseRent2 = dt8.Rows[0]["LeaseRent2"].ToString();
                    lblLeaseRent2.Text = LeaseRent2;
                    txtLeaseRent2.Text = LeaseRent2;

                    string LeaseRent3 = dt8.Rows[0]["LeaseRent3"].ToString();
                    lblLeaseRent3.Text = LeaseRent3;
                    txtLeaseRent3.Text = LeaseRent3;

                    string CoveredArea = dt8.Rows[0]["CoveredArea"].ToString();
                    lblCoveredArea.Text = CoveredArea;
                    txtCoveredArea.Text = CoveredArea;


                    /*
                    string AdditionalClause = dt8.Rows[0]["AdditionalClause"].ToString();
                    string ListofAnnexres = dt8.Rows[0]["ListofAnnexres"].ToString();

                    string Installments = dt8.Rows[0]["Installments"].ToString();
                    txtEMDAmountDateOld.Text = ApplicationDate;
                    txtEMDAmountDate.Text = ApplicationDate;

                    string Rebate = dt8.Rows[0]["Rebate"].ToString();
                    txtEMDAmountDateOld.Text = ApplicationDate;
                    txtEMDAmountDate.Text = ApplicationDate;
                    */
                    string RMName = dt8.Rows[0]["RMName"].ToString();
                    ...
                    htmlContent = htmlContent.Replace("{{ApplicationDate}}", ApplicationDate);
                    ...
                    string code = "ApplicationNo:" + ApplicationDate + "|ApplicantName:" + AllotteeName + "|IAName:" + IAName + "|DocType:Allotment";
