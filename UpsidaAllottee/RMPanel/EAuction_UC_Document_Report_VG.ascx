<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EAuction_UC_Document_Report_VG.ascx.cs" Inherits="UpsidaAllottee.RMPanel.EAuction_UC_Document_Report_VG" %>
