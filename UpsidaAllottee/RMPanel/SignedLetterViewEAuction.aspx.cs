...
{
    public partial class SignedLetterViewEAuction : System.Web.UI.Page
    {
        ...
        private void GetDetails()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("GetSignedLettersSbiAuction '" + Doctype + "','" + id + "'", con);
        ...
        protected void DocumentViewer(string ServiceRequestNo, string DocType, string type)
        {
            ...
            if (type == "Letter")
            {
                cmd = new SqlCommand(@"select Id , SignedDocumentContent , SignedDocument from  [dbo].[Repository] where ServiceRequestNo = '" + ServiceRequestNo + "' and DocType='" + DocType + "'", con);
        ...
        protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                string SerReqNo = GridView2.DataKeys[index].Values[0].ToString().Trim();
