    ...
    public partial class ReportGenration : System.Web.UI.Page
    {
        ...
        protected void load_UC()
        {
            ...
            if (Menu_Type == "page")
            {
                ...
                {
                    UC_DataFacts = LoadControl("~/RMPanel/UC_DataFacts.ascx") as UC_DataFacts;
                ...
                if (Menu_Value1 == "Report_View_Genrate")
                {
                    ...
                    UC_Document_Report_VG = LoadControl("~/RMPanel/UC_Document_Report_VG.ascx") as UC_Document_Report_VG;
