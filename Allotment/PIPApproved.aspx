<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="PIPApproved.aspx.cs" Inherits="Allotment.PIPApproved" %>
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                ...
                <asp:BoundField DataField = "CompletedOn" HeaderText = "Completion Date" DataFormatString="{0:dd-M-yyyy}" />
