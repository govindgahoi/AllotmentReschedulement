<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="MISReportAllApplicationsWeakWise.aspx.cs" Inherits="Allotment.MISReportAllApplicationsWeakWise" %>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div  id="DivP" style="text-align: center;padding: 15px 25px; margin: 25px 0%;background: #fbfbfb;border: 1px solid #ccc;">
                <div class="div-report" runat="server"  style="text-align: center;">
                    ...
                    <h2>List Of Applications Received Weak Wise</h2>
                    <div style = "border-top:3px solid #ffc511;">&nbsp;</div> 
