...
namespace Allotment
{
    public partial class ServiceRequestInboxIAUnderProcessApp : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                sub_menu.Items.Add(new MenuItem { Value = "13", Text = "RecognitionRecognition legal heir" });
