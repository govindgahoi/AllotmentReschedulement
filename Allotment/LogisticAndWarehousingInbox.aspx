<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="LogisticAndWarehousingInbox.aspx.cs" Inherits="Allotment.LogisticAndWarehousingInbox" %>
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                ...
                <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="ServiceRequestNo"  datanavigateurlformatstring="LAWAssessment.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
                ...
                <asp:BoundField DataField = "FinalSubmissionDate" HeaderText = "Form Submission Date" DataFormatString="{0:dd-M-yyyy}" />
                 <asp:BoundField DataField = "YearP"         HeaderText = "Policy Year"  />     
            </Columns>
            <EmptyDataTemplate>
                No Record Available
            </EmptyDataTemplate>
