...
namespace Allotment
{
    public partial class UC_ApplicationFinalViewSecondchargeService : System.Web.UI.UserControl
    {
        ...
        private void GetApplicantDetails(String ID)
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetAllotteeDetailsIASecondchargeService(objServiceTimelinesBEL);


                DataTable dt = ds.Tables[0];
                DataTable dt1 = ds.Tables[1];
                DataTable dt_secondcharge = ds.Tables[2];
                ...
                {
                    lblPaidoutstanding.Text = dt_secondcharge.Rows[0]["PaidStatus"].ToString();
                    lblfirstAmount.Text = dt_secondcharge.Rows[0]["firstAmount"].ToString();
                    lblfirstNameofbank.Text = dt_secondcharge.Rows[0]["firstNameofbank"].ToString();
                    lblfirstBranch.Text = dt_secondcharge.Rows[0]["firstBranch"].ToString();
                    lblfirstAddress.Text = dt_secondcharge.Rows[0]["firstAddress"].ToString();
                    lblAuthorizedSignatory1.Text = dt_secondcharge.Rows[0]["AuthorisedSignatory1"].ToString();
                    lblfirstMobileNo.Text = dt_secondcharge.Rows[0]["firstMobileNo"].ToString();
                    lblfirstemailid.Text = dt_secondcharge.Rows[0]["firstemailid"].ToString();
                    lblsecondAmount.Text = dt_secondcharge.Rows[0]["secondAmount"].ToString();
                    lblsecondNameofbank.Text = dt_secondcharge.Rows[0]["secondNameofbank"].ToString();
                    lblsecondBranch.Text = dt_secondcharge.Rows[0]["secondBranch"].ToString();
                    lblsecondAddress.Text = dt_secondcharge.Rows[0]["secondAddress"].ToString();
                    lblAuthorizedSignatory.Text = dt_secondcharge.Rows[0]["AuthorisedSignatory"].ToString();
                    lblsecondMobileNo.Text = dt_secondcharge.Rows[0]["secondMobileNo"].ToString();
                    lblsecondemailid.Text = dt_secondcharge.Rows[0]["secondemailid"].ToString();

                    lblPremimAmount.Text = dt_secondcharge.Rows[0]["PremimAmount"].ToString();
                    lblInterestAmount.Text = dt_secondcharge.Rows[0]["InterestAmount"].ToString();
                    lblPremimAmountSecond.Text = dt_secondcharge.Rows[0]["PremimAmountSecond"].ToString();
                    lblInterestSecond.Text = dt_secondcharge.Rows[0]["InterestSecond"].ToString();

                    lblSanctionletterno.Text = dt_secondcharge.Rows[0]["Sanctionletterno"].ToString();
                    lblSanctionletterDate.Text = dt_secondcharge.Rows[0]["SanctionletterDate"].ToString();
                    lblSanctionletterDatesecond.Text = dt_secondcharge.Rows[0]["SanctionletterDatesecond"].ToString();
                    lblSanctionletternoSecond.Text = dt_secondcharge.Rows[0]["SanctionletternoSecond"].ToString();
