...
namespace Allotment
{
    public partial class UC_ApplicationFinalViewNocMortgageService : System.Web.UI.UserControl
    {
        ...
        private void GetApplicantDetails(String ID)
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetAllotteeDetailsIAMortgageService(objServiceTimelinesBEL);


                DataTable dt = ds.Tables[0];
                DataTable dt1 = ds.Tables[1];
                DataTable dt_NocMortgage = ds.Tables[2];
                ...
                {
                    lblLetterNo.Text = dt_NocMortgage.Rows[0]["LetterNo"].ToString();
                    lblDate.Text = dt_NocMortgage.Rows[0]["LetterDate"].ToString();
                    lblLetterFrom.Text = dt_NocMortgage.Rows[0]["LetterFrom"].ToString();
                    lblAddressBank.Text = dt_NocMortgage.Rows[0]["LetterAddress"].ToString();
                    lblMobileNumbers.Text = dt_NocMortgage.Rows[0]["MobileNo"].ToString();
                    lblemailids.Text = dt_NocMortgage.Rows[0]["emailid"].ToString();
                    lblPremiumAmounts.Text = dt_NocMortgage.Rows[0]["PremimAmount"].ToString();
                    lblInterestAmounts.Text = dt_NocMortgage.Rows[0]["InterestAmount"].ToString();
                    lblPaidoutstanding.Text = dt_NocMortgage.Rows[0]["PaidStatus"].ToString();
                    lblfirstNameofbank.Text = dt_NocMortgage.Rows[0]["BankName"].ToString();
                    lblfirstBranch.Text = dt_NocMortgage.Rows[0]["BranchName"].ToString();
        ...
        public void BindApplicableFees(string serviceNO)
        {
            ...
            try
            {
                ...
                try { Getdata2 = dt_Fee.Select("type  = 'A'", "sno").CopyToDataTable(); } catch { }
