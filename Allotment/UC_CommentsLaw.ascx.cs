...
namespace Allotment
{
    public partial class UC_CommentsLaw : System.Web.UI.UserControl
    {
        SqlConnection con;
        ...
        public void Get_Notesheet_of_service(string ServiceReqNo)
        {
            ...
            {
                DivNotesheet.Text = "";
                dsR = objServiceTimelinesBLL.Get_Notesheet_of_application_LAW(ServiceReqNo);
    ...
    <div class='clearfix'></div>";
                                    ...
                                    if(filePath1.Length>0)
                                    {
                                        ...
                                        DivNotesheet.Text += @"<div class='col-md-2 col-sm-2 col-xs-2' style='background: #f7f7f7;border:1px solid #ccc; padding: 7px 13px;font-size:12px;'><b></b><a href=""http://eservices.onlineupsidc.com" + filePath1.Trim().Remove(0, 1) + @""" Target='_blank'><img src='images/file-pdf-icon.png' height='22px' /></a></div>";
    ...
    <div class='clearfix'></div>";
                                    if (filePath.Length > 0)
                                    {
                                        ...
                                        DivNotesheet.Text += @"<div class='col-md-2 col-sm-2 col-xs-2' style='background: #f7f7f7;border:1px solid #ccc; padding: 7px 13px;font-size:12px;'><b></b><a href=""http://eservices.onlineupsidc.com" + filePath.Trim().Remove(0, 1) + @""" Target='_blank'><img src='images/file-pdf-icon.png' height='22px' /></a></div>";
                                    ...
                                    if (Reminder1 != "")
                                    {
                                        DivNotesheet.Text += @"<div class='col-md-2 col-sm-2 col-xs-2' style='background: #f7f7f7;border:1px solid #ccc; padding: 7px 13px;font-size:12px;'><b></b><a>Reminder</a></div>";
                                            ...
                                            DivNotesheet.Text += @"<div class='col-md-2 col-sm-2 col-xs-2' style='background: #f7f7f7;border:1px solid #ccc; padding: 7px 13px;font-size:12px;'><b></b><a href=""http://eservices.onlineupsidc.com/LogisticAndWareHousing/Reminder/" + Reminder1.Trim() + @""" Target='_blank'><img src='images/file-pdf-icon.png' height='22px' /></a></div>";
                                       
                                        if (Reminder2 != "")
                                        {
                                            DivNotesheet.Text += @"<div class='col-md-2 col-sm-2 col-xs-2' style='background: #f7f7f7;border:1px solid #ccc; padding: 7px 13px;font-size:12px;'><b></b><a href=""http://eservices.onlineupsidc.com/LogisticAndWareHousing/Reminder/" + Reminder2.Trim() + @""" Target='_blank'><img src='images/file-pdf-icon.png' height='22px' /></a></div>";
                                        }
                                        if (Reminder3 != "")
                                        {
                                            DivNotesheet.Text += @"<div class='col-md-2 col-sm-2 col-xs-2' style='background: #f7f7f7;border:1px solid #ccc; padding: 7px 13px;font-size:12px;'><b></b><a href=""http://eservices.onlineupsidc.com/LogisticAndWareHousing/Reminder/" + Reminder3.Trim() + @""" Target='_blank'><img src='images/file-pdf-icon.png' height='22px' /></a></div>";
                                        }
                                        if (Reminder4 != "")
                                        {
                                            DivNotesheet.Text += @"<div class='col-md-2 col-sm-2 col-xs-2' style='background: #f7f7f7;border:1px solid #ccc; padding: 7px 13px;font-size:12px;'><b></b><a href=""http://eservices.onlineupsidc.com/LogisticAndWareHousing/Reminder/" + Reminder4.Trim() + @""" Target='_blank'><img src='images/file-pdf-icon.png' height='22px' /></a></div>";
                                        }
                                        if (Reminder5 != "")
                                        {
                                            DivNotesheet.Text += @"<div class='col-md-2 col-sm-2 col-xs-2' style='background: #f7f7f7;border:1px solid #ccc; padding: 7px 13px;font-size:12px;'><b></b><a href=""http://eservices.onlineupsidc.com/LogisticAndWareHousing/Reminder/" + Reminder5.Trim() + @""" Target='_blank'><img src='images/file-pdf-icon.png' height='22px' /></a></div>";
                                        }
                                    }
                                    DivNotesheet.Text += @"</div><div class='clearfix'></div></div>";
