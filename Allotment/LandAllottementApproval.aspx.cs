...
namespace Allotment
{
    ...
    public partial class LandAllottementApproval : System.Web.UI.Page
    {
        ...
        //                if (cnt>0)
        //                { dtOpenTicket = Getdata1.Select("TicketStage not in ('7','8')", sortOrder).CopyToDataTable(); }
        ...
        //                {
        //                    GridView2.DataSource = dtOpenTicket;
        //                    GridView2.DataBind();
        //                }
        //                else
        //                {
        ...
        //                if (cnt > 0)
        //                { dtCloseicket = Getdata1.Select("TicketStage  in ('7','8')", sortOrder).CopyToDataTable(); }
        ...
        //                {
        //                    GridView_TicketClosed.DataSource = dtCloseicket;
        //                    GridView_TicketClosed.DataBind();
        //                }
        //                else
        //                {
        //                    GridView_TicketClosed.DataSource = null;
        //                    GridView_TicketClosed.DataBind();
        //                }
        ...
        protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Select_Applicant_for_process")
            {
                ...
                try
                {
                    ...
                    {
                        Response.Redirect("~/AllotmentAssessment.aspx?ServiceReqNo=" + ServiceReqNo + "&PacketId=" + PacketID + "&TicketId=" + ServiceTicketId + " ");
                    }

                    if (ServiceStage == "6" || ServiceStage == "7" || ServiceStage == "8" || ServiceStage == "9")
                    {
                        Response.Redirect("~/AllotmentEvaluation.aspx?PacketID=" + PacketID + "");
                    }
