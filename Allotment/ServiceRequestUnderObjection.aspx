<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="ServiceRequestUnderObjection.aspx.cs" Inherits="Allotment.ServiceRequestUnderObjection" %>
...
<%--    <asp:BoundField  ItemStyle-BorderWidth="0" DataField="ALERTMESSAGE" />  --%>
              ...
              <asp:View runat="server" ID="AllotmentView">
                    ...
                    <div class="col-md-12" style="padding: 0px;">
                           ...
                           ClientIDMode="Static"
                            ...
                            DataKeyNames="WEEKSTARTDATE,WEEKENDDATE,IAID"
  ...
  <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:HyperLink runat="server" ID="Hyper1" Target="_blank" NavigateUrl='<%# string.Format("~/NewAssessmentUnderProcess.aspx?ServiceReqNo={0}",HttpUtility.UrlEncode(Eval("ServiceRequestNO").ToString())) %>' Text='<%# Eval("ServiceRequestNO").ToString()%>'> </asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Data Approved" SortExpression="IsDataApproved" HeaderStyle-CssClass="text-center-imp" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-center-imp" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                                     ...
                                                     <asp:TemplateField HeaderText="JMD Approved" SortExpression="JMDApproved" HeaderStyle-CssClass="text-center-imp" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="text-center-imp" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                                        <ItemTemplate>
        ...
        <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="ServiceRequestNO" Target="_blank" datanavigateurlformatstring="BuildingPlanAssessmentView.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
            ...
            <asp:BoundField DataField="AllotteeName" HeaderText="Allottee Name" SortExpression="AllotteeName" />
                ...
                <asp:BoundField DataField="ServiceRequestActivity" ItemStyle-HorizontalAlign="Justify" HeaderText="Request Regarding" SortExpression="ServiceRequestActivity" />
                 <asp:BoundField DataField="QueriedOn" ItemStyle-HorizontalAlign="Justify" DataFormatString="{0:dd-M-yyyy}"  HeaderText="Objection Raised On" SortExpression="QueriedOn" />
        ...
        <div class="clearfix"></div>
                ...
                <asp:View runat="server" ID="TransferView">
                      <div  class="table-responsive" style="overflow-y: auto; max-height: 390px;">
        <asp:GridView ID="GridView3" runat="server" CssClass="table table-striped table-bordered table-hover request-table request-table"         
             ClientIDMode="Static"
            AllowSorting="True"
            AutoGenerateColumns="False"
