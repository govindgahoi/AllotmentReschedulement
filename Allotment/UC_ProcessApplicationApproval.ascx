<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ProcessApplicationApproval.ascx.cs" Inherits="Allotment.UC_ProcessApplicationApproval" %>
...
<script type="text/javascript">
 ...
 <table class="request-table" style="border: 2px solid #adadad;width: 100%;" id="UploadTB" runat="server" visible="false">
                        <tr>
                            <td style="width: 25%;">Head Office Committee Minutes:</td>
                            ...
                            <td><asp:LinkButton runat="server" aria-hidden="true" ID="btnMinutes" CssClass="fa fa-download" OnClick="btnHeadMinutes_Click"/></td>
                            </tr>
