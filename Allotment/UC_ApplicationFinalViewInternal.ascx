<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ApplicationFinalViewInternal.ascx.cs" Inherits="Allotment.UC_ApplicationFinalViewInternal" %>
...
<div class="col-md-12 col-sm-12 col-xs-12" style="background:#ddd;">
    <asp:Button ID="btnPrint" runat="server" Text="Print" Style="margin: 6px 2px;display:block;" OnClick="btnPrint_Click" CssClass="btn-primary btn-sm ey-bg pull-right" />
</div>
                      ...
                      <!--<asp:PlaceHolder ID="ph" runat="server" />-->
                        <div class="applicant-detail" style="border: 2px solid #ccc;margin-top: 20px;">
                               ...
                               <div style="clear:both;"></div>
                                ...
                                <div style="width:15%;float:left;font-size:12px;font-weight:700;" class="col-md-3">1.&nbsp;<asp:label ID="lblPlotpreference1" runat="server"></asp:label></div>
                               
                                <div style="width:25%;float:left;font-size:12px;font-weight:700;" class="col-md-3">2.&nbsp;<asp:label ID="lblPlotpreference2" runat="server"></asp:label></div>
                                
                                <div style="width:25%;float:left;font-size:12px;font-weight:700;" class="col-md-3">3.&nbsp;<asp:label ID="lblPlotpreference3" runat="server"></asp:label></div>
                        ...
                        <div class="project-detail" style="border: 2px solid #ccc;margin-top: 20px;">
                                    ...
                                    <div style="width:45%;float:left;font-size:12px;font-weight:700;" class="col-md-3"><asp:label ID="lblTypeOfIndustry" runat="server"></asp:label></div>
                                    <div style="clear:both;"></div>
                                    <hr class="myhrline" />
