...
namespace Allotment
{
    public partial class UC_CreateNoticeforCancelation : System.Web.UI.UserControl
    {
        SqlConnection con;
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Get_Notice_of_service(ServiceReqNo);
            }
            catch (Exception ex) { }
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("GetAllotteeDetailsToCreateNotice '" + ServiceReqNo + "'", con);
                SqlDataAdapter adp = new SqlDataAdapter(cmd);
        ...
        {
            Response.Redirect("~/ReportGenrationIANotice.aspx?ServiceReqNo=" + ServiceReqNo );
        }
            ...
            if (e.CommandName == "ViewDocument")
            {
                ...
                If you are unable to view file, you can download from <a href = ""{0}&download=1"">here</a>
                 or download <a target = ""_blank"" href = ""http://get.adobe.com/reader/\"">Adobe PDF Reader</a> to view the file.
                    ...
                    ltEmbed.Text = string.Format(embed, ResolveUrl("/Viewer_Notice.ashx?ServiceRequestNO=" + SerReqNo.Trim() + ""));
                }
            }
        ...
        private void NoticeSendtoApplicant()
        {
            ...
            {
                string[] SerIdarray = ServiceReqNo.Split('|');
                SqlCommand cmd = new SqlCommand("GetAllotteeDetailsForNoticeReply '" + ServiceReqNo.Trim() + "'", con);
                SqlDataAdapter adp = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                adp.Fill(ds);
                ...
                if (dt.Rows.Count > 0)
                {
                  ...
                  MailAddress mailfrom = new MailAddress("eservicesotp@outlook.com");
                    ...
                    StrContent = StrContent.Replace("{Link}", "https://http://staging.onlineupsidc.com/IAServicesApplication_Module.aspx?ServiceReqNo=" + ServiceReqNo);
