...
namespace Allotment
{
    public partial class UC_TransferLAWCommentsEntry : System.Web.UI.UserControl
    {
        SqlConnection con;
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int retVal = objServiceTimelinesBLL.UpdateLawComments(objServiceTimelinesBEL);
                if (retVal > 0)
                {
                    ...
                    {
                        Response.Redirect("LogisticAndWarehousingInbox2.aspx");
                    }
                    else
                    {
                        Response.Redirect("LogisticAndWarehousingInbox1.aspx");
                    }
                }
                else
                {
