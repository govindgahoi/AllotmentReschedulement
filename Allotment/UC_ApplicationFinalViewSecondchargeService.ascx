<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ApplicationFinalViewSecondchargeService.ascx.cs" Inherits="Allotment.UC_ApplicationFinalViewSecondchargeService" %>
    ...
    <div id="DivP" style="padding: 15px 25px; margin: 25px; background: #fbfbfb; border: 1px solid #ccc;">
        ...
        <div class="my-div-report">
            <div style="text-align: center; font-size: 18px; font-weight: 600;">
                <asp:Label runat="server" ID="lblFormName" Text="Application Form For Second Charge"></asp:Label></div>
            <br />
            ...
            <div style="width: 75%; float: left; font-weight: 600;" class="col-md-9">
                ...
                <br />
                Dear Sir/Madam,<br />
                &nbsp;&nbsp;&nbsp;&nbsp;I Hereby submit the request for Permission for creation of Second Charge in favour of Financial Institution as per the following details.<br />
            </div>
            ...
            <div style="clear: both;"></div>
            <div class="SecondCharge-detail" style="border: 2px solid #ccc; margin-top: 20px;">
                <div class="col-md-12 col-sm-12 col-xs-12 main-head"><b>B.Second Charge Details</b></div>
                <br />
                <div style="clear: both;"></div>
                ...
                <label style="width: 35%; float: left;" class="col-md-3">Address :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblfirstAddress" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">Authorized Signatory Name :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblAuthorizedSignatory1" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">Mobile Number :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblfirstMobileNo" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">Email ID :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblfirstemailid" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <div class="col-md-12 col-sm-12 col-xs-12 main-head"><b>Details of Bank/FI(Second Charge)</b></div>
                <br />
                <div style="clear: both;"></div>
                <label style="width: 35%; float: left;" class="col-md-3">Sanction letter no</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblSanctionletternoSecond" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <div style="clear: both;"></div>
                <label style="width: 35%; float: left;" class="col-md-3">Sanction letter Date</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblSanctionletterDatesecond" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">Premium Amount bank agreed to pay</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblPremimAmountSecond" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">Interest on premium Amount agreed to pay</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblInterestSecond" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">Amount :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblsecondAmount" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">Name of bank :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblsecondNameofbank" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">Branch Name :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblsecondBranch" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">Address :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblsecondAddress" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">Authorized Signatory Name :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblAuthorizedSignatory" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">Mobile Number :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblsecondMobileNo" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">Email ID :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblsecondemailid" runat="server"></asp:Label></div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
            </div>
