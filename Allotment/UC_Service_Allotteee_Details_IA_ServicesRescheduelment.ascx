<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_Service_Allotteee_Details_IA_ServicesRescheduelment.ascx.cs" Inherits="Allotment.UC_Service_Allotteee_Details_IA_ServicesRescheduelment" %>
            ...
            <div style="background: #ececec; margin-top: 0px;">
                <div class="form-group">
                    <label class="col-md-2 col-sm-12 col-xs-12 text-right">
                        Regional OfficeArun kumar gjhghfgh:
                    </label>
