<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="AccountClearance.aspx.cs" Inherits="Allotment.AccountClearance" %>
...
<%-- Modal Section Start --%>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">        
            ...
            <div class="form-group">
             ...
             <div class="clearfix"></div>
             <hr class="myhrline" />
                <asp:TextBox ID="txtAmountDisplay" runat="server" CssClass="form-control input-sm similar-select1 margin-left-z"></asp:TextBox>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><asp:Label runat="server" ID="Label1" Text="NEFT/RTGS Challan Details"/></h4>
        </div>
        <div class="modal-body">        
             <div class="form-group">
                <label class="col-md-5 col-sm-6 col-xs-6">
...
<%-- Modal Section End --%>
    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="text-center my-new-heading" style="margin-bottom:2px;">Account Clearance</div>
            ...
            <div class="clearfix"></div>
            <hr class="separation" />
            <div class="panel-heading">Pending At You</div>
             ...
             <asp:HiddenField ID="hfParentContainer" runat="server"></asp:HiddenField>
                ...
                <div class="table-responsive" style="overflow-y:auto;max-height:400px;">
                    ...
                    <asp:GridView ID="ApplicationGrid" runat="server" ClientIDMode="Static" AutoGenerateColumns="false" DataKeyNames="ServiceRequestNO"  CssClass="table table-striped table-bordered table-hover request-table" OnRowDataBound="ApplicationGrid_RowDataBound"  >
                                    <Columns>
                                               <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:Panel ID="pnlAllotmentRequest" runat="server" Style="display: none">
                                            ...
                                            <asp:GridView ID="GridViewPayment" runat="server" AutoGenerateColumns="False" CssClass="request-table table table-hover table-bordered cm-table-heading myreq-col">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="ProcessingFees"  HeaderText="Processing Charges" SortExpression="ProcessingFees" />
                                                    <asp:BoundField DataField="GSTOnProcessingFees"  HeaderText="GST On Processing Charges"  SortExpression="GSTOnProcessingFees" />
                                                   <asp:BoundField DataField="EMD"  HeaderText="EMD"  SortExpression="EMD" />
                                        ...
                                        <asp:BoundField DataField="PaymentBank"           HeaderText ="Payment Bank"                          SortExpression ="PaymentBank" />
            ...
            <div class="clearfix"></div>
            <hr class="separation" />
            <div class="panel-heading">Cleared By You
...
<span class="pull-right">
                ...
                <div class="table-responsive" id="PrintDiv" style="overflow-y:auto;max-height:400px;">
                     <asp:GridView ID="ApplicationCleared" runat="server" ClientIDMode="Static" AutoGenerateColumns="false"  CssClass="table table-striped table-bordered table-hover request-table"  >
                                    <Columns>
        ...
        $("[src*=minus]").live("click", function () {
            ...
            $(this).closest("tr").next().remove();
                ...
                function ShowPopupChange(val, val1, val2, val3,val4) {
                    ...
                    $('#<%= txtAmountDisplay.ClientID %>').val(val4);
                    $("#btnModalGridchange").click();
                }
