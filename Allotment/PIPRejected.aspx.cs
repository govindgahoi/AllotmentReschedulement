...
namespace Allotment
{
    public partial class PIPRejected : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGridView()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfPIPRejected(objServiceTimelinesBEL);
                ...
                dsfin = objMbal.GetApplicationOfPIPFINRejected(objServiceTimelinesBEL);
        ...
        private void BindAlertServiceRequestGridView()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetAlertApplicationOfPIPRejected(objServiceTimelinesBEL);
                if (ds.Tables[0].Rows.Count > 0)
                {
