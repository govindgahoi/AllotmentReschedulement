...
namespace Allotment
{
    public partial class UC_OutstandingDuesPayAck : System.Web.UI.UserControl
    {
        ...
        public void BindApplicableFees(string serviceNO)
        {
            ...
            try
            {
                ...
                {
                    Pay_Ds = objServiceTimelinesBLL.GetOutstandingDuesPaymentDetailAfterTransaction(objServiceTimelinesBEL);
