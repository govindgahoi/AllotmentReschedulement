    ...
    public partial class ApplicationForPIP : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        if (Convert.ToDateTime(ApplicationSubmissionDate) < Convert.ToDateTime("12/29/2024"))
                        {
                        //Allotment.ActiveViewIndex = 7;
                            ...
                            if (ddlcompanytype.SelectedValue == "2")
                            {
                                ...
                                if (temp.Rows.Count > 0)
                                {
                                    foreach (DataRow dr1 in temp.Rows)
                                    {
                                        ...
                                        retval = objServiceTimelinesBLL.SaveShareHolderDetailsPIP(objServiceTimelinesBEL);
        ...
        protected void BtnProjectInsert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objServiceTimelinesBEL.PIPRegistrationNo                             = txtRegistrationNo.Text.Trim();
                objServiceTimelinesBEL.anyOther                                      = txtAnyOther.Text.Trim();
                objServiceTimelinesBEL.CapitalSubsidy                                = txtCapitalSubsidy.Text.Trim();

                /*objServiceTimelinesBEL.CapitalInterestSubsidy = "0";
                objServiceTimelinesBEL.InfrastructureInterestSubsidy = "0";
                objServiceTimelinesBEL.RebateonLanduseconversioncharges = "0";
                objServiceTimelinesBEL.Exemptionfromdevelopmentcharges = "0";
                objServiceTimelinesBEL.ElectricityRebate = "0";
                objServiceTimelinesBEL.Warehousingqualitycertificationreimbursement = "0";
                objServiceTimelinesBEL.assistanceforpayrollofdisabledworkers = "0";
                objServiceTimelinesBEL.Skilldevelopmentpromotion = "0";
                objServiceTimelinesBEL.IntelligentLogisticIncentives = "0";
                objServiceTimelinesBEL.PIPRegistrationNo = "0";
                objServiceTimelinesBEL.anyOther = "0";
                objServiceTimelinesBEL.CapitalSubsidy = "0";

                /*

                if (txtCapitalInterestSubsidy.Text.Trim()) { objServiceTimelinesBEL.CapitalInterestSubsidy = txtCapitalInterestSubsidy.Text.Trim(); }
                else { objServiceTimelinesBEL.CapitalInterestSubsidy = "0"; }

                if (txtCapitalInterestSubsidy.Text.Trim())
                {
                    objServiceTimelinesBEL.InfrastructureInterestSubsidy = txtInfrastructureInterestSubsidy.Text.Trim();
                }
                else { objServiceTimelinesBEL.InfrastructureInterestSubsidy = "0"; }

                if (txtCapitalInterestSubsidy.Text.Trim())
                {
                    objServiceTimelinesBEL.RebateonLanduseconversioncharges = txtRebateLandUseConversion.Text.Trim();
                }
                else { objServiceTimelinesBEL.RebateonLanduseconversioncharges = "0"; }

                if (txtCapitalInterestSubsidy.Text.Trim())
                {
                    objServiceTimelinesBEL.Exemptionfromdevelopmentcharges = txtExemptionDevelopmentCharges.Text.Trim();
                }
                else { objServiceTimelinesBEL.Exemptionfromdevelopmentcharges = "0"; }

                if (txtCapitalInterestSubsidy.Text.Trim())
                {
                    objServiceTimelinesBEL.ElectricityRebate = txtElectricityRebate.Text.Trim();
                }
                else { objServiceTimelinesBEL.ElectricityRebate = "0"; }

                if (txtCapitalInterestSubsidy.Text.Trim())
                {
                    objServiceTimelinesBEL.Warehousingqualitycertificationreimbursement = txtWarehousingCertification.Text.Trim();
                }
                else { objServiceTimelinesBEL.Warehousingqualitycertificationreimbursement = "0"; }

                if (txtCapitalInterestSubsidy.Text.Trim())
                {
                    objServiceTimelinesBEL.assistanceforpayrollofdisabledworkers = txtAssistanceForPayroll.Text.Trim();
                }
                else { objServiceTimelinesBEL.assistanceforpayrollofdisabledworkers = "0"; }

                if (txtCapitalInterestSubsidy.Text.Trim())
                {
                    objServiceTimelinesBEL.Skilldevelopmentpromotion = txtSkillDevelopmentPromotion.Text.Trim();
                }
                else { objServiceTimelinesBEL.Skilldevelopmentpromotion = "0"; }

                if (txtCapitalInterestSubsidy.Text.Trim())
                {
                    objServiceTimelinesBEL.IntelligentLogisticIncentives = txtIntelligentLogisticIncentives.Text.Trim();
                }
                else { objServiceTimelinesBEL.IntelligentLogisticIncentives = "0"; }
                ...
                else { objServiceTimelinesBEL.LAWRegistrationNo = "0"; }
                ...
                else { objServiceTimelinesBEL.anyOther = "0"; }
                ...
                else { objServiceTimelinesBEL.CapitalSubsidy = "0"; }
        ...
        public void fetchNMdetails()
        {
            try
            {
                ...
                using (con)
                {
                    using (SqlCommand cmd = new SqlCommand("SELECT * FROM PIPRegister WHERE ApplicationId ='" + ServiceReqNo + "'"))
                    {
    ...
    D7
        ...
        protected void Grid_LandDetails_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "EditRow")
            {
                ...
                var b2 = Grid_LandDetails.Rows[index].Cells[10].Text;
                ...
                var b4 = Grid_LandDetails.Rows[index].Cells[14].Text;
                ddlLandExchange.SelectedIndex = ddlLandExchange.Items.IndexOf(ddlLandExchange.Items.FindByText(b4));
                
                txtLandContiguous.Text = Grid_LandDetails.Rows[index].Cells[11].Text;
                txtGramGov.Text = Grid_LandDetails.Rows[index].Cells[13].Text;
                txtLandExchange.Text = Grid_LandDetails.Rows[index].Cells[15].Text;
  ...
  {9, 8, 7, 6, 5, 4, 3, 2, 1, 0}
       ...
       {7, 0, 4, 6, 9, 1, 3, 2, 5, 8}
        ...
        private void CheckNMSWPFeePaid()
        {
            ...
            SqlCommand cmd = new SqlCommand("Select * from [tbl_NMSWPTransactionDetailsPIP] where ControlID='" + ControlID.Trim() + "' and UnitID='" + UnitID.Trim() + "' and ServiceID='" + ServiceID.Trim() + "' and RequestID='" + RequestID + "' and isnull(Fee_Status,'') in ('Pending')", con);
            SqlDataAdapter adp = new SqlDataAdapter(cmd);
            DataTable data = new DataTable();
            adp.Fill(data);
            if (data.Rows.Count > 0)
            {
                /*ControlID = "UPSWP230675966";
                UnitID = "UPSWP23067596602";
                ServiceID = "SC21036";
                RequestID = "23067596602210360001";
    **/
        ...
        private void CheckNMSWPFeePaid123()
        {
            ...
            SqlCommand cmd = new SqlCommand("Select * from [tbl_NMSWPTransactionDetailsPIP] where ControlID='" + ControlID.Trim() + "' and UnitID='" + UnitID.Trim() + "' and ServiceID='" + ServiceID.Trim() + "' and RequestID='" + RequestID + "' and isnull(Fee_Status,'') in ('Paid')", con);
            SqlDataAdapter adp = new SqlDataAdapter(cmd);
            DataTable data = new DataTable();
            adp.Fill(data);
            if (data.Rows.Count > 0)
