...
namespace Allotment
{
    public partial class RegistrationLogisticsPIPFin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    //}
                    //else
                    if (SWCServiceID.Trim() == "SC21045" && recordalreadyexist == false)
        ...
        public void fetchRecordfromdb()
        {
            ...
            try
            {
                ...
                //{
                //    checkQuery = "select * from AllotteeMaster where NMRequestID =@RequestID and ControlID=@ControlID";
                //}
                if (SWCServiceID.Trim() == "SC21045")
                {
                ...
                //else
                //{
                //    checkQuery = "select * from LogisticWarehousingRegister where NMRequestID =@NMRequestID and ControlID=@ControlID";
                //}
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
              ...
              /*  else */if (SWCServiceID.Trim() == "SC21045")
                {
                    StrContent = StrContent.Replace("{Service}", "Application for Availing Financial Incentive under PIPFIN");
                    newmsg.Subject = "UPSIDAeService: OTP verification for registration of Application for Availing Financial Incentive under PIPFIN";
                }
            ...
            try
            {
                if (txtMobOtp.Text.Trim() == ViewState["OTP"].ToString().Trim())
                {
                    ...
                    /*else*/ if (SWCServiceID.Trim() == "SC21045")
                    {
                        ...
                        result = objMbal.SavePIPFinDetails(objServiceTimelinesBEL);
                    }
