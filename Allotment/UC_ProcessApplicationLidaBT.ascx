<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ProcessApplicationLidaBT.ascx.cs" Inherits="Allotment.UC_ProcessApplicationLidaBT" %>
<%--<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ProcessApplicationBT.ascx.cs" Inherits="Allotment.UC_ProcessApplicationBT" %>--%>
...
<script type="text/javascript">
 ...
 <table class="request-table" style="border: 2px solid #adadad;width: 100%;" id="UploadTB" runat="server" visible="false">
                        <tr>
                            <td style="width: 25%;">Inspection report:</td>
                            ...
                            <td><asp:LinkButton runat="server" aria-hidden="true" ID="btnInspectionReport" CssClass="fa fa-eye" OnClick="btnInspectionReport_Click"/></td>
                            </tr>
                    </table>
	<panel id="panelForm" runat="server">
...
<panel ID="panelForm1" runat="server">
    <div class="form-group" style="margin-top:2vh;">
                    <label class="col-md-4 col-sm-6 col-xs-6">
                        Please verify if payment has been credited: 
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <asp:Button runat="server" Text="Verify" id="btnverify" class="btn-primary btn-sm margin-left-z" style="margin: 7px 10px;" OnClick="btnverify_Click"/>
