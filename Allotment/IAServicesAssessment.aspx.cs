    ...
    public partial class IAServicesAssessment : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int landuseCode = (String.IsNullOrEmpty(NMSWP.Rows[0][5].ToString())) ? 2 : Convert.ToInt32(NMSWP.Rows[0][5]);
                //con = new SqlConnection(ConfigurationManager.ConnectionStrings["conStr"].ConnectionString);
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (Level == "RM")
                    {
                        if (ServiceID == 1003 || ServiceID == 1004 || ServiceID == 1005 || ServiceID == 1011 || ServiceID == 1026 || ServiceID == 1012 || ServiceID == 1007 || ServiceID == 1009 || ServiceID == 1010 || ServiceID == 1023 || ServiceID == 1008 || ServiceID == 1017 || ServiceID == 1021 || ServiceID == 1022 || ServiceID == 1014 || ServiceID == 1024 || ServiceID == 1027 || ServiceID == 1029)
                        {
                            btnRejectM.Visible = true;
                            btnApprove.Visible = true;
                            if (ServiceID == 1012 && plotArea > 500 && landuseCode == 2)
                            {
                        ...
                        #region ServiceID == 1002 || ServiceID == 1006 || ServiceID == 1013
                    ...
                    //else if (Level == "CMIA" && ServiceID == 1012)
                    //{
                    //    if (landuseCode == 2)
                    //    {
                    ...
                    //}else if(Level=="JDM" && ServiceID == 1012)
                    //{
                    ...
                    //Added By Sunil for Time Extension for 1 Year Services and Fee Less than 50 Lacks//
                    if (Level == "RM")
                    {
                            SqlCommand cmd12 = new SqlCommand("select TEFTimeperiod from tbl_Timeextensionfee where TEFTimeperiod <= '12' and ServiceReqNo = '" + ServiceReqNo + "'", con);
                            ...
                            if (dt12.Rows.Count > 0)
                            {
                                ...
                                SqlCommand cmd15 = new SqlCommand("select Amount from HDFCResponse where CAST(Amount AS DECIMAL(10, 2)) > '5000000' and uniqueCustomerId = '" + ServiceReqNo + "'", con);
                                SqlDataAdapter adp15 = new SqlDataAdapter(cmd15);
        ...
        protected void btnRejectM_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                if (dt.Rows[0][1].ToString() == "Close")
                {
                    ...
                    //var script = string.Format("alert({0});window.location ='RejectionLetterGeneration.aspx?ServiceReqNo=" + ServiceReqNo + "';");
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "", "window.location ='RejectionLetterGeneration.aspx?ServiceReqNo=" + ServiceReqNo + "';", true);
        ...
        protected void btnupload_Click(object sender, EventArgs e)
        {
            ...
            if (fileupload1.HasFile)
            {
                ...
                if (contenttype != String.Empty)
                {
                    ...
                    objServiceTimelinesBEL.ServiceCheckListsID = 1285;
                    objServiceTimelinesBEL.ServiceTimeLinesID = ServiceID;
                    ...
                    try
                    {
                        ...
                        if (retVal > 0)
                        {
                            ...
                            cs.str = "update ServiceRequests set docDate='"+DateTime.Now+ "', docDateExpire='" + DateTime.Now.AddDays(15) + "' where ServiceRequestNO='"+ ServiceReqNo + "' and AllotteeID='"+ ApplicantId + "'";
