<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ResolveObjectionPIP.ascx.cs" Inherits="Allotment.UC_ResolveObjectionPIP" %>
...
function NiveshRedirect() {
    alert('Objection Response Submit Successfully 1');
    //window.location.href = 'https://niveshmitra.up.nic.in/nmmasters/Add_Form.aspx';
    window.location.href = 'http://72.167.225.87/nivesh/nmmasters/Add_Form.aspx';
        }
...
<div runat="server" id="CurrentObjection_Div">
       ...
       <div class="panel panel-default">
                                             <div class="panel-heading">Objection Raised By UPSIDA <span style="float:right;">
                                                 <asp:LinkButton ID="lnkView1" runat="server" Class="fa fa-file-pdf-o" aria-hidden="true" OnClick="lnkView1_Click"></asp:LinkButton></span>
