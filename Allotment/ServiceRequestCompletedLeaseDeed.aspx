<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="ServiceRequestCompletedLeaseDeed.aspx.cs" Inherits="Allotment.ServiceRequestCompletedLeaseDeed" %>
   ...
   <div class="clearfix"></div>
    ...
    <div class="bg-mywhite table-divinbox">
       ...
       <asp:GridView ID="GridView1" runat="server"
        ...
        <ASP:HYPERLINKFIELD text="View" datanavigateurlfields="ServiceRequestNO"  datanavigateurlformatstring="LeaseDeedAssessmentView.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
