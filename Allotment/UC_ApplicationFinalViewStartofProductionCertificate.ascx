<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ApplicationFinalViewStartofProductionCertificate.ascx.cs" Inherits="Allotment.UC_ApplicationFinalViewStartofProductionCertificate" %>
    ...
    <div id="DivP" style="padding: 15px 25px; margin: 25px; background: #fbfbfb; border: 1px solid #ccc;">
        ...
        <div class="my-div-report">
            <div style="text-align: center; font-size: 18px; font-weight: 600;">
                <asp:Label runat="server" ID="lblFormName" Text="Application Form For Start of Production"></asp:Label>
            </div>
            <br />
            ...
            <div style="width: 75%; float: left; font-weight: 600;" class="col-md-9">
                ...
                <br />
                Dear Sir/Madam,<br />
                &nbsp;&nbsp;&nbsp;&nbsp;I Hereby submit the request for Start of Production as per the following details.<br />
            </div>
            ...
            <div class="timeextensiondetails-detail" style="border: 2px solid #ccc; margin-top: 20px;">
                <div class="col-md-12 col-sm-12 col-xs-12 main-head"><b>Start of Production  Details</b></div>
                <br />
                <div style="clear: both;"></div>

                <label style="width: 35%; float: left;" class="col-md-3">Production Start Date  :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblstartofprduction" runat="server"></asp:Label>
                </div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
            ...
            <div class="payment hidden" style="border: 2px solid #ccc; margin-top: 20px; visibility: hidden" id="Paymentdiv" runat="server" visible="false">
