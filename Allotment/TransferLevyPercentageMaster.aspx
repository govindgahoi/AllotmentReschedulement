<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" Debug="true" CodeBehind="TransferLevyPercentageMaster.aspx.cs"
    Inherits="Allotment.TransferLevyPercentageMaster" MaintainScrollPositionOnPostback="true" %>
    ...
    <asp:Label ID="RateIdlbl" runat="server" Visible="false"></asp:Label>
      <div class="panel">
                        <div class="panel-heading font-bold" style="text-align:center;">
                          Industrial Area Transfer Levy Percentage                         
                        </div>
