<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="MISReportTotalPaymentReceived.aspx.cs" Inherits="Allotment.MISReportTotalPaymentReceived" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('[id*=GridView1]').prepend($("<thead></thead>").append($('[id*=GridView1]').find("tr:first"))).DataTable({
                dom: 'Bfrtip1',
                'aoColumnDefs1': [{ 'bSortable': false, 'aTargets': [0] }],
                'iDisplayLength': 10,
                buttons: [
