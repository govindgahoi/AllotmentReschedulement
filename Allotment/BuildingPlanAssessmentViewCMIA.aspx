<%@ Page Title="" Language="C#"  ValidateRequest="false"  MasterPageFile="~/MainUserHO.Master"  EnableViewState="true" CodeBehind="BuildingPlanAssessmentViewCMIA.aspx.cs" Inherits="Allotment.BuildingPlanAssessmentViewCMIA" %>
       ...
       <style>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Clarification From Applcant</h4>
                </div>
                <div class="modal-body" >
                    <div class="col-md-12" style="font-size: 12px; padding: 4px 15px;">
                        <asp:TextBox runat="server" ID="txtClarification" CssClass="input-sm similar-select1 margin-left-z" placeholder="Enter Clarification Required From Applicant" TextMode="MultiLine" Height="250px"></asp:TextBox>
                ...
                <div class="modal-footer">
                    <div class="pull-right border-buttons">
                        ...
                        <asp:Button runat="server" Text="Send To Allottee" class="btn btn-primary btn-popup" style="margin-right: 0;"  OnClick="btnClarify_Click"  OnClientClick="return confirm('Do you want to send this application back to allottee?');" ID="btnClarify" /><button type="button" class="btn btn-primary btn-popup" data-dismiss="modal" style="margin-right: 0;">Cancel</button>
                    </div>
                </div>
            </div>
        </div>
