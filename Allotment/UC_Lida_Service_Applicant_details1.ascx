<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_Lida_Service_Applicant_details1.ascx.cs" Inherits="Allotment.UC_Lida_Service_Applicant_details1" %>
<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Already-applied-userdetails.aspx.cs" Inherits="LidaApplication.Already_applied_userdetails" %>--%>
            ...
            <div class="panel-body">
                ...
                <div id="Service_Building_Plan_hideDiv">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3" style="font-weight:500;font-size:14px">
                           <asp:ListBox ID="lstboxapplicants" Visible="false" runat="server" Enabled="false" Font-Size="14px" class="input-sm similar-select1"></asp:ListBox>
                            <asp:Label ID="lblapplicants" runat="server" class="input-sm similar-select1" Text=""></asp:Label>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <hr class="myhrline">
...
<asp:Panel ID="pnlploatdata" runat="server">
 ...
 <div class="clearfix"></div>
                    ...
                    <div class="form-group">
                       <%-- <label class="col-md-3 text-right">
                        ...
                        <div class="col-md-12" style="font-weight:500;font-size:14px">
                            <%--<asp:Label ID="Label1" runat="server" class="input-sm similar-select1" Text=""></asp:Label>--%>

                           <asp:GridView ID="grdview" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover request-table center-block" runat="server">
                               <Columns>

                                 <asp:BoundField DataField="khasra_gata_no" HeaderText="Khasra /Gata Number *" />  
                                  <asp:BoundField DataField="total_area" HeaderText="Total Area *" />  
                                <asp:BoundField DataField="ownership_area" HeaderText="Area(Under the Ownership) *" />  
