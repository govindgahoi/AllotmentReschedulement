<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="PaymentGSTReports.aspx.cs" Inherits="Allotment.PaymentGSTReports" %>
    ...
    <div class="row">
        <div class="form-group" style="background: #dadada;padding: 2px 0;margin-bottom: 3px;">
                <div class="">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <asp:DropDownList runat="server" ID="ddlPayMode" style="background:#fff;" CssClass="input-sm similar-select1" AutoPostBack="true" OnSelectedIndexChanged="ddlPayMode_SelectedIndexChanged">
                            <asp:ListItem Value="All">--All--</asp:ListItem>
                             <asp:ListItem Value="NEFT_RTGS">NEFT_RTGS</asp:ListItem>
                            <asp:ListItem Value="NET_BANKING">NET_BANKING</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="clearfix"></div>
                    <hr class="myhrline" />
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <asp:TextBox runat="server" ID="txtTransactionFromDate" style="background:#fff;" CssClass="form-control input-sm similar-select1 margin-left-z"></asp:TextBox>
                    </div>
                    <label class="col-md-2 col-sm-2 col-xs-12">
                        To Date :
                    </label>
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <asp:TextBox runat="server" ID="txtTransactionToDate" style="background:#fff;" CssClass="form-control input-sm similar-select1 margin-left-z"></asp:TextBox>
                    </div>
                    <label class="col-md-2 col-sm-2 col-xs-12">
                        Search Keyword :
                    </label>
