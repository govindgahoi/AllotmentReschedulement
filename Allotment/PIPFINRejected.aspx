<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="PIPFINRejected.aspx.cs" Inherits="Allotment.PIPFINRejected" %>
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                ...
                <asp:BoundField DataField = "RejectionDate"       HeaderText = "Rejection Date"       DataFormatString="{0:dd-M-yyyy}" />      
