...
namespace Allotment
{
    public partial class UC_LeaseDeedProcessingFee : System.Web.UI.UserControl
    {
        ...
        public void BindApplicableFees()
        {
            ...
            try
            {
                ...
                objServiceTimelinesBEL.ServiceRequestNO = ServiceRequestNo;
                dschoicearea = objServiceTimelinesBLL.GetApplicableChargesLeaseDeedFee(objServiceTimelinesBEL);
