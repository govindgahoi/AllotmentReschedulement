<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PIPApplicationForLAW.aspx.cs" Inherits="Allotment.PIPApplicationForLAW" %>
    ...
    .active{
       ...
       <script type="text/javascript">
           function MsgAndRedirect(ID) {
               ...
               window.location.href = 'PIPApplicationForLAW.aspx?ID=' + ID;

           }

           function MessageAndRedirect(par) {
               alert("Objection cleared and form re-submitted successfully");
               window.location.href = 'PIPApplicationForLAW.aspx?ID=' + par;
           }

           function MsgAndRedirect2() {
               alert('Invalid usage');
               window.location.href = 'PIPRegistrationLogistics.aspx';
					...
					<div class="row" id="SideDiv">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="panel panel-default">
								...
								<div class="clearfix"></div>
                                <div class="panel-heading font-bold text-center" style="font-size: 14px !important; font-weight: 600; background: #2d2d2d; color: #ffc511 !important;">Application Under Warehousing & Logistic Policy 2022 <span class="pull-right">Form No.: <asp:Label runat="server" id="lblFormNo"></asp:Label> </span></div>
                                                             ...
                                                             <asp:MultiView runat="server" ID="Allotment">  
                                                                    ...
                                                                    <asp:View runat="server" ID="View1">
                                                                            ...
                                                                            <div class="col-md-12 col-sm-12 col-xs-12">
													                            ...
													                            <div class="form-group">
														                            <div class="row">
															                            ...
															                            <div class="col-md-8 col-sm-6 col-xs-6">
																                            <asp:TextBox ID="txtProjectLocation" runat="server" CssClass="input-sm similar-select1"></asp:TextBox>
															                            </div>
														                            </div>
													                            </div>
													                            <div class="clearfix"></div>
                                                                        ...
                                                                        <div class="clearfix"></div>
															                            ...
															                            <div id="tr8" runat="server" visible="false">
																                            ...
																                            <asp:GridView ID="DirectorsGrid" ViewStateMode="Enabled" CssClass="table table-striped table-responsive table-bordered table-hover request-table" ShowFooterWhenEmpty="true" ShowHeaderWhenEmpty="true" runat="server" ShowFooter="true" AutoGenerateColumns="false" OnRowDeleting="DirectorDelete_Click">
																	                            <Columns>
																		                            ...
																		                            <asp:TemplateField><ItemTemplate><asp:ImageButton CommandName="Delete" CssClass="fa fa-trash-o" ToolTip="Delete" ID="btn_delete" runat="server"
																					                            ImageUrl="~/images/delete.png" Width="16px" Height="16px" OnClientClick="javascript:return confirm('Are you sure wanted to delete?');" /></ItemTemplate><FooterStyle HorizontalAlign="Right" /><FooterTemplate><asp:Button runat="server" ID="BtnSave" OnClientClick="return checkGrid3();" OnClick="insert_Director_details" CssClass="btn btn-sm btn-primary" Text="Add" Style="padding: 0px 10px !important;" /></FooterTemplate></asp:TemplateField>
															                            ...
															                            <div id="tr9" runat="server" visible="false">
																                            ...
																                            <asp:GridView ID="PartnershipFirmGrid" ViewStateMode="Enabled" CssClass="table table-striped table-responsive table-bordered table-hover request-table" ShowFooterWhenEmpty="true" ShowHeaderWhenEmpty="true" runat="server" ShowFooter="true" AutoGenerateColumns="false" OnRowDeleting="PartnershipDelete_Click">
																	                            <Columns>
																		                            ...
																		                            <asp:TemplateField><ItemTemplate><asp:ImageButton CommandName="Delete" CssClass="fa fa-trash-o" ToolTip="Delete" ID="btn_delete" runat="server"
																					                            ImageUrl="~/images/delete.png" Width="16px" Height="16px"  OnClientClick="javascript:return confirm('Are you sure wanted to delete?');" /></ItemTemplate><FooterStyle HorizontalAlign="Right" /><FooterTemplate><asp:Button runat="server" ID="BtnSave" OnClientClick="return checkGrid4();" OnClick="insert_Partnership_details"  CssClass="btn btn-sm btn-primary" Text="Add" Style="padding: 0px 10px !important;" /></FooterTemplate></asp:TemplateField>
															                            ...
															                            <div class="clearfix"></div>
                                                                           <div runat="server" id="Screen11" class="col-md-12 col-sm-12 col-xs-12 text-center" ><asp:Button runat="server" ID="BtnSaveApplicant" CssClass="btn btn-sm btn-primary" Text="Proceed" Style="text-align:center;padding: 4px 10px !important;margin: 10px 0;" OnClientClick="return ccheck1();" OnClick="BtnSaveApplicant_Click" /></div>
    ...
    <div class="panel panel-default">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-md-1 col-sm-12 col-xs-12"></div>
                                                            ...
                                                            <div class="panel-heading text-center"><b>Applicant Project Details (Annexure 1 as per logistic & warehousing rule)</b></div>
													       ...
													       <hr class="myhrline" />
                                                                               <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                            Proposed date for setting up logistic unit :
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <asp:TextBox ID="txtDateofSettingUnit" runat="server" CssClass="date input-sm similar-select1"  onblur ="ValidateRequired(this,'Proposed date for setting up logistic unit');"></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                               <div class="form-group">
                                                                                     <div class="row">
															                            ...
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <asp:TextBox ID="txtDateCapitalInvestment" runat="server" CssClass="date input-sm similar-select1"  onblur ="ValidateRequired(this,'Proposed date for setting up logistic unit');"></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                               <div class="form-group">
                                                                                     <div class="row">
															                            ...
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtProposedInvestment" runat="server" CssClass="input-sm similar-select1" Width="98%"  onblur ="ValidateRequired(this,'Proposed date for setting up logistic unit');"></asp:TextBox>
															                           </div>
														                            </div>
                                                  ...
                                                  <p class="panel-heading font-bold">Investment Details</p>
                                                                        <div class="form-group">
														                            <div class="row">
															                            <label class="col-md-4 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                             Cost of the Land(In Cr):
															                            </label>
															                            <div class="col-md-2 col-sm-6 col-xs-6">
																                             <i class="fa fa-inr"></i><asp:TextBox ID="txtCostofland" runat="server" CssClass="input-sm similar-select1" Width="93%" onkeypress="return isDecimalKey(event);" onblur ="ValidateRequired(this,'Cost of the Land');"></asp:TextBox>
															                            </div>
                                                                                        <div class="hidden-lg hidden-md"><div class="clearfix"></div></div>
														                    
															                            <label class="col-md-4 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                            Cost of Infrastructures(In Cr) :
															                            </label>
															                            <div class="col-md-2 col-sm-6 col-xs-6">
																                            <asp:TextBox ID="txtCostofinfrastructure" runat="server" CssClass="input-sm similar-select1" onkeypress="return isDecimalKey(event);" onblur ="ValidateRequired(this,'Cost of the Infrastructures');"></asp:TextBox>
															                            </div>
														                            </div>
													                            </div>
                                                           <div class="clearfix"></div>
													       <hr class="myhrline" />
                                                                             <div class="form-group">
														                            <div class="row">
															                            <label class="col-md-4 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                             Cost of the Plant & Machinery(In Cr):
															                            </label>
															                            <div class="col-md-2 col-sm-6 col-xs-6">
																                             <i class="fa fa-inr"></i><asp:TextBox ID="txtcostofPlantMachinery" runat="server" CssClass="input-sm similar-select1" Width="93%" onkeypress="return isDecimalKey(event);" onblur ="ValidateRequired(this,'Cost of the Plant & Machinery');"></asp:TextBox>
															                            </div>
                                                                                        <div class="hidden-lg hidden-md"><div class="clearfix"></div></div>
															                            ...
															                            <div class="col-md-2 col-sm-6 col-xs-6">
																                            <asp:TextBox ID="txtothercost" runat="server" CssClass="input-sm similar-select1" onkeypress="return isDecimalKey(event);" onblur ="ValidateRequired(this,'Other Cost');"></asp:TextBox>
															                            </div>
														                            </div>
													                            </div>
													       ...
													       <hr class="myhrline" />
                                                                             <div class="form-group">
														                            <div class="row">
															                            ...
															                            <div class="col-md-2 col-sm-6 col-xs-6">
																                             <i class="fa fa-inr"></i><asp:TextBox ID="txtBuildingCostforConstr" runat="server" CssClass="input-sm similar-select1" Width="93%" onkeypress="return isDecimalKey(event);" onblur ="ValidateRequired(this,'Building Cost for Other Construction');"></asp:TextBox>
															                            </div>
                                                                                        <div class="hidden-lg hidden-md"><div class="clearfix"></div></div>
                                                  ...
                                                  <p class="panel-heading font-bold">Requested benefits by Applicant</p>
                                                                              ...
                                                                              <p class="panel-heading font-bold">Applicant Benefit Details</p>
                                                                               ...
                                                                               <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                           Rebate on Stamp Duty (In Cr)(For 2018 or 2022) :
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtRebateOnStamp" runat="server" CssClass="input-sm similar-select1" Width="98%"  ></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                             <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                           EPF Reimbursement  (More than 100 unskilled workers) (In Cr) (For 2018):
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtEPFReimbursement" runat="server" CssClass="input-sm similar-select1" Width="98%"  ></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                               <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red;">*</span>
																                          <span style="font-size:12px;"> 10% Additional EPF Reimbursement (200 skilled and unskilled workers) (In Cr) (For 2018 or 2022):</span>
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtAdditionalEPFReimbursement" runat="server" CssClass="input-sm similar-select1" Width="98%"  ></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                             <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                           Capital Interest Subsidy (In Cr) (For 2018):
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtCapitalInterestSubsidy" runat="server" CssClass="input-sm similar-select1" Width="98%"  ></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                               <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                           Infrastructure Interest Subsidy (In Cr) (For 2018):
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtInfrastructureInterestSubsidy" runat="server" CssClass="input-sm similar-select1" Width="98%"  ></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                              <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                           Rebate on Land use conversion  charges (In Cr) (For 2018 or 2022):
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtRebateLandUseConversion" runat="server" CssClass="input-sm similar-select1" Width="98%"  ></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                             <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                           Exemption from development charges (In Cr) (For 2018 or 2022):
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                <%--  <i class="fa fa-inr"></i> <asp:TextBox ID="txtExemptionDevelopmentCharges" runat="server" CssClass="input-sm similar-select1" Width="98%"  onblur ="ValidateRequired(this,'Exemption from development charges');"></asp:TextBox>--%>
                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtExemptionDevelopmentCharges" runat="server" CssClass="input-sm similar-select1" Width="98%"  ></asp:TextBox>
													       ...
													       <hr class="myhrline" />
                                                                              <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                           Electricity Rebate (In Cr) (For 2018 or 2022):
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6"> 
                                                                                            <%--<i class="fa fa-inr"></i> <asp:TextBox ID="txtElectricityRebate" runat="server" CssClass="input-sm similar-select1" Width="98%"  onblur ="ValidateRequired(this,'Electricity Rebate');"></asp:TextBox>--%>                      
                                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtElectricityRebate" runat="server" CssClass="input-sm similar-select1" Width="98%"  ></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                             <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                           Warehousing quality certification reimbursement (In Cr) (For 2018 or 2022):
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtWarehousingCertification" runat="server" CssClass="input-sm similar-select1" Width="98%"  ></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                             <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                           500/- per month assistance for payroll of disabled workers (In Cr) (For 2018):
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtAssistanceForPayroll" runat="server" CssClass="input-sm similar-select1" Width="98%"  ></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                             <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                           Skill development promotion (In Cr) (For 2018 or 2022):
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtSkillDevelopmentPromotion" runat="server" CssClass="input-sm similar-select1" Width="98%"  ></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                              <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                           Intelligent Logistic Incentives (In Cr)(For 2018) :
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtIntelligentLogisticIncentives" runat="server" CssClass="input-sm similar-select1" Width="98%"  ></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                              <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                           Capital Subsidy (In Cr)(For 2022) :
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                       
                                                                                                 <i class="fa fa-inr"></i> <asp:TextBox ID="txtCapitalSubsidy" runat="server" CssClass="input-sm similar-select1" Width="98%"  ></asp:TextBox>
															                           </div>
														                            </div>
													       ...
													       <hr class="myhrline" />
                                                                              <div class="form-group">
                                                                                     <div class="row">
															                            <label class="col-md-6 col-sm-6 col-xs-6 text-right">
                                                                                            <span style="color: Red">*</span>
																                           Please Select Subsidy Type :
															                            </label>
															                            <div class="col-md-6 col-sm-6 col-xs-6">                    
                                                                                            <asp:CheckBox ID="CheckBoxFront" runat="server" Text="Front End" /> <asp:CheckBox ID="CheckBoxBack" runat="server" Text="Back End" />          
													       ...
													       <div class="clearfix"></div>
													       <hr class="myhrline" />
<div runat="server" id="Div1" class="col-md-12 col-sm-12 col-xs-12 text-center" ><asp:Button runat="server" ID="Button1" CssClass="btn btn-sm btn-primary" Text="Submit" Style="text-align:center;padding: 4px 10px !important;margin: 10px 0;" OnClientClick="return ccheck2();" OnClick="BtnProjectInsert_Click"/></div>
                                                        </asp:View>
 ...
 <div class="clearfix"></div>
    ...
    <div class="panel panel-default">
        <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <asp:TextBox ID="txtDistrict" runat="server" CssClass="similar-select1 input-sm" onblur="ValidateRequired(this,'District');"></asp:TextBox>
                                    </div>
                                    </div>
                                    </div>
                                    <div class="clearfix"></div>
                                  ...
                                  <div class="clearfix"></div>
                                   ...
                                   <div class="clearfix"></div>
                                    ...
                                    <div class="clearfix"></div>
                                    <div runat="server" id="Div2" class="col-md-12 col-sm-12 col-xs-12 text-center" ><asp:Button runat="server" ID="btnAddLandDetails" CssClass="btn btn-sm btn-primary" Text="Add Detail" Style="text-align:center;padding: 4px 10px !important;margin: 10px 0;" OnClientClick="return ccheck33();" OnClick="btnAddLandDetails_Click"  />&nbsp;<asp:Button runat="server" ID="btnClearLandDetails" CssClass="btn btn-sm btn-primary" Text="Clear" Style="text-align:center;padding: 4px 10px !important;margin: 10px 0;" OnClick="btnClearLandDetails_Click"  /></div>
        ...
        <%-- <asp:Button runat="server" Visible="false" ID="btnSample" Text="" OnClick="GetServiceChecklists_SP_BY_Condtion_Function" />  --%>    
                        ...
                        <ul class="nav nav-pills myul-tabs" style="margin-left:0;">
                            <asp:Panel ID="pnlDemo" runat="server">
                                <asp:LinkButton ID="LinkButton1" runat="server" Text="List of Attachment in 2018" CssClass="font-bold sub_menu_active" OnClick="LinkButton1_Click"></asp:LinkButton>
                ...
                <div class="div-report" runat="server"  style="text-align: center;">                 
	                ...
	                (Head Office: A-1/4, LAKHANPUR, POSTBOX NO. 1050, KANPUR 208024)</strong><br /><br /><div style = "border-top:3px solid #ffc511;">&nbsp;</div>
                                        <%--<asp:PlaceHolder ID="PlaceHolder1" runat="server"></asp:PlaceHolder>--%>
                                          <span class="pull-right font-bold">Dated:  May 18, 2023</span><br/><h2 style = "text-decoration:underline;" >  Statement of Estimated Deposits</h2><br/>
                              <div class='col- md-6'>
                        ...
                        <table class="table table-bordered table-hover request-table">
                            ...
                            <tr style = 'background:#f7f7f7;'>
                               ...
                               <tr><td colspan="3">A. Applicable Fees</td></tr> <tr> <td class='text-center'> 1 </td> <td class='text-center'> Processing Fess Against Application Under Warehousing & Logistic </td> <td class='text-center'> 10000</td> </tr>  <tr> <td class='text-center'> 2 </td> <td class='text-center'> GST 18% </td> <td class='text-center'> 1800</td> </tr> 
...
<%--                                       <asp:TextBox ID="TextBox14" runat="server" CssClass="similar-select1 input-sm" Visible="false"></asp:TextBox>--%>
    ...
    <script>
        ...
        function ccheck2() {
            var remark = true;
            var txtDateofSettingUnit = document.getElementById("<%= txtDateofSettingUnit.ClientID %>");
            ...
            var txtCostofland = document.getElementById("<%= txtCostofland.ClientID %>");
            var txtCostofinfrastructure = document.getElementById("<%= txtCostofinfrastructure.ClientID %>");
            var txtcostofPlantMachinery = document.getElementById("<%= txtcostofPlantMachinery.ClientID %>");
            ...
            var txtRebateOnStamp = document.getElementById("<%= txtRebateOnStamp.ClientID %>");
            var txtEPFReimbursement = document.getElementById("<%= txtEPFReimbursement.ClientID %>");
            var txtAdditionalEPFReimbursement = document.getElementById("<%= txtAdditionalEPFReimbursement.ClientID %>");
            var txtCapitalInterestSubsidy = document.getElementById("<%= txtCapitalInterestSubsidy.ClientID %>");
             var txtInfrastructureInterestSubsidy      = document.getElementById("<%= txtInfrastructureInterestSubsidy.ClientID %>");
             var txtRebateLandUseConversion            = document.getElementById("<%= txtRebateLandUseConversion.ClientID %>");
             var txtExemptionDevelopmentCharges        = document.getElementById("<%= txtExemptionDevelopmentCharges.ClientID %>");
             var txtElectricityRebate                  = document.getElementById("<%= txtElectricityRebate.ClientID %>");
             var txtWarehousingCertification           = document.getElementById("<%= txtWarehousingCertification.ClientID %>");
             var txtAssistanceForPayroll               = document.getElementById("<%= txtAssistanceForPayroll.ClientID %>");
             var txtSkillDevelopmentPromotion          = document.getElementById("<%= txtSkillDevelopmentPromotion.ClientID %>");
             var txtIntelligentLogisticIncentives      = document.getElementById("<%= txtIntelligentLogisticIncentives.ClientID %>");
             var ddlTypeProject                        = document.getElementById("<%= ddlTypeProject.ClientID %>");
             var ddlCategoryProject                    = document.getElementById("<%= ddlCategoryProject.ClientID %>");


             if (txtDateofSettingUnit.value.length <= 0) {
                txtDateofSettingUnit.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                txtDateofSettingUnit.style.borderColor = "";
            }

             if (txtDateCapitalInvestment.value.length <= 0) {
                txtDateCapitalInvestment.style.borderColor = '#e52213';
                remark = false;
            }
             else 
            {
                txtDateCapitalInvestment.style.borderColor = "";
            }

             if (txtProposedInvestment.value.length <= 0) {
                txtProposedInvestment.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                txtProposedInvestment.style.borderColor = "";
            }

             if (txtCostofland.value.length <= 0) {
                txtCostofland.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                txtCostofland.style.borderColor = "";
             }

             if (txtCostofinfrastructure.value.length <= 0) {
                txtCostofinfrastructure.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                txtCostofinfrastructure.style.borderColor = "";
            }

             if (txtcostofPlantMachinery.value.length <= 0) {
                txtcostofPlantMachinery.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                txtcostofPlantMachinery.style.borderColor = "";
            }

             if (txtothercost.value.length <= 0) {
                txtothercost.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                txtothercost.style.borderColor = "";
            }

             if (txtTotalAmountRequested.value.length <= 0) {
                txtTotalAmountRequested.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                txtTotalAmountRequested.style.borderColor = "";
            }

             if (txtRebateOnStamp.value.length <= 0) {
                txtRebateOnStamp.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                txtRebateOnStamp.style.borderColor = "";
             }
               
             if (txtEPFReimbursement.value.length <= 0) {
                txtEPFReimbursement.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                txtEPFReimbursement.style.borderColor = "";
            }

             if (txtAdditionalEPFReimbursement.value.length <= 0)
             {
                txtAdditionalEPFReimbursement.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                txtAdditionalEPFReimbursement.style.borderColor = "";
             }

             if (ddlTypeProject.selectedIndex == 0) {
                ddlTypeProject.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                 ddlTypeProject.style.borderColor = "";
             }

             if (ddlCategoryProject.selectedIndex == 0)
             {
                ddlCategoryProject.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                ddlCategoryProject.style.borderColor = "";
             }
           
             if (txtCapitalInterestSubsidy.value.length <= 0) {
                txtCapitalInterestSubsidy.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                txtCapitalInterestSubsidy.style.borderColor = "";
             }


             if (txtInfrastructureInterestSubsidy.value.length <= 0)
             {
                txtInfrastructureInterestSubsidy.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                txtInfrastructureInterestSubsidy.style.borderColor = "";
            }


             if (txtRebateLandUseConversion.value.length <= 0)
             {
                txtRebateLandUseConversion.style.borderColor = '#e52213';
                 remark = false;
             }
             else
             {
                txtRebateLandUseConversion.style.borderColor = "";
             }

             if (txtExemptionDevelopmentCharges.value.length <= 0) {
                txtExemptionDevelopmentCharges.style.borderColor = '#e52213';
                remark = false;
            }
             else {
                txtExemptionDevelopmentCharges.style.borderColor = "";
            }

             if (txtAssistanceForPayroll.value.length <= 0) {
                txtAssistanceForPayroll.style.borderColor = '#e52213';
                remark = false;
            }
             else {
                txtAssistanceForPayroll.style.borderColor = "";
            }

            if (txtElectricityRebate.value.length <= 0) {
                txtElectricityRebate.style.borderColor = '#e52213';
                remark = false;
            }
            else {
                txtElectricityRebate.style.borderColor = "";
            }

             if (txtWarehousingCertification.value.length <= 0) {
                txtWarehousingCertification.style.borderColor = '#e52213';
                remark = false;
            }
             else {
                txtWarehousingCertification.style.borderColor = "";
            }

             if (txtSkillDevelopmentPromotion.value.length <= 0) {
                txtSkillDevelopmentPromotion.style.borderColor = '#e52213';
                remark = false;
            }
             else {
                txtSkillDevelopmentPromotion.style.borderColor = "";
            }

             if (txtIntelligentLogisticIncentives.value.length <= 0) {
                txtIntelligentLogisticIncentives.style.borderColor = '#e52213';
                remark = false;
            }
             else {
                txtIntelligentLogisticIncentives.style.borderColor = "";
            }
