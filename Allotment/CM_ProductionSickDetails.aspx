<%@ Page Title="" Language="C#" MasterPageFile="~/CM_MainUser.Master" AutoEventWireup="true" CodeBehind="CM_ProductionSickDetails.aspx.cs" Inherits="Allotment.ProductionSickDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading font-bold">
                    Details of Sick Units/Production Stopped                       
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-3 col-sm-12 text-right">
                                <span style="color: Red">*</span>
                                Regional Office/Industrial Sector :
                            </label>
                            <div class="col-md-9 col-sm-12">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <asp:TextBox ID="txtContactNumber" onkeypress="return isNumberKey(event);" onblur="return validatephone(this)" runat="server" CssClass="input-sm similar-select1"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                ...
                <div class="panel-heading">
                    <div class="col-md-6 col-sm-12" style="margin-top: 5px;">
                        <label class="col-md-6 ">
                            Total Plots Where Production Stopped  :
                        </label>
                        <asp:Label ID="lblTotal" runat="server" class="col-md-6s"></asp:Label>
                    </div>
                    ...
                    <div class="panel-body gallery  table-responsive">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" ShowFooter="true" ShowHeaderWhenEmpty="true"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PlotNumber" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="14%" HeaderText="Plot Number " />
                                <asp:BoundField DataField="AllotmentIssueDate1" HeaderStyle-HorizontalAlign="Center" HeaderText="AllotmentDate" />
                                <asp:BoundField DataField="TotalArea" HeaderStyle-HorizontalAlign="Center" HeaderText="Area of Vacant Plot (In Sq.Mtr)" ItemStyle-Width="10%" />
    ...
    <script type="text/javascript">
        ...
        function Popup(data) {
            ...
            mywindow.document.write('<html><head><title style="font-weight:bold;">SICK UNITS DETAIL</title>');
