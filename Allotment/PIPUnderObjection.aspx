<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="PIPUnderObjection.aspx.cs" Inherits="Allotment.PIPUnderObjection" %>
    ...
    <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="bg-mywhite performance-textdiv">
                        <p class="pmt-text pmt-text-color">Private Industrial Parks</p>
        ...
        <div class="col-md-6 col-sm-12 col-xs-12"> 
            <div class="div6-right bg-mywhite">
               ...
               <asp:GridView ID="grid_Announcement_List" runat="server" CssClass="table table-striped table-bordered table-hover request-table request-table"
                            ClientIDMode="Static"
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                ...
                <ASP:HYPERLINKFIELD text="View" datanavigateurlfields="ServiceRequestNo"  datanavigateurlformatstring="PIPAssessmentProcess.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
                <asp:BoundField DataField = "ServiceRequestNo"    HeaderText = "Application No"/>
                <asp:BoundField DataField = "AllotteeName"       HeaderText = "Applicant Name"/>
                <asp:BoundField DataField = "CompanyName"         HeaderText = "Company Name"  />
                <asp:BoundField DataField = "ServiceSubmitDate" HeaderText = "Form Submission Date" DataFormatString="{0:dd-M-yyyy}" />
                <asp:BoundField DataField = "QueriedOn"       HeaderText = "Objection Date"       DataFormatString="{0:dd-M-yyyy}" />      
                ...
                <div  class="table-responsive" style="overflow-y: auto; max-height: 390px;">
                    <asp:GridView ID="ChangeOfProject_Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField Text="Process" DataNavigateUrlFields="ServiceRequestNo" DataNavigateUrlFormatString="PIPFINAssessmentProcess.aspx?ServiceReqNo={0}"></asp:HyperLinkField>
                            <asp:BoundField DataField="ServiceRequestNo" HeaderText="Application No" />
                            <asp:BoundField DataField="AllotteeName" HeaderText="Applicant Name" />
                            <asp:BoundField DataField="CompanyName" HeaderText="Company Name" />
                            <asp:BoundField DataField="ServiceSubmitDate" HeaderText="Form Submission Date" DataFormatString="{0:dd-M-yyyy}" />
