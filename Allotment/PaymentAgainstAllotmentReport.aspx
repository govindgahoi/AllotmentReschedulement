<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="PaymentAgainstAllotmentReport.aspx.cs" Inherits="Allotment.PaymentAgainstAllotmentReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div  id="DivP" style="text-align: center;padding: 15px 7px; margin: 25px 0%;background: #fbfbfb;border: 1px solid #ccc;">
