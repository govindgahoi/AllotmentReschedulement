<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" Debug="true" CodeBehind="IALeaseMaster.aspx.cs"
    Inherits="Allotment.IALeaseMaster" MaintainScrollPositionOnPostback="true" %>
    ...
    <asp:Label ID="RateIdlbl" runat="server" Visible="false"></asp:Label>
      <div class="panel">
                        <div class="panel-heading font-bold" style="text-align:center;">
                          Industrial Area Lease Rate Master                          
                        </div>
           <div class="panel-body">
                                        <div class="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10 col-sm-12">
                                                    <asp:TextBox ID="txtEffectiveFromDate" runat="server" CssClass="date input-sm similar-select1"  OnTextChanged="txtEffectiveFromDate_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                            <hr class="myhrline" />
      ...
      <div class="panel">
                     <div class="clearfix"></div>
                                    <div class="panel-heading">
                                        <div class="col-md-4" style="margin-top:12px;">
                                            <b>Existing Rate Record</b>
                                        </div>
                                        <div class="input-group col-md-8 col-sm-12 text-right" style="padding:2px;">
                                          <asp:TextBox ID="txtSearch" Width="200px" CssClass="similar-select input-sm" runat="server" AutoPostBack="true" OnTextChanged="txtSearch_TextChanged"   />
                    ...
                    <div class="panel-body gallery  table-responsive">
                        ...
                        <asp:GridView ID="IARateGrid" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="15" CssClass="table table-striped table-bordered table-hover request-table" OnRowCommand="IARateGrid_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Rate" HeaderText="Lease Rate" SortExpression="Rate" />
                               
                                <asp:BoundField DataField="Effective_From" HeaderText="Effective From Date" SortExpression="EffectiveFromDate" DataFormatString="{0:dd-MMM-yyyy}" />
                                 <asp:BoundField DataField="Effective_To" HeaderText="Effective To Date" SortExpression="EffectiveToDate" DataFormatString="{0:dd-MMM-yyyy}" />
