...
namespace Allotment
{
    public partial class PIPUnderProcess : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGridView()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfPIPUnderProcess1(objServiceTimelinesBEL);
                ...
                dsfin = objMbal.GetApplicationForPIPFINUnderProcess(objServiceTimelinesBEL);
                if (dsfin.Tables[0].Rows.Count > 0)
                {
                    ChangeOfProject_Grid.DataSource = dsfin.Tables[0];
        ...
        private void BindAlertServiceRequestGridView()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetAlertApplicationOfPIPUnderProcess(objServiceTimelinesBEL);
                if (ds.Tables[0].Rows.Count > 0)
                {
