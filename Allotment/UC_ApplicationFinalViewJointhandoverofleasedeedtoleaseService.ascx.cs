...
namespace Allotment
{
    public partial class UC_ApplicationFinalViewJointhandoverofleasedeedtoleaseService : System.Web.UI.UserControl
    {
        ...
        private void GetApplicantDetails(String ID)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        lblHandOverleasedeed.Text = dt2.Rows[0]["description"].ToString();
                    }
