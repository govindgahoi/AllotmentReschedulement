...
namespace Allotment
{
    public partial class PIPAssessment : System.Web.UI.Page
    {
        ...
        protected void MenuMaker()
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    SqlCommand cmd1 = new SqlCommand("select * from ServiceRequest_Track_PIP where Transfer_From ='MD@UPSIDC' and FromUser ='MD@UPSIDC'  and isActive = '0' and Status = 'Approve' and ServiceId ='" + ServiceReqNo + "'", con);
                    SqlDataAdapter adp1 = new SqlDataAdapter(cmd1);
                    DataTable dtM1 = new DataTable();
                    adp1.Fill(dtM1);
                    if (dtM1.Rows.Count > 1)
                    {
                        IDCount = "1";
                    }
                    else
