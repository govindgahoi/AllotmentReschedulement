<%@ Page Language="C#" MasterPageFile="~/MainLidaUser.Master" AutoEventWireup="true" CodeBehind="LidaServiceRequestNew.aspx.cs" Inherits="Allotment.LidaServiceRequestNew" %>
...
<asp:BoundField  ItemStyle-BorderWidth="0" DataField="ALERTMESSAGE" /> 
   ...
   <div class="clearfix"></div>
    ...
    <asp:View runat="server" ID="BuildingView">
        ...
        <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="lida_allotee_id"  datanavigateurlformatstring="LidaBuildingPlanAssessment.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
