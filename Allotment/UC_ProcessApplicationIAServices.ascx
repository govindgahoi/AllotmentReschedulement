<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ProcessApplicationIAServices.ascx.cs" Inherits="Allotment.UC_ProcessApplicationIAServices" %>
...
<table class="request-table" style="border: 2px solid #adadad; width: 100%;" id="UploadTB" runat="server" visible="false">
    <tr>
        ...
        <td>
            <asp:FileUpload ID="fileupload" Width="97%" CssClass="form-control" runat="server" /></td>
        <td>
            <asp:Button ID="btnUpload" runat="server" CssClass="btn btn-primary ey-bg btn-sm" Style="margin: 0 1px 0 0; width: 65px;" Text="Upload" OnClick="btnUpload_Click" /></td>
        <td>
            <asp:LinkButton runat="server" aria-hidden="true" ID="btnInspectionReport" CssClass="fa fa-eye" OnClick="btnInspectionReport_Click" /></td>
    </tr>
</table>
...
<span class="pull-right">
    <asp:Button runat="server" Text="Send" ID="btnSend" class="btn-primary btn-sm margin-left-z" Style="margin: 7px 10px;" OnClientClick="javascript:return confirm('Please Check the data before transferring application');" OnClick="btnSend_Click" />
</span>
