...
namespace Allotment
{
    public partial class IAServiceAccountDetails : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGrid()
        {
            ...
            try
            {
                ds = objServiceTimelinesBLL.GetListOfIAServiceAccountDetails(objServiceTimelinesBEL);
        ...
        private void BindServiceRequestClearedGrid()
        {
            ...
            try
            {
                ds = objServiceTimelinesBLL.GetListOfIAServiceAccountDetailsCleared(objServiceTimelinesBEL);
        ...
        protected void ApplicationGrid_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Cells[1].Attributes.Add("onclick", "ShowPopupChange('" + HttpContext.Current.Server.HtmlDecode(e.Row.Cells[9].Text) + "','Account Clearence','" + HttpContext.Current.Server.HtmlDecode(e.Row.Cells[1].Text) + "','" + HttpContext.Current.Server.HtmlDecode(e.Row.Cells[5].Text) + "'); return false;");
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (gm.ValidateDate(txtReceivedDate.Text))
                {
                    ...
                    int result = objServiceTimelinesBLL.UpdateApplicationAfterAccountClearenceIAService(objServiceTimelinesBEL);
                    if (result > 0)
                    {
