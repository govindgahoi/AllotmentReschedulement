<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewInspectionDocument.aspx.cs" Inherits="Allotment.ViewInspectionDocument" %>
...
<head id="Head1" runat="server">
    ...
    <style>
        * {
        ...
        #InspectionGridView tr th {
            text-align: center;
        }

        #InspectionGridView tr td {
            text-align: center;
        }
    </style>
                                    ...
                                    <div class="row well well-large offset4 well-minht">
                                        <div class="col-md-12 well well-large offset4">
                                            <p style="text-align: center; margin-bottom: 0;">
                                                <label><b>Disclosure of the UPSIDC Inspection Releted Document</b> </label>
                                            </p>
                                        </div>
                                        <div class="col-md-12 well well-large offset4">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body gallery">
                                                ...
                                                <asp:GridView ID="InspectionGridView" runat="server" AutoGenerateColumns="false" OnRowCommand="InspectionGridView_RowCommand1"
