...
namespace Allotment
{
    public partial class DocViewerHeadMinutes : System.Web.UI.Page
    {
        ...
        private void ViewDoc()
        {
            ...
            if (dtDoc.Rows.Count > 0)
            {
                ...
                ltEmbed.Text = string.Format(embed, ResolveUrl("/DocViewerHeadMinutes.ashx?ServiceRequestNO=" + ServiceReqNo.Trim() + ""));
