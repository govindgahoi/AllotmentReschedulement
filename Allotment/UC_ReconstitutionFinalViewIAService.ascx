<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ReconstitutionFinalViewIAService.ascx.cs" Inherits="Allotment.UC_ReconstitutionFinalViewIAService" %>
            ...
            <div  id="DivP" style="padding: 15px 25px; margin: 25px;background: #fbfbfb;border: 1px solid #ccc;">
                ...
                <style>
                    ...
                    <div class="my-div-report">
                        <div style="text-align:center;font-size: 18px;font-weight: 600;"><asp:Label runat="server" ID="lblFormName" Text="Application Form For Reconstitution"></asp:Label></div><br />
                        <div style="clear:both;"></div>
                            <div style="width:75%;float:left;font-weight:600;" class="col-md-9">
                                ...
                                Dear Sir/Madam,<br />
                                        &nbsp;&nbsp;&nbsp;&nbsp;I Hereby submit the request for Reconstitution as per the following details.<br />
                            </div>
