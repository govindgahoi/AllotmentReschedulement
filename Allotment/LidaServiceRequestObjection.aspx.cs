...
namespace Allotment
{
    public partial class LidaServiceRequestObjection : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGridView()
        {
            ...
            try
            {
                ...
                //ds = objServiceTimelinesBLL.GetApplicationOfLidaBuildingPlanUnderObjection(objServiceTimelinesBEL);
                ds = objServiceTimelinesBLL.GetApplicationOfLidaBuildingPlanUnderObjection(objServiceTimelinesBEL);
        ...
        private void Bind_Announcement_List_GridView()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetLidaBPNotApprovedUnderObjection(objServiceTimelinesBEL);
                if (ds.Tables[0].Rows.Count > 0)
