<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" Debug="true" CodeBehind="IAMaintenanceChargeMaster.aspx.cs"
    Inherits="Allotment.IAMaintenanceChargeMaster" MaintainScrollPositionOnPostback="true" %>
    ...
    <asp:Label ID="RateIdlbl" runat="server" Visible="false"></asp:Label>
      <div class="panel">
                        <div class="panel-heading font-bold" style="text-align:center;">
                          Industrial Area Maintenance Charge                         
                        </div>
                     ...
                     <div class="clearfix"></div>
                                    <div class="panel-heading">
                                        <div class="col-md-8 col-sm-4 col-xs-12 font-bold" style="margin-top:6px;">
                                            Existing Transfer Levy Percentage
                                        </div>
                    ...
                    <div class="panel-body  table-responsive">
                        ...
                        <asp:GridView ID="IARateGrid" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" CssClass="table table-striped table-bordered table-hover request-table" OnRowCommand="IARateGrid_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Rate" HeaderText="Transfer Levy %" SortExpression="Rate" />
                                ...
                                <asp:TemplateField HeaderText="Remove">
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton runat="server" ID="btnDelete" class="fa fa-trash" CommandName="DeleteRate" OnClientClick="javascript:return confirm('Are you sure wanted to delete?');" CommandArgument='<%#Eval("Id")+"/"+ Eval("IndustrialArea") %>'    ToolTip="Click here to delete Rate" />
                                        </span>  
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
