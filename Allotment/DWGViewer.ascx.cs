...
namespace Allotment
{
    public partial class DWGViewer : System.Web.UI.UserControl
    {
        SqlConnection con;
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from CheckListDocument where ServiceTimeLinesID=1 and ServiceReqID='" + p + "' and DocumentID='" + d + "'", con);
