...
namespace Allotment
{
    public partial class ServiceRequestUnderObjectionLeaseDeed : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGridViewLeaseDeed()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOLeaseDeedUnderObjection(objServiceTimelinesBEL);
