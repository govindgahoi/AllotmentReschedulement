<%@ Page Title="" Language="C#" MasterPageFile="~/MainUserOD.Master" AutoEventWireup="true" CodeBehind="LogisticAndWarehousingUnderProcess1.aspx.cs" Inherits="Allotment.LogisticAndWarehousingUnderProcess1" %>
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                ...
                <ASP:HYPERLINKFIELD text="View" datanavigateurlfields="ServiceRequestNo"  datanavigateurlformatstring="LAWAssessmentProcess1.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
