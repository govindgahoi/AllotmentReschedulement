...
namespace Allotment
{
    public partial class LetterView_ByServiceRequestNo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string id = Request.QueryString["ServiceRequestNo"];
        ...
        protected void DocumentViewer(string ServiceRequestNo, string DocType)
        {
            Placeholder.Controls.Clear();

            SqlCommand cmd = new SqlCommand(@"select Id ,SignedDocumentContent 'ContentType' ,SignedDocument 'Document' from 
