...
namespace Allotment
{
    public partial class UC_MeetingMinutesLaw : System.Web.UI.UserControl
    {
        SqlConnection con;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnSubmit.Text == "Save")
                {
                    ...
                    string filePath = "~/LAWCorrespondenceLetters/MeetingMinutes/" + Convert.ToString(Session["Name"]);
                    ...
                    int retVal = objServiceTimelinesBLL.InsertMeetingMinutesLAW(objServiceTimelinesBEL);
                    if (retVal > 0)
                    {
                ...
                if (btnSubmit.Text == "Update")
                {
                    ...
                    if (Convert.ToString(Session["Name"]).Length > 0)
                    {
                        filePath = "~/LAWCorrespondenceLetters/MeetingMinutes/" + Convert.ToString(Session["Name"]);
                    }
                    else
                    {
                    ...
                    objServiceTimelinesBEL.CreatedBy = UserName.Trim();
                    objServiceTimelinesBEL.ServiceRequestNO = ServiceReqNo.Trim();
                    int retVal = objServiceTimelinesBLL.UpdateMeetingMinutesLAW(objServiceTimelinesBEL);
                    if (retVal > 0)
                    {
                        if (Convert.ToString(Session["Name"]).Length > 0)
                        {
        ...
        private void BindOfficeOrders()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetAllMeetingMinutesLAW(objServiceTimelinesBEL);
        ...
        protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "DeleteRow")
            {
                ...
                try
                {
                    int retVal = objServiceTimelinesBLL.DeleteMeetingMinutesLAW(objServiceTimelinesBEL);
