...
namespace Allotment
{
    public partial class DocViewerPossession : System.Web.UI.Page
    {
        ...
        private void ViewDoc()
        {
            ...
            if (dtDoc.Rows.Count > 0)
            {
                ...
                ltEmbed.Text = string.Format(embed, ResolveUrl("/DocViewerPossession.ashx?ServiceRequestNO=" + ServiceReqNo.Trim() + "&Type=" + Type + ""));
