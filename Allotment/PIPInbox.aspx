<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="PIPInbox.aspx.cs" Inherits="Allotment.PIPInbox" %>
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                ...
                <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="ServiceRequestNo"  datanavigateurlformatstring="PIPAssessment.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
                        ...
                        <div class="col-md-12">
                            <asp:GridView ID="ChangeOfProject_Grid" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField Text="Process" DataNavigateUrlFields="ServiceRequestNo" DataNavigateUrlFormatString="PIPFINAssessment.aspx?ServiceReqNo={0}"></asp:HyperLinkField>
                                     <asp:BoundField DataField = "ServiceRequestNo"    HeaderText = "Application No"/>
                <asp:BoundField DataField = "AllotteeName"       HeaderText = "Applicant Name"/>
                <asp:BoundField DataField = "CompanyName"         HeaderText = "Company Name"  />
                                      <asp:BoundField DataField = "ServiceSubmitDate" HeaderText = "Form Submission Date" DataFormatString="{0:dd-M-yyyy}" />
