    ...
    public partial class AllotteeApplication : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Label12.Text = ControlID + "--" + UnitID + "--" + ServiceID + "--" + Request_ID + "--";
                //ADDED BY SUNIL
                //ServiceReqNo = "LAW20230710/685";

                /*
                ControlID = "UPSWP230001717";
                Request_ID = "23104546101210340001";
                UnitID = "23000171704210280001";
                ServiceID = "SC21099";                
                */
                ...
                //Request_ID = "20202482702210030002";
                    ...
                    try
                    {
                        ...
                        if (ServiceID == "SC21003")
                        {
                            ...
                            if (dt1.Rows.Count > 0)
                            {
                                lblservicenameBlock.Visible = false;
                            }
                            else
                            {
                                lblservicenameBlock.Visible = true;
                                System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "call_show", "alert('For New Application, Please select OBPAS service for Re-apply.');", true);
                                lblservicenameBlock.Text = "<h1 style='color:#fff;' > For New Application, Please select OBPAS service for Re-apply on Nivesh Mitra,Please Press GoBack Button to redirect Nivesh Mitra </h1>";
                                return;
                            }
                        }

                        if (ServiceID == "SC21034")
                        {
                            SqlCommand cmd = new SqlCommand("select B.ServiceRequestNO,B.Status,IsNull(A.BPFeePaid,'False') 'BPFeePaid',BuildingTraID,isnull(B.IsClarificationReq,0) 'BuildingPlanObjection',isnull(B.IsRejected,0) 'IsRejected',DATEDIFF(DAY,B.CreatedDate,GETDATE()) 'YearsCheck'  from AllotteeMaster A, ServiceRequests B where A.ControlId='" + ControlID + "' and A.UnitId='" + UnitID + "' and A.ServiceID='" + ServiceID + "' and A.NMRequestID='" + Request_ID + "' and A.AllotteeID = B.AllotteeID and B.ServiceTimelinesID in (1,2,3) and isnull(B.IsActive,0)=1", con);
                            SqlDataAdapter adp = new SqlDataAdapter(cmd);
                            DataTable dt1 = new DataTable();
                            ...
                            else
                            {
                                ...
                                lblservicenameBlock.Text = "<h1 style='color:#fff;' > For New Application ,Please Select Amagmation (OBPS) service on Nivesh Mitra,Please Press GoBack Button to redirect Nivesh Mitra </h1>";
                                return;
                            }
                        }
                ...
                {
                    PageHeadingLbl.Text = "Application for Seeking Incentive Under Warehousing and Logistics Policy ";
                    lblServiceName.Text = "Application for Seeking Incentive Under Warehousing and Logistics Policy ";
                ...
                else if (ServiceID.Trim() == "SC21044")
                {
                ...
                else if (ServiceID.Trim() == "SC21045")
                {
                    PageHeadingLbl.Text = "Application for Availing Financial Incentive under PIP ";
                    lblServiceName.Text = "Application for Availing Financial Incentive under PIP ";
                ...
                else if (ServiceID.Trim() == "SC21099")
                {
                    //UPSWP23000171704 / SC21028
                    PageHeadingLbl.Text = "Request for Reschedulementof Dues";
                    lblServiceName.Text = "Request for Reschedulementof Dues";

                    if (ControlID.Length > 0)
                    {
                        //----NiveshMitra();
                        divReScDueBtn.Visible = true;
                        btnDiv.Visible = false;
                        divpip.Visible = false;
                        divpipfin.Visible = false;
                        divReScDue.Visible = false;
                    }                    
                    if (Allotment.ActiveViewIndex <= 0)
                    {
                        if (ControlID.Length > 0)
...
D7
        ...
        protected void proceedAnchor_ServerClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (ServiceID == "SC21045")
                {
                    ...
                    Response.Redirect(string.Format("~/RegistrationLogisticsPIPFin.aspx?NMControlID={0}&NMUnitID={1}&NMServiceID={2}&NMRequestID={3}&AppName={4}&AppEmail={5}&AppMobNo=(6}", NMControlID, NMUnitID, NMServiceID, NMRequestID, AppName, AppEmail, AppMobNo));
                }
                else if (ServiceID == "SC21099")
                {
                    ...
                    Response.Redirect(string.Format("~/RegistrationLogisticsReScDue.aspx?NMControlID={0}&NMUnitID={1}&NMServiceID={2}&NMRequestID={3}&AppName={4}&AppEmail={5}&AppMobNo=(6}", NMControlID, NMUnitID, NMServiceID, NMRequestID, AppName, AppEmail, AppMobNo));
                }
        ...
        protected void btnReScDueTrack_Click(object sender, EventArgs e)
        {
            belBookDetails objServiceTimelinesBEL = new belBookDetails();
            BooksDetails_BLL objServiceTimelinesBLL = new BooksDetails_BLL();
            DataSet ds = new DataSet();
            try
            {
                objServiceTimelinesBEL.ServiceRequestNO = txtServiceRequestNo.Text.Trim();
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "call_show", "OnlyRedirectC('" + txtServiceRequestNo.Text + "');", true);
                    }
                    ...
                    if (TraID == "" || TraID == null)
                    {
                        System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "call_show", "OnlyRedirect('" + txtServiceRequestNo.Text + "');", true);
                    }
                    else
                    {
                        ...
                        if (PayType == "E00329")
                        {
                            if (status == "F")
                            {
                                System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "call_show", "OnlyRedirectPaymentF('" + txtServiceRequestNo.Text + "','" + TraID + "');", true);
                            }
                            if (status == "C")
                            {
                                System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "call_show", "OnlyRedirectPaymentC('" + txtServiceRequestNo.Text + "','" + TraID + "');", true);
        ...
        protected void btngotopip_Click(object sender, EventArgs e)
        {

            if (ServiceID.Trim() == "SC21044")
            {
        ...
        protected void btngotopipfin_Click(object sender, EventArgs e)
        {

            if (ServiceID.Trim() == "SC21045")
            {
                ...
                string AppEmail = HttpUtility.UrlEncode(Encrypt(lblOccupierEmail.Text.Trim()));
                string AppMobNo = HttpUtility.UrlEncode(Encrypt(lblOccupierPhone.Text.Trim()));
                Response.Redirect(string.Format("~/RegistrationLogisticsPIPFin.aspx?NMControlID={0}&NMUnitID={1}&NMServiceID={2}&NMRequestID={3}", NMControlID, NMUnitID, NMServiceID, NMRequestID));
                //Response.Redirect(string.Format("~/RegistrationLogistics.aspx?NMControlID={0}&NMUnitID={1}&NMServiceID={2}&NMRequestID={3}&AppName={4}&AppEmail={5}&AppMobNo=(6}", NMControlID, NMUnitID, NMServiceID, NMRequestID, AppName, AppEmail, AppMobNo));
            }
        }

        protected void btngotoReScDue_Click(object sender, EventArgs e)
        {

            if (ServiceID.Trim() == "SC21099")
            {
                ...
                string AppEmail = HttpUtility.UrlEncode(Encrypt(lblOccupierEmail.Text.Trim()));
                string AppMobNo = HttpUtility.UrlEncode(Encrypt(lblOccupierPhone.Text.Trim()));
                Response.Redirect(string.Format("~/RegistrationLogisticsReScDue.aspx?NMControlID={0}&NMUnitID={1}&NMServiceID={2}&NMRequestID={3}", NMControlID, NMUnitID, NMServiceID, NMRequestID));
                //Response.Redirect(string.Format("~/RegistrationLogistics.aspx?NMControlID={0}&NMUnitID={1}&NMServiceID={2}&NMRequestID={3}&AppName={4}&AppEmail={5}&AppMobNo=(6}", NMControlID, NMUnitID, NMServiceID, NMRequestID, AppName, AppEmail, AppMobNo));
            }
        }
