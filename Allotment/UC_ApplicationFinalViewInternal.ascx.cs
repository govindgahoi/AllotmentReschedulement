...
namespace Allotment
{
    public partial class UC_ApplicationFinalViewInternal : System.Web.UI.UserControl
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            GetTempIDFRromMain(ServiceRequestNo);

        }



        private void GetTempIDFRromMain(string ID)
        {
            belBookDetails objServiceTimelinesBEL = new belBookDetails();
            BooksDetails_BLL objServiceTimelinesBLL = new BooksDetails_BLL();
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetTempReqIDFromMain(objServiceTimelinesBEL);
                string serviceReqNo = ds.Tables[0].Rows[0][0].ToString();
                TranID = ds.Tables[0].Rows[0][1].ToString();
                GetApplicantDetails(serviceReqNo);
                BindApplicableFees(serviceReqNo);
        ...
        private void GetApplicantDetails(String ID)
        {
            ...
            try
            {
                ...
                int j = 0;
                objServiceTimelinesBEL.ServiceRequestNO = ID;
                objServiceTimelinesBEL.ApplicationID = ServiceRequestNo;
                ds = objServiceTimelinesBLL.GetNewApplicantDetailsInternal(objServiceTimelinesBEL);
                ...
                if (dt_project.Rows.Count > 0)
                {
                    ...
                    lblTypeOfIndustry.Text = dt_project.Rows[0]["IAClasification"].ToString();
        ...
        public void BindApplicableFees(string serviceNO)
        {
            ...
            try
            {
                ...
                objServiceTimelinesBEL.ServiceRequestNO = serviceNO;
                objServiceTimelinesBEL.TranID = TranID;

                dst = objServiceTimelinesBLL.GetNivishMitraBasicDetail(serviceNO);
                ...
                dsR = objServiceTimelinesBLL.GetapplicableChargesnData(serviceNO);
                ...
                if (Getdata1.Rows.Count > 0)
                {
                    ...
                    if (Getdata1.Rows.Count > 0)
                    {
                        ...
                        htmldata = @"<span class=""pull-right font-bold"">Dated:  " + ConfirmDate + @"</span><br/><h2 style = ""text-decoration:underline;"" > Accounts  Statement </h2><br />";
