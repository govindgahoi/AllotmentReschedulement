<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_Service_Lida_Fee_Calculation_Details.ascx.cs" Inherits="Allotment.UC_Service_Lida_Fee_Calculation_Details" %>
                                                                ...
                                                                <table class="table-bordered pull-left" width="41%" style="font-size: 12px;">
                                                                    <tbody>
                                                                      ...
                                                                      <%--  <tr style="background: #f7f7f7;">
                                                                            ...
                                                                            <th class="text-left">Kosi Kotwan Extn.-1</th>
                                                                        </tr>--%>
                                                                        <%--<tr style="background: #f7f7f7;">
                                                                            <th>Applied in the name of </th>
                                                                            <th class="text-left"><asp:Label ID="lblnameof" runat="server" Text=""></asp:Label></th>
                                                                        </tr>--%>
                                                                       <%-- <tr style="background: #f7f7f7;">
                                                                            <th>Address </th>
                                                                            <th class="text-left">R/o H.No 185, Near B.V.R. School, Khanvi (118), Khambi, Distt. Palwal (Haryana)</th>
                                                                        </tr>--%>
                                                                        <tr style="background: #f7f7f7;">
                                                                            <th>Payment Mode </th>
                                                                            <th class="text-left"><asp:Label ID="lblpaymode" runat="server" Text=" 	HDFC Bank Retail"></asp:Label></th>
                                                                        </tr>
                                                                        <tr style="background: #f7f7f7;">
                                                                            <th>Transaction Ref No </th>
                                                                            <th class="text-left"><asp:Label ID="lbltxnrefno" runat="server" Text=""></asp:Label></th>
                                                                        </tr>
                                                                        <tr style="background: #f7f7f7;">
                                                                            <th>Transaction Date </th>
                                                                            <th class="text-left"><asp:Label ID="lbltxndt" runat="server" Text=""></asp:Label></th>
                                                                        </tr>
                                                                        <tr style="background: #f7f7f7;">
                                                                            <th>Payment Status </th>
                                                                            <th class="text-left"><asp:Label ID="lblpaystatus" runat="server" Text=""></asp:Label></th>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>
                                                            ...
                                                            <div class="col- md-6">
                                                                <table class="table-bordered pull-left" width="41%" style="font-size: 12px;">
                                                                    <tbody>
                                                                        ...
                                                                        <tr style="background: #f7f7f7;">
                                                                            <th>Plot Area </th>
                                                                            <th class="text-left"><asp:Label ID="lblplotarea" runat="server" Text=""></asp:Label> SQmts</th>
                                                                        </tr>
                                                                        <tr style="background: #f7f7f7;">
                                                                            <th>Builtup/Ground Coverage Area </th>
                                                                            <th class="text-left"><asp:Label ID="lblcoveredarea" runat="server" Text=""></asp:Label> SQmts</th>
                                                                        </tr>
                                                                ...
                                                                <table class="table-bordered pull-right" width="41%" style="font-size: 12px;">
                                                                    <tbody>
                                                                        <tr style="background: #f7f7f7;">
                                                                            ...
                                                                            <th class="text-center"><i class="fa fa-inr"></i><asp:Label ID="Label2" runat="server" Text=""></asp:Label></th>
                                                                        </tr>

                                                                        <tr style="background: #f7f7f7;">
                                                                            <th>Total Applicable Charges </th>
                                                                            <th class="text-center"><i class="fa fa-inr"></i><asp:Label ID="Label3" runat="server" Text=""></asp:Label></th>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>--%>
                                                                ...
                                                                <tbody>
                                                                  ...
                                                                  <%--    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center"><asp:Label ID="lblpermitfee" runat="server" Text=""></asp:Label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-center">2</td>
                                                                        <td class="text-center">Permissive Fee For Temporary Construction</td>
                                                                        <td class="text-center"><asp:Label ID="lblpermitfeefortemp" runat="server" Text=""></asp:Label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-center">3</td>
                                                                        <td class="text-center">Labour Accomatdation Fee</td>
                                                                        <td class="text-center"><asp:Label ID="lbllabourfree" runat="server" Text=""></asp:Label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-center">4</td>
                                                                        <td class="text-center">Inspection Fee on Ground Coverage Area</td>
                                                                        <td class="text-center"><asp:Label ID="lblfeeoncoveredarea" runat="server" Text=""></asp:Label></td>
                                                                    </tr>
                                                                    <tr>
                                                                      <%--  <td class="text-center">5</td>
                                                                        <td class="text-center">Temporary Structure Fee(Labour Hutment)</td>
                                                                        <td class="text-center"><asp:Label ID="Label8" runat="server" Text=""></asp:Label></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-center">6</td>
                                                                        <td class="text-center">Temporary Structure Fee(Other Use)</td>
                                                                        <td class="text-center"><asp:Label ID="Label9" runat="server" Text=""></asp:Label></td>
                                                                    </tr>
                                                                    <tr>--%>


                                                                        <td colspan="2" class="text-center">Total Applicable Fees</td>
                                                                        <th class="text-left"><i class="fa fa-inr"></i><asp:Label ID="lbltotalfee" runat="server" Text=""></asp:Label></th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th colspan="2" class="text-center">Total Payable(with 18 % GST)</th>
                                                                        <th class="text-left"><i class="fa fa-inr"></i><asp:Label ID="lblgstwithfee" runat="server" Text=""></asp:Label></th>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
