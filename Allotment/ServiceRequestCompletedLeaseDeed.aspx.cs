...
namespace Allotment
{
    public partial class ServiceRequestCompletedLeaseDeed : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGridViewLeaseDeed()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfLeaseDeedCompleted(objServiceTimelinesBEL);
