<%@ Page Title="" Language="C#" MasterPageFile="~/MainLidaUser.Master" AutoEventWireup="true" CodeBehind="TrackApplicationLIDA.aspx.cs" Inherits="Allotment.TrackApplicationLIDA" %>
                ...
                <asp:GridView ID="GridView2" runat="server"
                                ...
                                <Columns>
                                   ...
                                   <%-- SELECT ID,ApplicationType,,,Description,serviceRequestNo,LetterCopyfile,CreateDate--%>
                                    ...
                                    <asp:BoundField DataField="LetterNO" ItemStyle-HorizontalAlign="Justify" HeaderText="Lette No" SortExpression="Lette No"/>
                                    ...
                                    <asp:BoundField DataField="ForwardedTo" ItemStyle-HorizontalAlign="Justify" HeaderText="Industrial Area Nameo" SortExpression="IssuedBy" />
                                   <%-- <asp:BoundField DataField="Section" HeaderText="Section" SortExpression="Section" />--%>
