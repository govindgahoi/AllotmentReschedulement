<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllotteeReservationMoneyPayOld.aspx.cs" Inherits="Allotment.AllotteeReservationMoneyPayOld" %>
            ...
            <div class="row" id="SideDiv">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <hr class="separation" />
                        <div class="form-group" runat="server" id="Filter_Div" style="background: #dedede;padding: 2px 0;border: 1px solid #ccc;" visible="false">
                             ...
                             <div class="row" style="border: 15px solid #ccc;">
                                <div class="col-md-12 col-sm-6 col-xs-12" style="border-right: 4px solid #ccc;padding: 0px !important;">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:5px;">                                    
                                        <asp:Button ID="btnPay" runat="server" Text="Pay Now" CssClass="btn-primary ey-bg pull-right" Width="" Style="margin:3px 0;background: #ffc71f;color: #000;Display:none;" OnClick="btnPay_Click"  />                                   
                                    </div>
                                </div>
                            </div>
