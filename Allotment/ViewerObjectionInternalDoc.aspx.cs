...
namespace Allotment
{
    public partial class ViewerObjectionInternalDoc : System.Web.UI.Page
    {
        ...
        private void ViewDoc()
        {
            ...
            if (dtDoc.Rows.Count > 0)
            {
                ...
                contype = dtDoc.Rows[0]["InternalObjDocContent"].ToString().Trim();
                ...
                ltEmbed.Text = string.Format(embed, ResolveUrl("/ViewerObjectionInternalDoc.ashx?ID=" + ID.Trim()));
