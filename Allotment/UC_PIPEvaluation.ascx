<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_PIPEvaluation.ascx.cs" Inherits="Allotment.UC_PIPEvaluation" %>
           ...
           <div>
               <table class="table table-bordered table-hover request-table">
                    ...
                    <tr><td>7</td><td> <span style="font-weight:bold;">Category of project</span><br />a) Private Industrial Parks<br />b) Container Freight Station<br />c) Warehousing Facility<br />d) Cold Chain Facility </td>
                     ...
                     <tr><td>8</td><td> <span style="font-weight:bold;">Registration/Permit for setting Private Industrial Parks Unit  </span></td>
...
<script type="text/javascript">
    ...
    function MsgAndRedirectModify(ID) {
        ...
        window.location.href = 'PIPEvaluationSheetPrint.aspx?ID=' + ID;
