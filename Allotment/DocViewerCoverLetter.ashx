...
public class Viewer : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (dtDoc.Rows.Count > 0)
        {
            ...
            {
                Byte[] bytes = (Byte[])dtDoc.Rows[0]["CoverLetter"];
                string filename = dtDoc.Rows[0]["CoverLetterName"].ToString().Trim();
                ...
                context.Response.ContentType = dtDoc.Rows[0]["CoverContentType"].ToString().Trim();
