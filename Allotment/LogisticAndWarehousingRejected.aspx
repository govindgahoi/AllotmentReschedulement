<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="LogisticAndWarehousingRejected.aspx.cs" Inherits="Allotment.LogisticAndWarehousingRejected" %>
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                ...
                <ASP:HYPERLINKFIELD text="View" datanavigateurlfields="ServiceRequestNo"  datanavigateurlformatstring="LAWAssessmentProcess.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
                ...
                <asp:BoundField DataField = "YearP"         HeaderText = "Police Year"  />
            </Columns>
            <EmptyDataTemplate>
                No Record Available
            </EmptyDataTemplate>
