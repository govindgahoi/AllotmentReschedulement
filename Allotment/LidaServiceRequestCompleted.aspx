<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MainLidaUser.Master" CodeBehind="LidaServiceRequestCompleted.aspx.cs" Inherits="Allotment.LidaServiceRequestCompleted" %>
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
           ...
           <div class="clearfix"></div>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="lida_allotee_id" HeaderText="Service Request" SortExpression="lida_allotee_id" />
                <asp:BoundField DataField="AllotteeName" HeaderText="Applicant Name" SortExpression="AllotteeName" />
                <asp:BoundField DataField="CompletedOn" ItemStyle-HorizontalAlign="Justify" HeaderText="Approved On" SortExpression="CompletedOn" />
