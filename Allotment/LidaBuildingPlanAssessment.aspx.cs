...
namespace Allotment
{
    public partial class LidaBuildingPlanAssessment : System.Web.UI.Page
    {
        ...
        protected void btnApprove_Click(object sender, EventArgs e)
        {
            ...
            //else
            //{
            Response.Redirect("~/LidaReportGeneration.aspx?ServiceReqNo=" + ServiceReqNo, false);
            //}
        }
        ...
        protected void btnClarify_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                #endregion
                //Test
                SqlCommand cmd1 = new SqlCommand("[SendLidaApplicationToAllotteeforQuerySp]", con);
                cmd1.CommandType = CommandType.StoredProcedure;

                cmd1.Parameters.AddWithValue("@ServiceRequestNo", ServiceReqNo);
                cmd1.Parameters.AddWithValue("@RejectedBY", UserName.Trim());
                cmd1.Parameters.AddWithValue("@Role", Level.Trim());
                cmd1.Parameters.AddWithValue("@Reason", txtClarification.Text.Trim());
                cmd1.Parameters.AddWithValue("@ObjectionID", drp_NMObjectionType.SelectedValue.Trim());
                ...
                if (dt1.Rows.Count > 0)
                {
                    ...
                    return_string = (dt1.Rows[0]["Message"].ToString().Trim()).Trim();
                    SendMailUPSIDCBuildingPlan();
                    System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "call_show", "MessageAndRedirect('" + return_string + "');", true);
        ...
        protected void btnRejectM_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                if (dt.Rows[0][1].ToString() == "Close")
                {
                    ...
                    Response.Redirect("~/LidaRejectionLetterGeneration.aspx?ServiceReqNo=" + ServiceReqNo, false);
                }
        ...
        protected void load_UC(string AllOrFirst)
        {
            ...
            if (Menu_Type == "page")
            {
                ...
                {
                    UC_Lida_Service_Applicant_details1 UC_Service_Allotteee_Detail = LoadControl("~/UC_Lida_Service_Applicant_details1.ascx") as UC_Lida_Service_Applicant_details1;
                    UC_Service_Allotteee_Detail.ServiceReqNo = ServiceReqNo;
                ...
                {
                    UC_Comments_LidaBT UC_Comments_LidaBT = LoadControl("~/UC_Comments_LidaBT.ascx") as UC_Comments_LidaBT;
                    UC_Comments_LidaBT.ServiceReqNo = ServiceReqNo;
                    UC_Comments_LidaBT.ID = "UC_Comments_LidaBT";
                    Placeholder.Controls.Add(UC_Comments_LidaBT);

                }
                if (Menu_Value1 == "Building_Details")
                {
                    UC_Service_Building_Plan_Specifications_details UC_BuildingDetails = LoadControl("~/UC_Service_Building_Plan_Specifications_details.ascx") as UC_Service_Building_Plan_Specifications_details;
                ...
                {
                    UC_Lida_PaymentDetails UC_Lida_PaymentDetails = LoadControl("~/UC_Lida_PaymentDetails.ascx") as UC_Lida_PaymentDetails;
                    UC_Lida_PaymentDetails.ServiceReqNo = ServiceReqNo;
                    UC_Lida_PaymentDetails.ID = "UC_Service_Lida_Fee_Calculation_Details1";
                    Placeholder.Controls.Add(UC_Lida_PaymentDetails);
                }

                if (Menu_Value1 == "Process_Application")
                {
                    UC_ProcessApplicationLidaBT UC_ProcessApplicationBT = LoadControl("~/UC_ProcessApplicationLidaBT.ascx") as UC_ProcessApplicationLidaBT;
                ...
                {
                    UC_Service_Document_CheckList_Details UC_Service_Doc_Upload_View = LoadControl("~/UC_Service_Document_CheckList_Details.ascx") as UC_Service_Document_CheckList_Details;
                    UC_Service_Doc_Upload_View.ID = "UC_Service_Document_CheckList_Details";
                ...
                {
                    UC_Service_Architect_Details UC_ArchitectDetails = LoadControl("~/UC_Service_Architect_Details.ascx") as UC_Service_Architect_Details;
                    UC_ArchitectDetails.ID = "UC_Service_Architect_Details";
        ...
        private void SendMailUPSIDCBuildingPlan()
        {
            ...
            {
                string[] SerIdarray = ServiceReqNo.Split('|');
                SqlCommand cmd = new SqlCommand("select Top(1)* from allotee_info where lida_allotee_id='" + ServiceReqNo + "'", con);
                SqlDataAdapter adp = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                adp.Fill(dt);
                ...
                if (dt.Rows.Count > 0)
                {
                    string ApplicantName = dt.Rows[0]["allottee_name"].ToString();
                    string ApplicantEmail = dt.Rows[0]["allottee_email"].ToString();
                    string PhoneNo = dt.Rows[0]["allotee_mobno"].ToString();
                  ...
                  MailAddress mailfrom = new MailAddress("eservicesotp@outlook.com");
                    ...
                    newmsg.Subject = "LIDAeServe: Acknowledgement-Request to resubmit application for Building Plan ";
                    newmsg.BodyHtml = StrContent;
