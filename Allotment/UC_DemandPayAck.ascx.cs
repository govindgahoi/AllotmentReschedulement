...
namespace Allotment
{
    public partial class UC_DemandPayAck : System.Web.UI.UserControl
    {
        ...
        public void BindApplicableFees(string serviceNO)
        {
            ...
            try
            {
                ...
                {
                    Pay_Ds = objServiceTimelinesBLL.GetDemandPaymentDetailAfterTransaction(objServiceTimelinesBEL);
                    Datadt = Pay_Ds.Tables[0];
                    Paymentdt = Pay_Ds.Tables[1];
                    URNDT = Pay_Ds.Tables[2];
                }
                ...
                if (Datadt.Rows.Count > 0)
                {
                    ...
                    if (Datadt.Rows.Count > 0)
                    {
                        ...
                        if (URNDT.Rows.Count > 0)
                        {
                            string URNNo = URNDT.Rows[0]["URNNumber"].ToString();
                            string PayDate = URNDT.Rows[0]["PaymentDate"].ToString();
                            ...
                            htmldata += @"
                              <div class='col- md-6'><table class=""table table-bordered table-hover request-table pull-left"" width='41%' style='Font-Size:12px;'>
                                   ...
                                   <tr style='background:#f7f7f7;'> <td>Applicant Name " + "" + "</td><td style='text-align:left;'>" + Applicantname + @"</td></tr>
                                    ...
                                    <tr style='background:#f7f7f7;'> <td>UTR Number" + "" + "</td><td style='text-align:left;'>" + URNNo + @"</td></tr>
                                    <tr style='background:#f7f7f7;'> <td>Payment Date" + "" + "</td><td style='text-align:left;'>" + PayDate + @"</td></tr>
