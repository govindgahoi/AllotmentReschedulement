...
namespace Allotment
{
    public partial class BuildingPlanAssessmentViewCMIA : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd2 = new SqlCommand("Select SWCControlId,SWCUnitId,SWCServiceId from ApplicationRegister where ApplicationID='" + ServiceReqNo + "'", con);
