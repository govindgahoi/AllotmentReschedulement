...
namespace Allotment
{
    public partial class ApplicationReports : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGrid()
        {
            ...
            try
            {
                ds = objServiceTimelinesBLL.GetListOfApplication(objServiceTimelinesBEL);
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    htmldata += @"<tr style='background:#f7f7f7;'>
                                          <th colspan=""6""class='head-total'><span class=""pull-right"">Total " + region_prev + @"</span></th>
                                           <th class='text-center-imp head-total'>" + pre_totalArea + @"</th>
                                          <th class='text-center-imp head-total'>" + pre_sum + @"</th>
                                            <th class='head-total'></th>
                                          </tr>";
