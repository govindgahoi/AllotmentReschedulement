...
namespace Allotment
{
	public partial class ReportGenrationT : System.Web.UI.Page
	{
		...
		protected void MenuMaker()
		{
			...
			switch (ServiceID.ToString())
			{
                ...
                case "4":
					{
						//////// Plot Transfer 
						sub_menu.Items.Add(new MenuItem { Value = "page|Data_FactsT", Text = "Data Facts & Preview" });
						sub_menu.Items.Add(new MenuItem { Value = "page|Report_View_Genrate", Text = "Report View & Generate" });
		...
		protected void load_UC()
		{
			...
			if (Menu_Type == "page")
			{
                ...
                if (Menu_Value1 == "Data_FactsT")
                {
                    UC_DataFactsT = LoadControl("~/UC_DataFactsT.ascx") as UC_DataFactsT;
                    UC_DataFactsT.ServiceRequestNo = ServiceReqNo;

                    UC_DataFactsT.ID = "UC_DataFactsT";

                    Placeholder.Controls.Add(UC_DataFactsT);
