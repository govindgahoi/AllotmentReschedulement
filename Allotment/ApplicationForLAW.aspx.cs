...
namespace Allotment
{
    public partial class ApplicationForLAW : System.Web.UI.Page
    {
                ...
                if (e.CommandName == "Upload")
                {
                    ...
                    if (fu.HasFile)
                    {
                        ...
                        if (contenttype != String.Empty)
                        {
                            ...
                            objServiceTimelinesBEL.LAWDocPath = "~/LogisticAndWareHousing/" + LblAllotteeId.Text + "/"+Service_Id+"/" + filename;
                            try
                            {
                                int retVal;
                                ...
                                if (retVal > 0)
                                {
                                    ...
                                    string folderPath = Server.MapPath("~/LogisticAndWareHousing/" + LblAllotteeId.Text + "/"+ Service_Id+"/");
