<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DirImageView.aspx.cs" Inherits="Allotment.DirImageView" %>
                  ...
                  <div>
                               <div class="col-md-12 col-sm-12 col-xs-12" style="background:#525659;">
                                   ...
                                   <div class="bp-divviewer">
                                       <asp:Image runat="server" ID="img" ImageUrl="~/images/1200px-Compass_Rose_English_North.svg.png" /> 
                                   </div>
                               </div>
                           </div>
