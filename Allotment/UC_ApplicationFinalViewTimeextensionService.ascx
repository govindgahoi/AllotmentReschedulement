<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ApplicationFinalViewTimeextensionService.ascx.cs" Inherits="Allotment.UC_ApplicationFinalViewTimeextensionService" %>
    ...
    <div id="DivP" style="padding: 15px 25px; margin: 25px; background: #fbfbfb; border: 1px solid #ccc;">
        ...
        <div class="my-div-report">
            <div style="text-align: center; font-size: 18px; font-weight: 600;">
                <asp:Label runat="server" ID="lblFormName" Text="Application Form For Time Extension"></asp:Label>
            </div>
            <br />
            ...
            <div style="width: 75%; float: left; font-weight: 600;" class="col-md-9">
                ...
                <br />
                Dear Sir/Madam,<br />
                &nbsp;&nbsp;&nbsp;&nbsp;I Hereby submit the request for Time extension as per the following details.<br />
            </div>
            ...
            <div class="applicant-detail" style="border: 2px solid #ccc; margin-top: 20px;">
                ...
                <div style="width: 15%; float: right; font-size: 12px; font-weight: 700;" class="col-md-3">
                ...
                <div class="panel panel-default" runat="server" id="tefview">
                    <div class="panel-body table-responsive col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="panel panel-default" runat="server" id="Div1">
                    <p class="panel-heading font-bold allot-heading" style="">Privious Time Extension Details </p>
                    <div class="panel-body table-responsive col-md-12 col-sm-12 col-xs-12">
                        <asp:GridView ID="ApplicantTEFDetails" runat="server" AutoGenerateColumns="false"
                            CssClass="table table-striped table-bordered table-hover request-table">
                            <Columns>
                                <asp:TemplateField HeaderText="S.No" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
            ...
            <div class="timeextensiondetails-detail" style="border: 2px solid #ccc; margin-top: 20px;">
                <div class="col-md-12 col-sm-12 col-xs-12 main-head"><b>Time Extension Fee Application Details</b></div>
                <br />
                <div style="clear: both;"></div>
                <label style="width: 35%; float: left;" class="col-md-3">Time extension Period (In month) :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lbltefperiod" runat="server"></asp:Label>
                </div>
                <div style="clear: both;"></div>
                 <label style="width: 35%; float: left;" class="col-md-3">Do You want to avail free 6 Month Time Extension due to  Covid 19 Pandemic-Lockdown :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblCovid19" runat="server"></asp:Label>
                </div>
                <div style="clear: both;"></div>
                 <label style="width: 35%; float: left;" class="col-md-3"> Time extension applicable as per Allotmentletter/transferletter/leesedeed(TEF Applicable on ):</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblapplicableonAllotmentletter" runat="server"></asp:Label>
                </div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <div class="form-group">
                    <asp:Literal ID="lblApplicationDetails" runat="server" Mode="PassThrough"></asp:Literal>
                </div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
            </div>
