...
namespace Allotment
{
    public partial class UC_ProcessApplication : System.Web.UI.UserControl
    {
        SqlConnection con;
        string ControlID = "";
        string UnitID = "";
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd1 = new SqlCommand("Select SWCControlId,SWCUnitId,SWCServiceId,SWCRequestID,IndustrialArea from ApplicationRegister where ApplicationID='" + ServiceReqNo + "'", con);
                ...
                if (dt1.Rows.Count > 0)
                {
                    ...
                    IAID= Convert.ToInt32(dt1.Rows[0]["IndustrialArea"].ToString());
                }
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            try
            {
                string Forwarded = drpSendto.SelectedValue.Trim();
                string filePath = "";
                ...
                if (DataManager == "Data Approver")
                {
                    ...
                    {
                        if (dt1.Rows[0][2].ToString() == "NotUploaded")
                        {
                            MessageBox1.ShowInfo("Please Upload Cover Letter");
                            return;
                        }
                    }
                }
                ...
                if (retVal > 0)
                {
                    ...
                    this.Page.GetType().InvokeMember("AllertRedirectA", System.Reflection.BindingFlags.InvokeMethod, null, this.Page, new object[] { "Application Transferred To " + drpSendto.SelectedValue.Trim() });
                }
                else
                {
        ...
        private void RegisterPostBackControl()
        {
            ...
            scriptManager.RegisterPostBackControl(btnCover);
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            if (dtDoc.Rows.Count > 0)
            {
                if (dtDoc.Rows[0]["CoverLetter"].ToString().Length > 0)
                {
                    ...
                    //Response.Write("<script>window.open ('DocViewerMinutes.aspx?ServiceReqNo=" + ServiceReqNo.Trim() + "','_blank');</script>");
                    String js = "window.open('DocViewerCoverLetter.aspx?ServiceReqNo=" + ServiceReqNo.Trim() + "', '_blank');";
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "DocViewerCoverLetter.aspx", js, true);
                }
                else
                {
                    MessageBox1.ShowError("Cover Letter Not Uploaded Yet");
                }
            }
        }
        protected void btnCover_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (fileupload1.HasFile)
                {
                    ...
                    retval = objServiceTimelinesBLL.UploadCoverLetter(objServiceTimelinesBEL);
                    if (retval > 0)
                    {
                        MessageBox1.ShowSuccess("Cover Letter Uploaded Successfully !");
                        return;
                    }
                    else
                    {
                ...
                {
                    MessageBox1.ShowError("Please Upload Cover Letter");
                    return;
                }
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (fileupload.HasFile)
                {
                    ...
                    if (retval > 0)
                    {
                        MessageBox1.ShowSuccess("Minutes Uploaded Successfully !");
                        return;
                    }
                    else
                    {
