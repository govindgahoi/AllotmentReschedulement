...
namespace Allotment
{
    public partial class RegistrationLogisticsReSchedule : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (SWCServiceID.Trim() == "SC21045")
                {
                    divwarehouse.Visible = false;
                    divpip.Visible = false;
                ...
                if (!IsPostBack)
                {
                    ...
                    else if (SWCServiceID.Trim() == "SC21044" && recordalreadyexist == false)
                    ...
                    else if (SWCServiceID.Trim() == "SC21045" && recordalreadyexist == false)
        ...
        public void fetchRecordfromdb()
        {
            try
            {
                con.Open();
                string checkQuery;
                if (SWCServiceID.Trim() == "SC21044")
                {
                    checkQuery = "select * from ServiceRequests where RequestID =@RequestID and ControlID=@ControlID";
                }
                else if (SWCServiceID.Trim() == "SC21045")
                {
                    checkQuery = "select * from  PIP_AFARegister where RequestID =@RequestID and ControlID=@ControlID";
                }
                else
                {
                    checkQuery = "select * from LogisticWarehousingRegister where RequestID =@RequestID and ControlID=@ControlID";
                }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "call_show", "alert('Please enter valid UID no');", true);
                    return;
                }
                ...
                {
                    StrContent = StrContent.Replace("{Service}", "Application for Availing Financial Incentive under PIP");
                    newmsg.Subject = "UPSIDAeService: OTP verification for registration of Application for Availing Financial Incentive under PIP";
                }
        ...
        protected void btn_EnterMobileOtp_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtMobOtp.Text.Trim() == ViewState["OTP"].ToString().Trim())
                {
                    ...
                    if (txtUID.Text == "")
                    {
                        System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "call_show", "alert('Please enter valid UID ID');", true);
                        return;
                    }
                    else
                    {
                        ...
                        SqlCommand cmd = new SqlCommand("select * from ServiceRequests where IsCompleted = '1' and UID ='" + txtUID.Text.Trim() + "'", con);
                    ...
                    objServiceTimelinesBEL.UID = txtUID.Text.Trim();
                    ...
                    if (SWCServiceID.Trim() == "SC21036")
                    {
                        result = objServiceTimelinesBLL.SaveLogisticDetails(objServiceTimelinesBEL);
                    }
                    else if (SWCServiceID.Trim() == "SC21044")
                    {
                        ...
                        result = objServiceTimelinesBLL.SavePIPDetails(objServiceTimelinesBEL);
                    }
                    else if (SWCServiceID.Trim() == "SC21045")
                    {
                        ServiceReference1.upswp_niveshmitraservicesSoapClient webService = new ServiceReference1.upswp_niveshmitraservicesSoapClient();
                        ...
                        result = objServiceTimelinesBLL.SavePIPFinDetails(objServiceTimelinesBEL);
                    }
