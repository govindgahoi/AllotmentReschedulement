...
namespace Allotment
{
    public partial class MISReportOutstandingData : System.Web.UI.Page
    {
        ...
        protected void UserpayHeaderBinding()
        {
            objServiceTimelinesBEL.UserName = "Admin1";
            DataSet dsHead = new DataSet();
            try
            {
                dsHead = objServiceTimelinesBLL.GetPayHeaderRecords(objServiceTimelinesBEL);
                ddlPayHeader.DataSource = dsHead.Tables[0];
                ddlPayHeader.DataTextField = "a";
                ddlPayHeader.DataValueField = "b";
                ddlPayHeader.DataBind();
                ddlPayHeader.Items.Insert(0, new ListItem("--ALL--", "All"));
            }
            catch (Exception ex)
            {
                Response.Write("Oops! error occured111 :" + ex.Message.ToString());
        ...
        private void BindServiceRequestGrid()
        {
            ...
            try
            {
                ...
                objServiceTimelinesBEL.Description = (ddlPayHeader.SelectedValue.Trim());
                ...
                ds = objServiceTimelinesBLL.GetListOfOutstandingWise(objServiceTimelinesBEL);
