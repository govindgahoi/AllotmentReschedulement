<%@ Page Title="" Language="C#"  ValidateRequest="false"  MasterPageFile="~/MainUser.Master"  EnableViewState="true" CodeBehind="NewAssessment.aspx.cs" Inherits="Allotment.NewAssessment" %>
...
#ContentPlaceHolder1_sub_menu ul
{
    ...
    <script type='text/javascript'>
        ...
        function MessageAndRedirectNew(par) {
            alert(par);
            window.location.href = 'ServiceRequestInboxNew.aspx';
        }
       ...
       <style>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" >
                    <div class="col-md-12" style="font-size: 12px; padding: 4px 15px;">
                        <asp:TextBox runat="server" ID="txtClarification" CssClass="input-sm similar-select1 margin-left-z" placeholder="Enter Clarification Required From Applicant(Max 500 words)" MaxLength="500" TextMode="MultiLine" Height="250px"></asp:TextBox>
