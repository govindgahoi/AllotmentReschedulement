<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_Document_Report_VG_IA_Notice.ascx.cs" Inherits="Allotment.UC_Document_Report_VG_IA_Notice" %>
...
<div runat="server" class="row" style="border: 1px solid #c5c506;background: #e4e4e4; margin: 6px 0 0 0px; padding: 2px 0;">
    ...
    <div class="col-md-8 col-sm-8 col-xs-8">
        <asp:Button ID="btnSave_Genrate" OnClick="btnSave_Genrate_Click" CssClass="btn btn-sm btn-primary text-right btn-bpservice pull-right" Style="margin-top:0;"  runat="server" Text="Generated Notice" />
