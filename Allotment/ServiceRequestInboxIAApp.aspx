<%@ Page Title="" Language="C#" MasterPageFile="~/MainUserHO.Master" AutoEventWireup="true" CodeBehind="ServiceRequestInboxIAApp.aspx.cs" Inherits="Allotment.ServiceRequestInboxIAApp" %>
...
<script type="text/javascript" src="https://cdn.datatables.net/buttons/1.2.2/js/buttons.html5.min.js"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('[id*=CompletionCertificateGrid]').prepend($("<thead></thead>").append($('[id*=CompletionCertificateGrid]').find("tr:first"))).DataTable({
                dom: 'Bfrtip',
                'aoColumnDefs': [{ 'bSortable': false, 'aTargets': [0] }],
                'iDisplayLength': 20,
                buttons: [
            ...
            $('[id*=OccupancyCertificateGrid]').prepend($("<thead></thead>").append($('[id*=OccupancyCertificateGrid]').find("tr:first"))).DataTable({
                dom: 'Bfrtip',
                'aoColumnDefs': [{ 'bSortable': false, 'aTargets': [0] }],
                'iDisplayLength': 20,
                buttons: [
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center col-sm-4 col-xs-12">
                    <div class="bg-mywhite three-div6in" style="    padding-top: 15px;">
                        <div class="dash-status-inr"> <asp:Label runat="server" ID="TotalPending" Text="10"></asp:Label></span></div>
   ...
   <div class="clearfix"></div>
    <div class="bg-mywhite table-divinbox">
        ...
        <asp:GridView ID="ChangeOfProject_Grid" runat="server"
         ...
         <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="ServiceRequestNO"  datanavigateurlformatstring="IAServicesAssessmentApp.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
      ...
      <asp:BoundField DataField="IAName" HeaderText="IA Name" SortExpression="IAName" />
        ...
        <div class="clearfix"></div>
               ...
               <asp:View runat="server" ID="CompletionCertificateView">
        <div class="col-md-12">
        <asp:GridView ID="CompletionCertificateGrid" runat="server"
             CssClass="table table-striped table-bordered table-hover request-table request-table"
            ClientIDMode="Static"
            AutoGenerateColumns="False"
            DataKeyNames="ServiceRequestNO"
      ...
      <asp:BoundField DataField="IAName" HeaderText="IA Name" SortExpression="IAName" />
        ...
        <div class="clearfix"></div>
              ...
              <asp:View runat="server" ID="OccupancyCertificateView">
        <div class="col-md-12">
        <asp:GridView ID="OccupancyCertificateGrid" runat="server"
             CssClass="table table-striped table-bordered table-hover request-table request-table"
            ClientIDMode="Static"
            AutoGenerateColumns="False"
            DataKeyNames="ServiceRequestNO"
