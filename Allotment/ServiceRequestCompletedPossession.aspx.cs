...
namespace Allotment
{
    public partial class ServiceRequestCompletedPossession : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                sub_menu.Items.Add(new MenuItem { Value = "0", Text = "Possession" });
                sub_menu.DataBind();
        ...
        private void BindServiceRequestGridViewLeaseDeed()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfPossessionCompleted(objServiceTimelinesBEL);
