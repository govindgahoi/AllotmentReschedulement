<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="PIPFINUnderProcess.aspx.cs" Inherits="Allotment.PIPFINUnderProcess" %>
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                ...
                <ASP:HYPERLINKFIELD text="View" datanavigateurlfields="ServiceRequestNo"  datanavigateurlformatstring="PIPAssessment.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
