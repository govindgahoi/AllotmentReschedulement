<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstantLandAllotmentApplication.aspx.cs" Inherits="Allotment.InstantLandAllotmentApplication" %>
													                            ...
													                            <div id="tr6" runat="server" visible="false">
														                            <div class="form-group">
															                            <div class="row">
																                            ...
																                            <div class="col-md-8 col-sm-6 col-xs-6">
																	                            <asp:TextBox ID="txtIndividualPhone" runat="server" CssClass="input-sm similar-select1" MaxLength="15" onblur ="ValidateRequired(this,'Individual Phone No');" onkeypress="return isDecimalKey(event);"></asp:TextBox>
																                            </div>
															                            </div>
														                            </div>
														                            <div class="clearfix"></div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-md-10 col-sm-12 col-xs-12" style="margin-bottom:10px;">
                <div class="row">
                    ...
                    <div class="clearfix"></div>
                   <!-- <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="myborder note" style="padding:30px 0px 0 20px;">
                            <div class="row">
                                <div class="col-md-7 col-sm-8 col-xs-8 text-right">
                                    Verified & Matched photograph & signature 
                                </div>
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    <asp:dropdownlist runat="server" style="background:#fff;" ID="DdlStatus" CssClass="similar-select1 input-sm dropdown-toggle">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    <asp:Button ID="btnSubmit" CssClass="btn-primary ey-bg btn-sm" Text="Submit" style="margin-bottom:10px;" runat="server"/>
                                </div>
                            </div>
                        </div>
                    </div>-->
...
<asp:Label ID="DocDisable" runat="server" Visible="false"></asp:Label>
                                 ...
                                 <asp:View runat="server" ID="View5">
                                     ...
                                     <div class="text-center">
                                         ...
                                         <asp:Button runat="server" ID="btnProceed1" Text="View Provisional Letter" CssClass="btn btn-sm btn-primary" Style="margin-left:3px;" OnClick="btnProceed1_Click" OnClientClick="aspnetForm.target ='_blank';" />
                                                                             </div>
                                 </asp:View>
