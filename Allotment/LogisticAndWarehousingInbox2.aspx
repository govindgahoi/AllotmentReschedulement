<%@ Page Title="" Language="C#" MasterPageFile="~/MainUserHO.Master" AutoEventWireup="true" CodeBehind="LogisticAndWarehousingInbox2.aspx.cs" Inherits="Allotment.LogisticAndWarehousingInbox2" %>
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                ...
                <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="ServiceRequestNo"  datanavigateurlformatstring="LAWAssessment2.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
