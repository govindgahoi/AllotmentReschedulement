...
public class Viewer : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (dtDoc.Rows.Count > 0)
        {
            ...
            {
                Byte[] bytes = (Byte[])dtDoc.Rows[0]["HeadOfficeCommitteeDoc"];
                string filename = dtDoc.Rows[0]["HeadOfficeCommitteeDocName"].ToString().Trim();
                ...
                context.Response.ContentType = dtDoc.Rows[0]["HeadOfficeCommitteeDocType"].ToString().Trim();
