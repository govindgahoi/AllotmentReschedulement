<%@ Page Title="" Language="C#" MasterPageFile="~/CM_MainUser.Master" AutoEventWireup="true" CodeBehind="CM_ChangePassword.aspx.cs" Inherits="Allotment.CM_ChangePassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    .modalPopup
    {
     ...
     <script  type="text/javascript">
         ...
         function ShowMessage() {
             ...
             window.location.href = 'CM_default.aspx';
         ...
         prm.add_endRequest(function (sender, e) {
             ...
             function ShowMessage() {
                 alert('Your Password Is Changed Successfully. Please Login Again..');
                 window.location.href = 'IDADashboard.aspx';
   ...
   <ContentTemplate>
     ...
     <div class="panel panel-default">
                                    <div class="panel-heading font-bold">Reset Your Password</div>
