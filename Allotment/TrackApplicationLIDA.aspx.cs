...
namespace Allotment
{
    public partial class TrackApplicationLIDA : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (btnSubmit.Text == "Save")
                {
                    ...
                    if (txtGRDate.Text!="")
                    { 
                         date_to_GR = DateTime.ParseExact(txtGRDate.Text.Trim(), "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("dd MMM yyyy", CultureInfo.InvariantCulture);
                    }
                    ...
                    {
                        objServiceTimelinesBEL.LGrivenceRDate = Convert.ToDateTime(date_to_be);
                    }

                    objServiceTimelinesBEL.StatusID = "0";
        ...
        protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "EditRow")
            {
                ...
                drpSection.SelectedItem.Text = GridView2.Rows[index].Cells[4].Text;
