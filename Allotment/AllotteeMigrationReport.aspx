<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="AllotteeMigrationReport.aspx.cs" Inherits="Allotment.AllotteeMigrationReport" %>
...
<%--           <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <asp:DropDownList ID="drpReportType" CssClass="input-sm similar-select1" runat="server" >
           ...
           <div class="clearfix"></div>
            ...
            <%-- <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <asp:TextBox ID="txtFromDate" CssClass="input-sm date similar-select1" runat="server"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="clearfix"></div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <asp:TextBox ID="txtToDate" CssClass="input-sm date similar-select1" runat="server"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="clearfix"></div>
