...
namespace Allotment
{
    public partial class PIPApproved : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGridView()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfPIPApproved(objServiceTimelinesBEL);
                ...
                dsfin = objMbal.GetApplicationOfPIPFINApproved(objServiceTimelinesBEL);
        ...
        private void BindAlertServiceRequestGridView()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetAlertApplicationOfPIPApproved(objServiceTimelinesBEL);
                if (ds.Tables[0].Rows.Count > 0)
                {
