...
namespace Allotment
{
    public partial class UC_LidaRejectionLetterDataFacts : System.Web.UI.UserControl
    {
        SqlConnection con;
        ...
        private void GetBuildingPlanRejectionDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("[DetailsForLidaBuildingPlanRejection] '" + lblServiceReqNo.Text + "'", con);
                SqlDataAdapter adp = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                ...
                if (dt0.Rows.Count > 0)
                {
                    ...
                    string code = "ApplicationNo:" + lblServiceReqNo.Text + "|ApplicantName:" + AllotteeName + "|ProjectName:" + project_name + "|DocType:Rejection";
                    QRCodeGenerator qrGenerator = new QRCodeGenerator();
