...
namespace Allotment
{
    public partial class LidaServicerequestUnderProcess : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGridView()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfLidaBuildingPlanUnderProcess(objServiceTimelinesBEL);
        ...
        //        if (ds.Tables[0].Rows.Count > 0)
        //        {
        //            Grid_LidaAllotment.DataSource = ds;
        //            Grid_LidaAllotment.DataBind();
        //        }
        //        else
        //        {
        //            Grid_LidaAllotment.DataSource = null;
        //            Grid_LidaAllotment.DataBind();
        //        }
        //        if (ds.Tables[1].Rows.Count > 0)
        //        {
