...
namespace Allotment
{
    public partial class CM_ChangePassword : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("/CM_Default.aspx");
            }
            if (!IsPostBack)
            {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ds = objServiceTimelinesBLL.CM_GetLoginDetailCheck(objServiceTimelinesBEL);
                            ...
                            if (ds.Tables.Count > 0)
                            {
                                if (txtNewPassword.Text == txtConfirmPassword.Text)
                                {
                                    ...
                                    int retVal = objServiceTimelinesBLL.CM_UpdatePassword(objServiceTimelinesBEL);
                                    if (retVal > 0)
                                    {
