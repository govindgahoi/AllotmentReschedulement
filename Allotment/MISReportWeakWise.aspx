<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="MISReportWeakWise.aspx.cs" Inherits="Allotment.MISReportWeakWise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text-right"> <a runat="server" onclick="PrintElem()" style="cursor:pointer;">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div  id="DivP" style="text-align: center;padding: 15px 25px; margin: 25px 0%;background: #fbfbfb;border: 1px solid #ccc;">
                <div class="div-report" runat="server"  style="text-align: center;">
                    ...
                    <h2>Applications Received from <asp:Label ID="lblStartDate" runat="server"></asp:Label> to  <asp:Label ID="lblEndDate" runat="server"></asp:Label></h2>
                    <div style = "border-top:3px solid #ffc511;">&nbsp;</div> 
