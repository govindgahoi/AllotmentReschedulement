<%@ Page Title="" Language="C#"  ValidateRequest="false"  MasterPageFile="~/MainUser.Master"  EnableViewState="true" CodeBehind="BuildingPlanAssessment.aspx.cs" Inherits="Allotment.BuildingPlanAssessment" %>
	...
	<div class="row my-new-heading">
		<div class="text-center my-new-heading">
			<span class="col-md-2 col-sm-4 col-xs-6" style="padding-left: 0px !important; padding-right: 2px !important;">
               <asp:Button ID="Button1" runat="server" Text="Go Back" Style="margin: 6px 126px;display:block;margin-top: -4px;padding: 6px 13px 3px 14px;"  CssClass="btn-primary btn-sm ey-bg pull-right" PostBackUrl="~/ServiceRequestInboxNew.aspx" />
