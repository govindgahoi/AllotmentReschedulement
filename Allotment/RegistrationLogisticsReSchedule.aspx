<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationLogisticsReSchedule.aspx.cs" Inherits="Allotment.RegistrationLogisticsReSchedule" %>
...
<asp:View ID="View1" runat="server">
  ...
  <div class="form-group">
    ...
    <asp:RequiredFieldValidator ID="reqName" ControlToValidate="txtUID" runat="server" ErrorMessage="Please Enter UID No."></asp:RequiredFieldValidator>
