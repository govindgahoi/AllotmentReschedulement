...
namespace Allotment
{
    public partial class LidaReportGeneration : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string[] SerArray = Applicant.Split('/');
        ...
        protected void load_UC()
        {
            ...
            if (Menu_Type == "page")
            {
                ...
                if (Menu_Value1 == "Data_Facts")
                {
                    UC_LidaDataFacts UC_DataFacts = LoadControl("~/UC_LidaDataFacts.ascx") as UC_LidaDataFacts;
                    UC_DataFacts.ServiceRequestNo = ServiceReqNo;

                    UC_DataFacts.ID = "UC_LidaDataFacts";
                ...
                if (Menu_Value1 == "Report_View_Genrate")
                {
                    ...
                    UC_LidaDocument_Report_VG UC_Document_Report_VG = LoadControl("~/UC_LidaDocument_Report_VG.ascx") as UC_LidaDocument_Report_VG;
