...
namespace Allotment
{
    public partial class UC_LeaseDeedFeePayAck : System.Web.UI.UserControl
    {
        ...
        public void BindApplicableFees(string serviceNO)
        {
            ...
            try
            {
                ...
                {
                    Pay_Ds = objServiceTimelinesBLL.GetLeaseDeedPaymentDetailAfterTransactionNMSWP(objServiceTimelinesBEL);
                    Datadt = Pay_Ds.Tables[0];
                    Paymentdt = Pay_Ds.Tables[1];
                }
                else
                {
                    Pay_Ds = objServiceTimelinesBLL.GetLeaseDeedPaymentDetailAfterTransaction(objServiceTimelinesBEL);
                    Datadt = Pay_Ds.Tables[0];
                    Paymentdt = Pay_Ds.Tables[1];
