<%@ Page Title="" Language="C#" MasterPageFile="~/MainUserHO.Master" AutoEventWireup="true" CodeBehind="MISReportInvestmentDataHO.aspx.cs" Inherits="Allotment.MISReportInvestmentDataHO" %>
    ...
    <div class="row">
        <div class="form-group" style="background: #dadada; padding: 2px 0; margin-bottom: 3px;">
            <div class="">
                ...
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <asp:DropDownList runat="server" ID="ddlReportType" Style="background: #fff;" CssClass="chosen input-sm similar-select1">
