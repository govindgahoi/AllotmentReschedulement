...
namespace Allotment
{
    public partial class ServiceRequestRejectedLeaseDeed : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGridViewLeaseDeed()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOLeaseDeedRejected(objServiceTimelinesBEL);
