<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_RaiseObjectionPIPFIN.ascx.cs" Inherits="Allotment.UC_RaiseObjectionPIPFIN" %>
...
<div id="divDisableReminder1" visible="false" runat="server">
<div class="panel panel-default">
    <div class="panel-heading font-bold">
        Send Reminder       
    </div>
