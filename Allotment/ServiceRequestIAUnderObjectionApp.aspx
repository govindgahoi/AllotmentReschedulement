<%@ Page Title="" Language="C#" MasterPageFile="~/MainUserHO.Master" AutoEventWireup="true" CodeBehind="ServiceRequestIAUnderObjectionApp.aspx.cs" Inherits="Allotment.ServiceRequestIAUnderObjectionApp" %>
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center col-sm-4 col-xs-12">
                    <div class="bg-mywhite three-div6in" style="    padding-top: 15px;">
                        ...
                        <div class="dash-cost-text"><b>Total Under Objection</b></div>
                    </div>
                </div>
                <div class="col-md-6 text-center col-sm-4 col-xs-12">
    ...
    <div class="bg-mywhite table-divinbox">
        <div class="panel panel-default">
            <div class="panel-heading font-bold">
                Application - (Pending At Allottee)
            </div>
        </div>
        <div class="">
            <asp:Menu
      ...
      <asp:BoundField DataField="IAName" HeaderText="IA Name" SortExpression="IAName" />
       ...
       <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="ServiceRequestNO"  datanavigateurlformatstring="IAServicesAssessmentViewApp.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
      <asp:BoundField DataField="IAName" HeaderText="IA Name" SortExpression="IAName" />
                <asp:BoundField DataField="AllotteeName" HeaderText="Allottee Name" />
                <asp:BoundField DataField="PlotNo" HeaderText="Plot No" SortExpression="PlotNo" />
                <asp:BoundField DataField="ServiceRequestNO" HeaderText="Service Request" SortExpression="ServiceRequestNO" />
