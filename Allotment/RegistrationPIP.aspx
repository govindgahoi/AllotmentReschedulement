<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationPIP.aspx.cs" Inherits="Allotment.RegistrationPIP" %>
                ...
                <div>
                    <div class="navbar-header pull-left top-head-bg">
                          <div class="panel panel-default">
                                ...
                                <div class="clearfix"></div>
                                    <div class="clearfix"></div>
                                    <div class="panel-heading font-bold text-center" style="font-size: 14px !important; font-weight: 600; background: #2d2d2d; color: #ffc511 !important;">Application Under Private Industrial Parks Policy</div></div>
                    </div>
                </div>
                                                                ...
                                                                <div style="border:3px solid #ccc;padding: 10px 0px;">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="text-justify" style="padding: 10px 20px;">
                                                                            Applicant can make their Application Under Private Industrial Parks Policy
                                                                        </div>
                                                                        <div class="clearfix"></div>
                                                                    </div>
                                                                    <div class="clearfix"></div>
