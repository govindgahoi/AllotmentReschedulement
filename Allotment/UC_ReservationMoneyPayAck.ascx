<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ReservationMoneyPayAck.ascx.cs" Inherits="Allotment.UC_ReservationMoneyPayAck" %>
...
<div class="col-md-12 col-sm-12 col-xs-12">
            <div  id="DivP" style="padding: 15px 25px; margin: 25px;background: #fbfbfb;border: 1px solid #ccc;">
                ...
                <style>
	                ...
	                <p class="text-justify"><strong>Disclaimer:</strong>This is just an intimation of online payment subject to actual receipt of amount in authority bank account.</p>
                    </div>
                </div>
