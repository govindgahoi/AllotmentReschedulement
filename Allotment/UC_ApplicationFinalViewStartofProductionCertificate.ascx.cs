...
namespace Allotment
{
    public partial class UC_ApplicationFinalViewStartofProductionCertificate : System.Web.UI.UserControl
    {
        ...
        private void GetApplicantDetails(String ID)
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetAllotteeDetailsIAStartofProductionService(objServiceTimelinesBEL);
                ...
                {
                    lblstartofprduction.Text = dt_timeextensionfee.Rows[0]["ProductionstartDate"].ToString();
