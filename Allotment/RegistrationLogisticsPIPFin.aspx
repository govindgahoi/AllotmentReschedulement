<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationLogisticsPIPFin.aspx.cs" Inherits="Allotment.RegistrationLogisticsPIPFin" %>
                          ...
                          <div class="panel panel-default">
                                ...
                                <div class="clearfix"></div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 text-center" runat="server" id="divwarehouse" visible="false">
                                        <div class="panel-heading font-bold text-center" style="font-size: 14px !important; font-weight: 600; background: #2d2d2d; color: #ffc511 !important;">Application Under Warehousing & Logistic Policy 2022</div>
                                    </div>

                                    <div class="col-md-12 col-sm-12 col-xs-12 text-center" runat="server" id="divpip" visible="false">
                                        <div class="panel-heading font-bold text-center" style="font-size: 14px !important; font-weight: 600; background: #2d2d2d; color: #ffc511 !important;">Application for Issuance of Unique Id for Private Industrial Parks</div>
                                    </div>
                                    
                              <div class="col-md-12 col-sm-12 col-xs-12 text-center" runat="server" id="divpipfin" visible="false">
                                        <div class="panel-heading font-bold text-center" style="font-size: 14px !important; font-weight: 600; background: #2d2d2d; color: #ffc511 !important;">Application for Availing Financial Incentive under PIP</div>
                                    </div>
...
<asp:View ID="View1" runat="server">
  ...
  <div class="form-group">
    <label>PIP UID Number</label>
    <asp:TextBox ID="txtUID" runat="server" CssClass="form-control"  placeholder="Enter UID No"></asp:TextBox>
    <asp:RequiredFieldValidator ID="reqName" ControlToValidate="txtUID" runat="server"  style="color:Red" ErrorMessage="Please Enter UID No."></asp:RequiredFieldValidator>
