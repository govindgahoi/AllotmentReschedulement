   ...
   <%-- <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        $(document).keypress(function (e) {
         ...
         function MessageAndRedirectBuilding(par,par1) {
             alert(par);
             window.location.href = 'AllotteeApplication.aspx?ViewID=' + par1;
        }
        ...
        function ShowMessage(msg) {
         ...
         function BPRedirectWithMessage(par1, par2) {
            alert('Kindly Pay Nivesh Mitra Processing Fee for Final Submission of Your Application');
           // top.window.location.href = 'AllotteeApplication.aspx?ServiceID=' + par1 + '&TraID=' + par2;            
        }

        function MessageAndRedirect(parameter) {
            alert('Your Request Is Submitted Successfully.Now Fill Further Details');
            top.window.location.href = 'LandAllotmentApplication.aspx?ServiceReqNo=' + parameter;
        }
        ...
        function BPRedirect(par1, par2) {
            top.window.location.href = 'AllotteeApplication.aspx?ServiceID=' + par1+'&TraID='+par2;            
        }
         function BPRedirectObjection(par1, par2) {
            top.window.location.href = 'AllotteeApplication.aspx?ServiceID=' + par1+'&TraID='+par2+'&App=Resubmit';            
        }
         function BPRedirectOn(par1, par2) {
            top.window.location.href = 'AllotteeApplication.aspx?ServiceID=' + par1;            
        }
        function BPRedirectObjectionMessage(par1, par2) {
            alert('Service Request No Verified Kindly Proceed to resubmit the application');
            top.window.location.href = 'AllotteeApplication.aspx?ServiceID=' + par1 + '&TraID=' + par2 + '&App=Resubmit';
        }
          function OnlyRedirectC(parameter) {
           
            top.window.location.href = 'LandAllotmentApplication.aspx?ServiceReqNo=' + parameter + '&App=Resubmit';

        }
        function OnlyRedirectPaymentF(parameter1, parameter2) {

            top.window.location.href = 'LandAllotmentApplication.aspx?ServiceReqNo=' + parameter1 + '&Status=F&TranID=' + parameter2;
        ...
        function OnlyRedirectPaymentC(parameter1, parameter2) {
            ...
            top.window.location.href = 'LandAllotmentApplication.aspx?ServiceReqNo=' + parameter1 + '&Status=C&TranID=' + parameter2;
      ...
      <div class="modal-content">
              ...
              .
                     ...
                     <div class="panel panel-default">
                                      <div class="" style="border: 1px solid #cccccc; margin-bottom: 8px; background: #fdfdfd;" runat="server" id="BannerDiv">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-4 col-xs-12 right-niveshban">
                                               <ul class="mylogo-ul list-inline" style="margin: 0; padding: 6px 0 9px 1px; margin-left: 120px;">
                                            <li>
                      ...
                      <asp:Button runat="server" ID="btn_backNmswp" Text="⇦ Go Back" CssClass="pull-right btn btn-info" Style="background-color:#02486d;color:#fff;font-weight:600;" OnClick="btn_backNmswp_Click"  />
                         ...
                         <div class="panel-heading font-bold text-center" style="font-size: 14px !important; font-weight: 600; background: #2d2d2d; color: #ffc511 !important;"><asp:Label runat="server" ID="lblservicenameBlock" Visible="false"></asp:Label></div></div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading font-bold text-center" style="font-size: 14px !important; font-weight: 600; background: #2d2d2d; color: #ffc511 !important;">
                                        <asp:Label runat="server" ID="PageHeadingLbl"></asp:Label></div></div>
                                    ...
                                    <asp:MultiView runat="server" ID="Allotment">
                                        ...
                                        <asp:View runat="server" ID="View1">
                                            ...
                                            <div class="form-group" style="margin-top: 15px; margin-bottom: 15px;">
												...
												<div class="col-md-12 col-sm-12 col-xs-12 text-center" runat="server" id="divwarehouse" visible="false">
                                                        <span class="text-center" runat="server" id="Span3">
                                                            <asp:Button ID="btngotoware" runat="server" class="btn btn-default" Text="Confirm & Go To WareHousing Application" OnClick="btngotoware_Click" />
                                                           </span>
                                                 </div>

                                                 <div class="col-md-12 col-sm-12 col-xs-12 text-center" runat="server" id="divpip" visible="false">
                                                        <span class="text-center" runat="server" id="Span4">
                                                            <asp:Button ID="btngotopip" runat="server" class="btn btn-default" Text="Confirm & Go To PIP Application" OnClick="btngotopip_Click" />
                                                           </span>
                                                 </div>

                                                <div class="col-md-12 col-sm-12 col-xs-12 text-center" runat="server" id="divpipfin" visible="false">
                                                        <span class="text-center" runat="server" id="Span5">
                                                            <asp:Button ID="Button3" runat="server" class="btn btn-default" Text="Confirm & Go To PIP Financial Incentive Application" OnClick="btngotopipfin_Click" />
                                                           </span>
                                                 </div>

                                                <div class="col-md-12 col-sm-12 col-xs-12 text-center" runat="server" id="divReScDueBtn" visible="false">
                                                        <span class="text-center" runat="server" id="Span6">
                                                        <asp:Button ID="btngotoReScDue" runat="server" class="btn btn-default" Text="Confirm & Go To Reschedulement of Dues Application" OnClick="btngotoReScDue_Click" />
                                                        </span>
                                                 </div>

                                                
                                                <div class="col-md-12 col-sm-12 col-xs-12 text-center" runat="server" id="divReScDue" visible="false">
                                                    <div class="col-md-4">Enter Your Service Request No :-</div>
                                                    <div class="col-md-6 text-left">
                                                        <asp:TextBox runat="server" ID="txtServiceRequestNo" CssClass=" form-control margin-left-z input-sm similar-select1"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <asp:Button runat="server" ID="btnReScDueTrack" Text="Proceed" CssClass="btn btn-sm btn-primary" OnClick="btnReScDueTrack_Click"/> 
                                                    </div>
                                                </div>
                        ...
                        <div style="border:1px solid #e0e0e0;padding:10px;">
                                                                <div style="border:3px solid #ccc;padding: 10px 0px;">
                                                                    ...
                                                                    <div class="form-group" style="display:none;">
                                                                        ...
                                                                        <hr class="myhrline" style="border-top: 1px solid #646464;"/>
                                                                        <div class="text-justify" style="padding: 10px 20px;">
                                                                            Entrepreneurs can apply for land allotment through Nivesh Mitra Portal.
                                                                        </div>
                                                                        <div class="clearfix"></div>
                                                                    </div>
                                                                    <div class="clearfix"></div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10 col-sm-6 col-xs-6">
                                                         <asp:Label ID="lblDistrictName" runat="server"></asp:Label>
                                                            <asp:Label ID="lblReqV" runat="server" Visible="False"></asp:Label>
                                                        </div>
                                                    </div>
                                                     <div class="clearfix"></div>
                                                     <hr class="myhrline" />
                                        ...
                                        <asp:View runat="server" ID="View7">
                                            <div class="panel panel-default"><div class="panel-heading">Update URN Number</div></div>
                                             <div style="border:12px solid #ccc;margin: 0 0 6px 0;">
                                                    <div class="form-group">
                                                        <label class="col-md-2 col-sm-6 col-xs-6 text-right">
                                                            Service Request No :
                                                        ...
                                                        <div class="col-md-10 col-sm-6 col-xs-6">
                                                             <asp:TextBox runat="server" ID="txtServieReqNo" Placeholder="Enter Your Service Request No" AutoPostBack="true" CssClass="margin-left-z input-sm similar-select1" OnTextChanged="txtServieReqNo_TextChanged"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                     <div class="clearfix"></div>
                                                     <hr class="myhrline" />
                                                 ...
                                                 <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-md-10 col-sm-6 col-xs-6">
                                                            <asp:TextBox runat="server" ID="txtURNNo" CssClass="margin-left-z input-sm similar-select1"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                     <div class="clearfix"></div>
                                                     <hr class="myhrline" />
                                                 <div class="form-group">
                                                        ...
                                                        <div class="col-md-10 col-sm-6 col-xs-6">
                                                            <asp:TextBox runat="server" ID="txtPayDate" placeholder="dd/mm/yyyy" CssClass="date margin-left-z input-sm similar-select1"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                     <div class="clearfix"></div>
                                                     <hr class="myhrline" />
                                                 <div class="form-group">
                                                     ...
                                                     <asp:Button Style="margin:5px;" runat="server" ID="btnUpdateURN" Text="Update" Enabled="false" CssClass="btn btn-sm btn-primary pull-right" OnClick="btnUpdateURN_Click"/>
                                                <div class="clearfix"></div>
                                             </div>
                                        </asp:View>
                                       ...
                                       <asp:View runat="server" ID="View8">
                                           <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                               <table class="request-table fill-view-mytable" style="width:100%;">
                                                   <tr>
                                                         <td style="width:50%;"> <asp:Label ID="Label9" runat="server">Application For</asp:Label></td>
                                                       <td style="width:50%;"><asp:Label ID="lblApplicationFor" runat="server">Building Plan</asp:Label></td>
                                                     
                                                   </tr>
                                                     <tr>
                                                         <td style="width:50%;"> <asp:Label ID="Label11" runat="server">Industrial Area</asp:Label></td>
                                                       <td style="width:50%;"><asp:Label ID="lblIAName" runat="server"></asp:Label></td>
                                                     
                                                   </tr>
                                                   <tr>
                                                       <td><asp:Label ID="Label1" runat="server" Text="Allottee Name"></asp:Label></td>
                                                       <td><asp:Label ID="lblName" runat="server"></asp:Label></td>
                                                   </tr>
                                                    <tr>
                                                         <td style="width:50%;"> <asp:Label ID="Label10" runat="server">Plot No</asp:Label></td>
                                                       <td style="width:50%;"><asp:Label ID="lblPlotNo" runat="server"></asp:Label></td>
                                                   ...
                                                   <tr>
                                                    ...
                                                    <tr>
                                                       <td><asp:Label ID="Label8" runat="server" Text="Application Date"></asp:Label></td>
                                                       <td><asp:Label ID="lblAppDate" runat="server"></asp:Label></td>
                                                       
                                                   </tr>
                                                    <tr>
                                                       <td><asp:Label ID="Label6" runat="server" Text="Building Plan Fee"></asp:Label></td>
                                                       <td><asp:Label ID="lblBPFee" runat="server"></asp:Label></td>
                                                       
                                                   </tr>
                                                    <tr>
                                                        <td><asp:Label ID="Label5" runat="server" Text="Nivesh Mitra Processing Fee"></asp:Label></td>
                                                       <td><asp:Label ID="lblProcessing" runat="server"></asp:Label></td>
                                                      
                                                   </tr>
                                                   <tr>
                                                       <td><asp:Label ID="Label7" runat="server" Text="Form Submission"></asp:Label></td>
                                                       <td><asp:Label ID="lblForm" runat="server"></asp:Label></td>
                                                       
                                                   </tr>
                                               </table>
                                                <asp:Button ID="btnClickViewForm" runat="server" Style="margin:5px 0;" CssClass="btn-primary bg-ey pull-right" Text="Click To View and Fill Details" OnClick="btnClickViewForm_Click" />
                                            </div>
                                           <div class="col-md-2"></div>
                                           <div class="clearfix"></div>
                                      ...
                                      <asp:View runat="server" ID="ViewreBP">
                                              <div class="panel panel-default"><div class="panel-heading">If your building plan application has been rejected. Kindly provide your previous service request no for re submission of your application</div></div>
                                             <div style="border:12px solid #ccc;margin: 0 0 6px 0;">
                                                   ...
                                                   <div class="form-group">
                                                        ...
                                                        <div class="col-md-10 col-sm-6 col-xs-6">
                                                         <asp:Label ID="lblDistictN" runat="server"></asp:Label>
                                                        </div>
                                                    </div>
                                                     <div class="clearfix"></div>
                                                     <hr class="myhrline" />
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-md-10 col-sm-6 col-xs-6">
                                                            <asp:DropDownList ID="drdiaN" AutoPostBack="true" Width="48%"  runat="server" CssClass="chosen margin-left-z input-sm similar-select1" style="background: #fff;"></asp:DropDownList>
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-md-10 col-sm-6 col-xs-6">
                                                            <asp:TextBox runat="server" ID="txtSerNo" CssClass="margin-left-z input-sm similar-select1"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                 <div class="clearfix"></div>
                                                     <hr class="myhrline" />
                                              ...
                                              <div class="form-group">
                                                 ...
                                                 <div class="clearfix"></div>
                                                     ...
                                                     <asp:Button  runat="server" ID="Button1" Text="Proceed To Apply" CssClass="btn btn-sm btn-primary pull-right" Style="margin:5px;" OnClick="Button1_Click" />
                                                     <asp:Button  runat="server" ID="Button2" Text="Verify OTP" CssClass="btn btn-sm btn-primary pull-right" Style="margin:5px;" OnClick="Button2_Click" Visible="false" />
                                                <div class="clearfix"></div>
                                             </div>
                                        </asp:View>
        ...
        <script>
            ...
            function DisplayNdRedirect(msg) {
                ...
                message += newLine;
                message +="Please Pay Application Form Fees To Nivesh Mitra For Further Processing."
                alert(message);
              //  window.location.href = 'LandAllotmentApplication.aspx?ServiceReqNo=' + msg;
            }
