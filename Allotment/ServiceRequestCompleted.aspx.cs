...
namespace Allotment
{
    public partial class ServiceRequestCompleted : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGridViewSubdividion()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfSubDivisionPostAllotmentCompleted(objServiceTimelinesBEL);
                if (ds.Tables[0].Rows.Count > 0)
                {
        ...
        private void BindServiceRequestGridViewAmalgamation()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfAmalgamationPostAllotmentCompleted(objServiceTimelinesBEL);
                if (ds.Tables[0].Rows.Count > 0)
                {
        ...
        protected void GridView4_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                HyperLink lnkd = e.Row.FindControl("hlnkView") as HyperLink;
                string ReqNo = GridView4.DataKeys[e.Row.RowIndex].Values[0].ToString();
                string NM = GridView4.DataKeys[e.Row.RowIndex].Values[1].ToString();
                if (NM.Length > 0)
                {
                    lnkd.NavigateUrl = "~/IAServicesAssessmentView.aspx?ServiceReqNo=" + ReqNo + "";
