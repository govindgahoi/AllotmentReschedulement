    <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PIPAllotteeApplication.aspx.cs" Inherits="Allotment.PIPAllotteeApplication" %>
    ...
    <script type="text/javascript">
        ...
        $(document).keypress(function (e) {
         ...
         function MessageAndRedirectBuilding(par,par1) {
             alert(par);
             window.location.href = 'PIPAllotteeApplication.aspx?ViewID=' + par1;
        }
        ...
        function ShowMessage(msg) {
         ...
         function BPRedirectWithMessage(par1, par2) {
           ...
           // top.window.location.href = 'PIPAllotteeApplication.aspx?ServiceID=' + par1 + '&TraID=' + par2;            
        }
        ...
        function BPRedirect(par1, par2) {
         ...
         function BPRedirectObjection(par1, par2) {
            top.window.location.href = 'PIPAllotteeApplication.aspx?ServiceID=' + par1+'&TraID='+par2+'&App=Resubmit';            
        }
         function BPRedirectOn(par1, par2) {
            top.window.location.href = 'PIPAllotteeApplication.aspx?ServiceID=' + par1;            
        }
