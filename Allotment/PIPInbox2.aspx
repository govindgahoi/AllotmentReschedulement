<%@ Page Title="" Language="C#" MasterPageFile="~/MainUserHO.Master" AutoEventWireup="true" CodeBehind="PIPInbox2.aspx.cs" Inherits="Allotment.PIPInbox2" %>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="bg-mywhite performance-textdiv">
                        <p class="pmt-text pmt-text-color">Private Industrial Parks Policy</p>
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                ...
                <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="ServiceRequestNo"  datanavigateurlformatstring="PIPAssessment2.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
