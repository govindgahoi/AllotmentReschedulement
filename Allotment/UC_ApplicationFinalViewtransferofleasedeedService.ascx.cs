...
namespace Allotment
{
    public partial class UC_ApplicationFinalViewtransferofleasedeedService : System.Web.UI.UserControl
    {
        ...
        private void GetApplicantDetails(String ID)
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetAllotteeDetailsIAtransferofleasedeedService(objServiceTimelinesBEL);


                DataTable dt = ds.Tables[0];
                DataTable dt1 = ds.Tables[1];
                DataTable dt_transferofleasedeed = ds.Tables[2];
                ...
                if (dt_transferofleasedeed.Rows.Count > 0)
                {
                    ...
                    lblPaidoutstanding.Text = dt_transferofleasedeed.Rows[0]["PaidStatus"].ToString();
                    lblLetterNo.Text = dt_transferofleasedeed.Rows[0]["leasedeedLetterNo"].ToString();
                    lblDate.Text = dt_transferofleasedeed.Rows[0]["leasedeedLetterDate"].ToString();
                    lblLetterFrom.Text = dt_transferofleasedeed.Rows[0]["leasedeedLetterFrom"].ToString();
                    lblAddressBank.Text = dt_transferofleasedeed.Rows[0]["leasedeedLetterAddress"].ToString();
                    lblfirstNameofbank.Text = dt_transferofleasedeed.Rows[0]["BankName"].ToString();
                    lblfirstBranch.Text = dt_transferofleasedeed.Rows[0]["BranchName"].ToString();
                    lblMobileNumbers.Text = dt_transferofleasedeed.Rows[0]["MobileNo"].ToString();
                    lblemailids.Text = dt_transferofleasedeed.Rows[0]["emailid"].ToString();
                    lblPremiumAmounts.Text = dt_transferofleasedeed.Rows[0]["PremimAmount"].ToString();
                    lblInterestAmounts.Text = dt_transferofleasedeed.Rows[0]["InterestAmount"].ToString();
