<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JanhitPendencyReport.aspx.cs" Inherits="Allotment.JanhitPendencyReport" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-7">
                        <asp:DropDownList ID="drpReportName" width="87.5%" style="background:#fff;" AutoPostBack="true"  CssClass="input-sm similar-select1" runat="server" OnSelectedIndexChanged="drpReportName_SelectedIndexChanged" >
                            ...
                            <asp:ListItem Text="Land Allottment Application Under Janhit" Value="LAPL"  ></asp:ListItem>
                            <asp:ListItem Text="Building Plan Application Under Janhit"   Value="BPSLA"  ></asp:ListItem>
