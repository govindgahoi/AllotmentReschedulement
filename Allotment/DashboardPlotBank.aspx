<%@ Page Title="" Language="C#" MasterPageFile="~/MainUserHO.Master" AutoEventWireup="true" CodeBehind="DashboardPlotBank.aspx.cs" Inherits="Allotment.DashboardPlotBank" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="" style="border: 1px solid #ccc; margin: 0px 0;">
                    <div class="">
                        <div class="row div-landbank ">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <span style="font-size: 18px;">Plot Bank <span class="pull-right">Total Area:
                            ...
                            <div class="" style="padding: 16px 0px;background: #713800;">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    SUMMARY PLOT MASTER
                                    <span style="display:none;"><asp:Label ID="lblIndustrial" CssClass="" runat="server"></asp:Label> Acres</span>
                                </div>
                                <div class="col-md-2 col-sm-12 col-xs-12 pad-lt0 pad-rt0" style="display:none;">
                                    Institutional :
    ...
    <div class="clearfix"></div>
    <hr style="margin-top: 6px; margin-bottom: 6px; border: 0; border-top: 2px solid #f5f5f5;" />
    <div class="" style="padding: 10px 0px;background: #713800;color:#fff;">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ADVERTIZED PLOTS
        </div>
        <div class="clearfix"></div>
