...
namespace Allotment
{
    public partial class UC_BuildingPlanFeeInternal : System.Web.UI.UserControl
    {
            ...
            try
            {
                ...
                if (ApplicationStatus == "Revised")
                {
                    if (choicearea > 0)
                    {
                        ...
                        objServiceTimelinesBEL.ServiceRequestNO = ServiceRequestNo;
                        dschoicearea = objServiceTimelinesBLL.GetBuildingPlanChargesRevised(objServiceTimelinesBEL);
                ...
                else
                {
                    if (choicearea > 0)
                    {
                        ...
                        objServiceTimelinesBEL.CoveredArea = CoveredArea;
                        objServiceTimelinesBEL.ServiceRequestNO = ServiceRequestNo;
                        dschoicearea = objServiceTimelinesBLL.GetBuildingPlanCharges(objServiceTimelinesBEL);
