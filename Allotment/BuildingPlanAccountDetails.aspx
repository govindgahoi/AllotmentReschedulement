<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="BuildingPlanAccountDetails.aspx.cs" Inherits="Allotment.BuildingPlanAccountDetails" %>
        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="panel panel-default">
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="clearfix"></div>
                                    <hr class="myhrline" />
                                     <asp:TextBox ID="txtBPAmount" runat="server" Style="display:none;" CssClass="form-control input-sm similar-select1 margin-left-z" placeholder="dd/mm/yyyy"></asp:TextBox>
                    ...
                    <div class="clearfix"></div>
                    <hr class="separation" />
                    <div class="panel-heading">Building Plan Map Application Details</div>
                     ...
                     <input type="button" value="Click Me" style="display:none;" id="btnModalChallan" data-toggle="modal" data-target="#ModalChallan" >
                        <asp:GridView ID="ApplicationGrid" runat="server" AutoGenerateColumns="false" DataKeyNames="ServiceRequestNO" CssClass="table table-striped table-bordered table-hover request-table" OnRowDataBound="ApplicationGrid_RowDataBound" >
                            <Columns>
                                ...
                                <asp:BoundField DataField="InspectionCharges" HeaderText="Inspection Charges" SortExpression="InspectionCharges" />
                                <asp:BoundField DataField="MalbaCharges" HeaderText="Malba Charges" SortExpression="MalbaCharges" />
                                <asp:BoundField DataField="InfrastructureUpgrationCharge" HeaderText="InfrastructureUpgrationCharge" SortExpression="InfrastructureUpgrationCharge" />
