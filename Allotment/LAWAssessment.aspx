<%@ Page Title="" Language="C#"  ValidateRequest="false"  MasterPageFile="~/MainUser.Master"  EnableViewState="true" CodeBehind="LAWAssessment.aspx.cs" Inherits="Allotment.LAWAssessment" %>
...
#ContentPlaceHolder1_sub_menu ul
{
    ...
    <script type='text/javascript'>
        ...
        function PrintElem() {
            //Popup($('#ContentPlaceHolder1_UC_ApplicationFinalViewLAW_DivP').html());
            Popup($('#FinalPrint').html());
        }
        ...
        function MessageAndRedirect(par) {
            alert(par);
            window.location.href = 'LogisticAndWarehousingInbox.aspx';
        }
