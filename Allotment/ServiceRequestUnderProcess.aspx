<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="ServiceRequestUnderProcess.aspx.cs" Inherits="Allotment.ServiceRequestUnderProcess" %>
...
<%--    <asp:BoundField  ItemStyle-BorderWidth="0" DataField="ALERTMESSAGE" />  --%>
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
              ...
              <asp:View runat="server" ID="AllotmentView">
                    <div style="overflow-x: auto; overflow-y: auto; max-height: 490px;">
 ...
 <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:HyperLink runat="server" ID="Hyper1"  NavigateUrl='<%# string.Format("~/NewAssessmentUnderProcess.aspx?ServiceReqNo={0}",HttpUtility.UrlEncode(Eval("ServiceRequestNO").ToString())) %>' Text='<%# Eval("ServiceRequestNO").ToString()%>'> </asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
 ...
 <asp:BoundField DataField="STATUS" ItemStyle-Wrap="false" HeaderText="Current Status" Visible="false" SortExpression="STATUS" />
        ...
        <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="ServiceRequestNO"  datanavigateurlformatstring="BuildingPlanAssessmentView.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
