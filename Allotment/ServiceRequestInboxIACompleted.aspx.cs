...
namespace Allotment
{
    public partial class ServiceRequestInboxIACompleted : System.Web.UI.Page
    {
...

        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfChangeOfProjectCompleted(objServiceTimelinesBEL);
        ...
        private void BindTotalCount()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.BindTotalCountCompleted(objServiceTimelinesBEL);
                if (ds.Tables.Count > 0)
                {
        ...
        /*
        #region Devendra kumar
        protected void ChangeOfProject_Grid_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ChangeOfProject_Grid.PageIndex = e.NewPageIndex;
            this.BindServiceRequestGridView();
        }
        #endregion
        */
    }
