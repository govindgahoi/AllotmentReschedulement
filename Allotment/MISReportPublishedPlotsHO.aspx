<%@ Page Title="" Language="C#" MasterPageFile="~/MainUserHO.Master" AutoEventWireup="true" CodeBehind="MISReportPublishedPlotsHO.aspx.cs" Inherits="Allotment.MISReportPublishedPlotsHO" %>
        ...
        <div class="form-group" style="background: #dadada; padding: 2px 0; margin-bottom: 3px;">
            <div class="">
                ...
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <asp:DropDownList runat="server" ID="ddloffice" Style="background: #fff;" CssClass="chosen input-sm similar-select1" AutoPostBack="true" OnSelectedIndexChanged="Regional_Changed"></asp:DropDownList>
                </div>
                <label class="col-md-2 col-sm-2 col-xs-12">
                    Industrial Area :
                </label>
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <asp:DropDownList runat="server" ID="drpdwnIA" Style="background: #fff;" CssClass="chosen input-sm similar-select1"></asp:DropDownList>
                </div>
                ...
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <asp:DropDownList runat="server" ID="ddlReportType" Style="background: #fff;" CssClass="input-sm similar-select1">
                        <asp:ListItem Text="Through Nivesh Mitra" Value="1"></asp:ListItem>
                        <asp:ListItem Text="Through Auction" Value="2"></asp:ListItem>
