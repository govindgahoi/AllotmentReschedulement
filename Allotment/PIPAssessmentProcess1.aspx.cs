...
namespace Allotment
{
    public partial class PIPAssessmentProcess1 : System.Web.UI.Page
    {
        ...
        protected void load_UC(string AllOrFirst)
        {
            ...
            try
            {
                ...
                if (Menu_Type == "page")
                {
                    ...
                    {
                        UC_ObjectionsPIP UC_ObjectionsPIP = LoadControl("~/UC_ObjectionsPIP.ascx") as UC_ObjectionsPIP;
                        UC_ObjectionsPIP.ID = "UC_ObjectionsPIP";
                        UC_ObjectionsPIP.ServiceReqNo = ServiceReqNo;
                        Placeholder.Controls.Add(UC_ObjectionsPIP);

                    }
                    if (Menu_Value1 == "MeetingMinutes")
                    {
                        UC_MeetingMinutesPIPDetails UC_MeetingMinutesPIPDetails = LoadControl("~/UC_MeetingMinutesPIPDetails.ascx") as UC_MeetingMinutesPIPDetails;
                        UC_MeetingMinutesPIPDetails.ID = "UC_MeetingMinutesPIPDetails";
                        UC_MeetingMinutesPIPDetails.ServiceReqNo = ServiceReqNo;
                        Placeholder.Controls.Add(UC_MeetingMinutesPIPDetails);
