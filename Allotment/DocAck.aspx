<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="DocAck.aspx.cs" Inherits="Allotment.DocAck" %>
...
<%--	<script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.6.4/angular.min.js"></script>--%>
     ...
     <script type='text/javascript'>
         ...
         function MessagePlusRedirect(par,par1) {

             alert(par1);
            window.location.href = ("LeaseDeedAssessment.aspx?ServiceReqNo=" + par);

         }

		 function MessagePlusRedirect1(par) {

			 alert(par);
			 window.location.href = ("ServiceRequestInboxNewLeaseDeed.aspx");

		 }
		 function MessagePlusRedirectTransfer(par, par1) {

			 alert(par1);
			 window.location.href = ("IAServiceAssessment.aspx?ServiceReqNo=" + par);
	...
	<div class="row my-new-heading">
		<div class="text-center my-new-heading">
			<span class="col-md-2 col-sm-4 col-xs-6" style="padding-left: 0px !important; padding-right: 2px !important;">
				...
				<asp:DropDownList ID="ddlApplicant" runat="server" Visible="false" AutoPostBack="true" OnSelectedIndexChanged="ddlApplicant_SelectedIndexChanged" CssClass="btn btn-sm btn-default dropdown-toggle similar-select1">
					</asp:DropDownList>
			</span>
