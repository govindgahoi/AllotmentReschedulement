<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ApplicationFinalViewtransferofleasedeedService.ascx.cs" Inherits="Allotment.UC_ApplicationFinalViewtransferofleasedeedService" %>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div id="DivP" style="padding: 15px 25px; margin: 25px; background: #fbfbfb; border: 1px solid #ccc;">
        <div class="div-report" runat="server" style="text-align: center;">
            ...
            <img src="https://eservices.onlineupsidc.com/images/upsidclogo.png" class="header-logo" style="border-top: none; height: 40px; margin-bottom: 0;" /><br />
        ...
        <div class="my-div-report">
            <div style="text-align: center; font-size: 18px; font-weight: 600;">
                <asp:Label runat="server" ID="lblFormName" Text="Application Form For Transfer of Lease deed to Financial Institution"></asp:Label>
            </div>
            <br />
            ...
            <div style="width: 75%; float: left; font-weight: 600;" class="col-md-9">
                ...
                <br />
                Dear Sir/Madam,<br />
                &nbsp;&nbsp;&nbsp;&nbsp;I Hereby submit the request for Transfer of Lease deed to Financial Institution as per the following details.<br />
            </div>
            ...
            <div style="clear: both;"></div>
            <div class="transferofleasedeed-detail" style="border: 2px solid #ccc; margin-top: 20px;">
                <div class="col-md-12 col-sm-12 col-xs-12 main-head"><b>Bank Details</b></div>
                <br />
                <div style="clear: both;"></div>
                ...
                <label style="width: 35%; float: left;" class="col-md-3">Address :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblAddressBank" runat="server"></asp:Label>
                </div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">Mobile Number :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblMobileNumbers" runat="server"></asp:Label>
                </div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
                <label style="width: 35%; float: left;" class="col-md-3">EmailID :</label>
                <div style="width: 45%; float: left; font-size: 12px; font-weight: 700;" class="col-md-3">
                    <asp:Label ID="lblemailids" runat="server"></asp:Label>
                </div>
                <div style="clear: both;"></div>
                <hr class="myhrline" />
            </div>
