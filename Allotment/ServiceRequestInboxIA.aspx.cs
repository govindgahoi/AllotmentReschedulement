...
namespace Allotment
{
    public partial class ServiceRequestInboxIA : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGridView()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfChangeOfProjectInBox(objServiceTimelinesBEL);
                ...
                {
                    CompletionCertificateGrid.DataSource = ds.Tables[2];
                    CompletionCertificateGrid.DataBind();
                }
                else
                {
                    CompletionCertificateGrid.DataSource = null;
                    CompletionCertificateGrid.DataBind();
                }
                if (ds.Tables[3].Rows.Count > 0)
                {
                    OccupancyCertificateGrid.DataSource = ds.Tables[3];
                    OccupancyCertificateGrid.DataBind();
                }
                else
                {
                    OccupancyCertificateGrid.DataSource = null;
                    OccupancyCertificateGrid.DataBind();
                }
                ...
                #region Newservice by Manish Rastogi
        ...
        private void BindTotalCount()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.BindTotalCountInbox(objServiceTimelinesBEL);
