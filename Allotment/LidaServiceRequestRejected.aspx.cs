...
namespace Allotment
{
    public partial class LidaServiceRequestRejected : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGridView()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfLidaBuildingPlanRejected(objServiceTimelinesBEL);
        ...
        private void Bind_Announcement_List_GridView()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetLidaBPNotApprovedRejected(objServiceTimelinesBEL);
                if (ds.Tables[0].Rows.Count > 0)
