...
//$(".unsco", $svg).attr('style', "stroke: #6666ff; stroke-width: 1px; marker-start: url(#unscoBg);")
$("#wGroup").hide()
$(".mapCateg li").removeClass("CatSelected");
$("#mGroup").attr('style', "visibility: visible"); 
$(this).addClass("CatSelected");
unsStatus = "clz";
}
else{
	//$(".unsco", $svg).attr('style', "fill:"+"#FFF");
$("#mGroup").hide()
...
if(mceStatus=="shw")
{
	...
	$(".mice", $svg).attr('style', "stroke: #6666ff; stroke-width: 1px; marker-start: url(#miceBg);")
$(this).addClass("CatSelected");
mceStatus = "clz";
}
else{$(".mice", $svg).attr('style', "fill:"+"#FFF");
$(this).removeClass("CatSelected");
mceStatus = "shw";}
});
...
$(".htrsr", $svg).attr('style', "stroke: #6666ff; stroke-width: 1px; marker-start: url(#htBg);")
$(this).addClass("CatSelected");
htStatus = "clz";
}
else{$(".htrsr", $svg).attr('style', "fill:"+"#FFF");
$(this).removeClass("CatSelected");
htStatus = "shw";}
});
...
//$(".wild", $svg).attr('style', "");
//$(".wild", $svg).attr('style', "fill:"+"url(#wldBg);filter:"+"drop-shadow(5px 1px 0px rgb(115, 69, 0))");
$("#mGroup").hide()
$("#wGroup").attr('style', "visibility: visible"); 
$(this).addClass("CatSelected");
wStatus = "clz";
}
else{
	$("#wGroup").hide()
	$(".wild", $svg).attr('style', "fill:"+"#FFF");
$(this).removeClass("CatSelected");
wStatus = "shw";}
});
...
if(hStatus=="shw")
{
	//$(".hrtg", $svg).attr('style', "fill:"+"url(#hBg)");
			$(".hrtg", $svg).attr('style', "stroke: #6666ff; stroke-width: 1px; marker-start: url(#hBg);")
$(this).addClass("CatSelected");
hStatus = "clz";}
else{$(".hrtg", $svg).attr('style', "fill:"+"#FFF");
$(this).removeClass("CatSelected");
hStatus = "shw";}
});
