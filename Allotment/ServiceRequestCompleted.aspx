<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="ServiceRequestCompleted.aspx.cs" Inherits="Allotment.ServiceRequestCompleted" %>
...
<%--    <asp:BoundField  ItemStyle-BorderWidth="0" DataField="ALERTMESSAGE" />  --%>
 ...
 <asp:BoundField DataField="CompletedIn" ItemStyle-HorizontalAlign="Justify" HeaderText="Approved On" SortExpression="CompletedIn" />
          ...
          <div class="clearfix"></div>
                ...
                <asp:View runat="server" ID="AmalgamationView">
                       <div class="table-responsive" style="max-height:300px;overflow-y:auto;">
                    <asp:GridView ID="GridView4" runat="server" ClientIDMode="Static"
                     CssClass="table table-striped table-bordered table-hover request-table request-table"
                     AutoGenerateColumns="False"
                     DataKeyNames="ServiceRequestNO,UnitID"
                     GridLines="Horizontal"
                 ...
                 <asp:BoundField DataField="CompletedOn" HeaderText="Approval Date" SortExpression="CompletedOn"  DataFormatString="{0:dd-M-yyyy}" />
                             ...
                             <asp:TemplateField HeaderText="View">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:HyperLink runat="server" ID="Hyper1" Target="_blank" NavigateUrl='<%# string.Format("~/SignedLetterView.aspx?ServiceRequestNo={0}&DocType=AmalgamationPostAllotment",HttpUtility.UrlEncode(Eval("ServiceRequestNO").ToString())) %>'  Text ='<i class="fa fa-eye" aria-hidden="true"></i>' > </asp:HyperLink>
                                    </ItemTemplate>
                            </asp:TemplateField>
                      ...
                      <asp:GridView ID="Grid_PostSubDivision" runat="server"
                          ...
                          <Columns>
                             ...
                             <%-- <asp:BoundField DataField="LastObjectionDate" HeaderText="Objection Last Date" DataFormatString="{0:dd-M-yyyy}" />--%>
                               ...
                               <asp:BoundField DataField="CompletedOn" HeaderText="Approve Date" DataFormatString="{0:dd-M-yyyy}" />
