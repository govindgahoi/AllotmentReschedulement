<%@ Page Title="" Language="C#" MasterPageFile="~/MainUserHO.Master" AutoEventWireup="true" CodeBehind="ServiceRequestCompletedApp.aspx.cs" Inherits="Allotment.ServiceRequestCompletedApp" %>
...
<%--    <asp:BoundField  ItemStyle-BorderWidth="0" DataField="ALERTMESSAGE" />  --%>
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                <asp:TemplateField HeaderText="Number" HeaderStyle-HorizontalAlign="Center">
                 ...
                 <ASP:HYPERLINKFIELD text="View" datanavigateurlfields="ServiceRequestNO" datanavigateurlformatstring="NewAssessmentUnderProcessApp.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
                ...
                <asp:BoundField DataField="PlotNo" HeaderText="Allotted Plot No" SortExpression="PlotNo" />

                 <asp:BoundField DataField="PlotSize" HeaderText="Allotted Plot Size" SortExpression="PlotSize" />
 ...
 <asp:BoundField DataField="CompletedIn" ItemStyle-HorizontalAlign="Justify" HeaderText="Completed In (Days)" SortExpression="CompletedIn" />
                             ...
                             <asp:TemplateField HeaderText="View">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:HyperLink runat="server" ID="Hyper2" Target="_blank" NavigateUrl='<%# string.Format("~/SignedLetterView.aspx?ServiceRequestNo={0}&DocType=Allotment",HttpUtility.UrlEncode(Eval("ServiceRequestNO").ToString())) %>'  Text ='<i class="fa fa-eye" aria-hidden="true"></i>' > </asp:HyperLink>
                                    </ItemTemplate>
                            </asp:TemplateField>
         ...
         ClientIDMode="Static"
            ...
            <Columns>
                <asp:TemplateField HeaderText="Number" HeaderStyle-HorizontalAlign="Center">
                 ...
                 <ASP:HYPERLINKFIELD text="View" datanavigateurlfields="ServiceRequestNO" datanavigateurlformatstring="BuildingPlanAssessmentViewApp.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
           ...
           <asp:BoundField DataField="AllotteeName" HeaderText="Allottee Name" SortExpression="AllotteeName" />
                ...
                <asp:BoundField DataField="ServiceRequestActivity" ItemStyle-HorizontalAlign="Justify" HeaderText="Request Regarding" SortExpression="ServiceRequestActivity" />
                 <asp:BoundField DataField="CompletedOn" HeaderText="Approval Date" SortExpression="CompletedOn"  DataFormatString="{0:dd-M-yyyy}" />
                             ...
                             <asp:TemplateField HeaderText="View">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:HyperLink runat="server" ID="Hyper1" Target="_blank" NavigateUrl='<%# string.Format("~/SignedLetterView.aspx?ServiceRequestNo={0}&DocType=BuildingPlan",HttpUtility.UrlEncode(Eval("ServiceRequestNO").ToString())) %>'  Text ='<i class="fa fa-eye" aria-hidden="true"></i>' > </asp:HyperLink>
                                    </ItemTemplate>
                            </asp:TemplateField>
        ...
        <asp:GridView ID="GridView3" runat="server"
            ...
            <Columns>
                <asp:TemplateField HeaderText="Number" HeaderStyle-HorizontalAlign="Center">
                 ...
                 <ASP:HYPERLINKFIELD text="View" datanavigateurlfields="ServiceRequestNO" Target="_blank" datanavigateurlformatstring="BPServiceRequestInbox.aspx?serviceId={0}"></ASP:HYPERLINKFIELD>  
           ...
           <asp:BoundField DataField="AllotteeName" HeaderText="Allottee Name" SortExpression="AllotteeName" />
                 ...
                 <asp:BoundField DataField="CompletedOn" HeaderText="Approval Date" SortExpression="CompletedOn"  DataFormatString="{0:dd-M-yyyy}" />
                             ...
                             <asp:TemplateField HeaderText="View">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:HyperLink runat="server" ID="Hyper1" Target="_blank" NavigateUrl='<%# string.Format("~/SignedLetterView.aspx?ServiceRequestNo={0}&DocType=Transfer",HttpUtility.UrlEncode(Eval("ServiceRequestNO").ToString())) %>'  Text ='<i class="fa fa-eye" aria-hidden="true"></i>' > </asp:HyperLink>
                                    </ItemTemplate>
                            </asp:TemplateField>
                ...
                <%--<asp:TemplateField HeaderText="Upload Your Signed Document" ItemStyle-HorizontalAlign="Center" >
                                        <ItemTemplate>
                                             <asp:HyperLink runat="server" ID="Hyper1" Target="_blank" NavigateUrl='<%# string.Format("~/UploadSignedCopy.aspx?ServiceReqNo={0}&Type=TR",HttpUtility.UrlEncode(Eval("ServiceRequestNO").ToString())) %>'  Text ='<i class="fa fa-pencil-square-o" aria-hidden="true"></i>' > </asp:HyperLink>
                                </ItemTemplate></asp:TemplateField>--%>
            </Columns>
            <EmptyDataTemplate>
                No Record Available
