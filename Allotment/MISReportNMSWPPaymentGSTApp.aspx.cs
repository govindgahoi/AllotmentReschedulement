...
namespace UpsidcApi
{
    public partial class MISReportNMSWPPaymentGST : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (token != string.Empty && RegionalOffice != string.Empty )//&& token == "345623-JJJJGGFFD-JHK6544")
            {
                try
                {
      ...
      public void  BindServiceRequestGrid()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[sp_NMSWPFeeReceivedAllApplicationWithGST]";
