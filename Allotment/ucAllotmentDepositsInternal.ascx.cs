...
namespace Allotment
{
    public partial class ucAllotmentDepositsInternal : System.Web.UI.UserControl
    {
        ...
        public void BindApplicableFees()
        {
            ...
            try
            {
                ...
                objServiceTimelinesBEL.PlotNo = PlotNumber;
                ...
                {
                    objServiceTimelinesBEL.choicearea = choicearea;
                    dschoicearea = objServiceTimelinesBLL.GetapplicableChargesnDataforAllotmentInternal(objServiceTimelinesBEL);
                }
                if (!string.IsNullOrEmpty(Convert.ToString(choiceP1)))
                {
                    objServiceTimelinesBEL.choicearea = choiceareap1;
                    dschoiceP1 = objServiceTimelinesBLL.GetapplicableChargesnDataforAllotmentInternal(objServiceTimelinesBEL);
                }
                if (!string.IsNullOrEmpty(Convert.ToString(choiceP2)))
                {
                    objServiceTimelinesBEL.choicearea = choiceareap2;
                    dschoiceP2 = objServiceTimelinesBLL.GetapplicableChargesnDataforAllotmentInternal(objServiceTimelinesBEL);
                }
                if (!string.IsNullOrEmpty(Convert.ToString(choiceP3)))
                {
                    objServiceTimelinesBEL.choicearea = choiceareap3;
                    dschoiceP3 = objServiceTimelinesBLL.GetapplicableChargesnDataforAllotmentInternal(objServiceTimelinesBEL);
                }
