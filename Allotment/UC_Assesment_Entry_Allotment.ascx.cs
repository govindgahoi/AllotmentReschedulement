...
namespace Allotment
{
    public partial class UC_Assesment_Entry_Allotment : System.Web.UI.UserControl
    {
        ...
        protected void Get_Data_FromApplicantEntry()
        {
            ...
            if (dt_project.Rows.Count > 0)
            {
                ...
                txtland_lbl.Text = dt_project.Rows[0]["LandDetails"].ToString();
                ...
                txtNetWorth_lbl.Text = dt_project.Rows[0]["NetTurnOver"].ToString().Trim();
        ...
        protected void Get_EvaluationCheckListData_ForPacketApplicant()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Get_ServiceTicketChecklistAllotment '" + PacketId + "' , '" + ServiceReqNo + "'  ", con);
        ...
        protected void Set_EvaluationCheckListData_ForPacketApplicant(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox1.ShowInfo("Please Select Priority Category");
                    return;
                }



                command = new SqlCommand(@"Set_ServiceTicketChecklistAllotment", con, transaction);
                command.CommandType = CommandType.StoredProcedure;

                command.Parameters.AddWithValue("@UserId", UserId);
                command.Parameters.AddWithValue("@packetId", PacketId);
