<%@ Page Title="" Language="C#"  ValidateRequest="false"  MasterPageFile="~/MainUserHO.Master"  EnableViewState="true" CodeBehind="LAWAssessmentProcess2.aspx.cs" Inherits="Allotment.LAWAssessmentProcess2" %>

<%@ Register Assembly="ProudMonkey.Common.Controls" Namespace="ProudMonkey.Common.Controls" TagPrefix="cc1" %>

<%@ Register Src="~/UC_ApplicationFinalViewLAW.ascx" TagPrefix="uc1" TagName="UC_ApplicationFinalViewLAW" %>
   ...
   <ContentTemplate>
	...
	<div class="row my-new-heading">
		<div class="text-center my-new-heading">
           ...
           <span class="col-md-2 col-sm-2 col-xs-2"> <asp:Button ID="btnPrint" runat="server" Text="Print" Style="margin: 6px 2px;display:block;margin-top: -4px;padding: 6px 13px 3px 14px;" CssClass="btn-primary btn-sm ey-bg pull-right" />
			</span>
		</div>
	</div>
