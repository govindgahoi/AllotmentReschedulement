...
namespace Allotment
{
    public partial class ServiceRequestUnderProcessLeaseDeed : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGridViewLeaseDeed()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfLeaseDeedUnderProcess(objServiceTimelinesBEL);
