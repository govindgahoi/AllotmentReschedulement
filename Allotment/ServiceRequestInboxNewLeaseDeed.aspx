<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="ServiceRequestInboxNewLeaseDeed.aspx.cs" Inherits="Allotment.ServiceRequestInboxNewLeaseDeed" %>
   ...
   <div class="clearfix"></div>
    ...
    <div class="bg-mywhite table-divinbox">
       ...
       <asp:GridView ID="GridView1" runat="server"
        ...
        <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="ServiceRequestNO"  datanavigateurlformatstring="LeaseDeedAssessment.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
      <asp:BoundField DataField="IAName" HeaderText="IA Name" SortExpression="IAName" />
                ...
                <asp:BoundField DataField="Currents" ItemStyle-HorizontalAlign="Justify" HeaderText="Pending Status" SortExpression="Currents" />
