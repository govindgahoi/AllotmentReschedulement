		...
		<div class="col-md-12 col-sm-12 col-xs-12" style="padding: 0;">
			<div class="panel panel-default" style="position: relative; min-height: 80%;">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="border: 1px solid #c5c506; margin: 6px 0 0 0px; padding: 2px 0;" >
                    <span class="pull-right"><asp:Button runat="server" Text="Raise Objection" id="btnClarifyM" OnClick="btnClarifyM_Click" class="btn-warning" Visible="false" />&nbsp;<asp:Button runat="server" Text="Reject Application" id="btnRejectM" CssClass="btn-danger" OnClick="btnRejectM_Click" Visible="false"  />&nbsp;<asp:Button runat="server" Text="Approve & Issue Letter" id="btnApprove" class="btn-success" Visible="false" onclick="btnApprove_Click" /></span>
                </div>
