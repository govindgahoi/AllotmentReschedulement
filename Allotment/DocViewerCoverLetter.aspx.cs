...
namespace Allotment
{
    public partial class DocViewerCoverLetter : System.Web.UI.Page
    {
        ...
        private void ViewDoc()
        {
            ...
            if (dtDoc.Rows.Count > 0)
            {
                ...
                ltEmbed.Text = string.Format(embed, ResolveUrl("/DocViewerCoverLetter.ashx?ServiceRequestNO=" + ServiceReqNo.Trim() + ""));
