<%@ Page Title="" Language="C#" MasterPageFile="~/MainUserHO.Master" AutoEventWireup="true" CodeBehind="ServiceRequestUnderProcess_CMIA.aspx.cs" Inherits="Allotment.ServiceRequestUnderProcess_CMIA" %>
...
<%--    <asp:BoundField  ItemStyle-BorderWidth="0" DataField="ALERTMESSAGE" />  --%>
  ...
  <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:HyperLink runat="server" ID="Hyper1" Target="_blank" NavigateUrl='<%# string.Format("~/NewAssessmentUnderProcessApp.aspx?ServiceReqNo={0}",HttpUtility.UrlEncode(Eval("ServiceRequestNO").ToString())) %>' Text='<%# Eval("ServiceRequestNO").ToString()%>'> </asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
        ...
        <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="ServiceRequestNO"  datanavigateurlformatstring="BuildingPlanAssessmentViewCMIA.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
                ...
                <asp:BoundField DataField="UnitId" HeaderText="Nivesh Mitra ID" SortExpression="UnitId" />
                 ...
                 <asp:BoundField DataField="ApplicationDate" ItemStyle-Wrap="false" DataFormatString="{0:dd-M-yyyy}" HeaderStyle-CssClass="text-center-imp" HeaderText="Application Date" SortExpression="ObjectionDate" ItemStyle-Width="5%"/>
