<%@ Page Title="" Language="C#" ValidateRequest="false" MasterPageFile="~/MainUser.Master" EnableViewState="true" CodeBehind="PIPFINAssessmentProcess.aspx.cs" Inherits="Allotment.PIPFINAssessmentProcess" %>
        ...
        <ContentTemplate>
            ...
            <div class="row my-new-heading">
                <div class="text-center my-new-heading">
                    <span class="col-md-2 col-sm-4 col-xs-6" style="padding-left: 0px !important; padding-right: 2px !important;"></span>

                    <span class="col-md-8 col-sm-8 col-xs-8">Assessment Sheet
                    </span>

                    <span class="col-md-2 col-sm-2 col-xs-2">
                        <asp:Button ID="btnPrint1" runat="server" Text="Print" Style="margin: 6px 2px; display: block; margin-top: -4px; padding: 6px 13px 3px 14px;" CssClass="btn-primary btn-sm ey-bg pull-right" OnClientClick='PrintElem();' />
                    </span>
                </div>
            </div>
