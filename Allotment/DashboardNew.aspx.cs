...
namespace Allotment
{
    public partial class DashboardNew : System.Web.UI.Page
    {
        ...
        private void bind()
        {
            UC_Pendecy_Report UC_Pendecy_Report = LoadControl("~/UC_Pendecy_Report.ascx") as UC_Pendecy_Report;
            UC_Pendecy_Report.RPType = "LA";
            ph.Controls.Add(UC_Pendecy_Report);
        }
        private void bind2()
        {
            UC_Pendecy_Report UC_Pendecy_Report = LoadControl("~/UC_Pendecy_Report.ascx") as UC_Pendecy_Report;
            UC_Pendecy_Report.RPType = "BP";
            ph1.Controls.Add(UC_Pendecy_Report);
        }
