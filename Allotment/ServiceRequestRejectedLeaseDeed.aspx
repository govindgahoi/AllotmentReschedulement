<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="ServiceRequestRejectedLeaseDeed.aspx.cs" Inherits="Allotment.ServiceRequestRejectedLeaseDeed" %>
   ...
   <div class="clearfix"></div>
    ...
    <div class="bg-mywhite table-divinbox">
       ...
       <asp:GridView ID="GridView1" runat="server"
        ...
        <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="ServiceRequestNO"  datanavigateurlformatstring="LeaseDeedAssessmentView.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
                ...
                <asp:BoundField DataField="RejectOn" HeaderText="Rejected On" DataFormatString="{0:dd-M-yyyy}" />
