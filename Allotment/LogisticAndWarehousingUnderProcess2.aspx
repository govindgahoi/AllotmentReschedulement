<%@ Page Title="" Language="C#" MasterPageFile="~/MainUserHO.Master" AutoEventWireup="true" CodeBehind="LogisticAndWarehousingUnderProcess2.aspx.cs" Inherits="Allotment.LogisticAndWarehousingUnderProcess2" %>
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                ...
                <ASP:HYPERLINKFIELD text="View" datanavigateurlfields="ServiceRequestNo"  datanavigateurlformatstring="LAWAssessmentProcess2.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
