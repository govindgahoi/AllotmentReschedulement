<%@ Page Title="" Language="C#" CodeBehind="UserDashboardReport.aspx.cs" Inherits="Allotment.UserDashboardReport" EnableEventValidation="false" %>
            ...
            <ContentTemplate>--%>
                ...
                <div class="panel panel-default">
                    <div class="" style="border: 1px solid #cccccc; margin-bottom: 8px; background: #fdfdfd;" runat="server" id="BannerDiv">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12 right-niveshban">
                                <ul class="mylogo-ul list-inline pull-right" style="margin: 0; padding: 6px 0 9px 1px;">
                                    <li>
                    ...
                    <div class="panel-heading font-bold text-center" style="font-size: 14px !important; font-weight: 600; background: #2d2d2d; color: #ffc511 !important;">
                        <asp:Label runat="server" ID="PageHeadingLbl"></asp:Label></div>
                </div>
                    <div class="clearfix"></div>
                <div style="background: #eaeaea;">
                    <asp:Button ID="btnprint" class="btn-primary ey-bg pull-right" style="margin:8px 9px 9px 0;" runat="server" Text="Print" OnClick="btnprint_Click"/>
                    <div class="clearfix"></div>
                </div>
                <div class="bg-mywhite table-divinbox table border_none request-table-col">
                    ...
                    <div style="overflow-x: auto; overflow-y: auto; max-height: 1100px;">
                        <div class="col-md-12" style="padding: 0px;" runat="server" id="Print"> 
