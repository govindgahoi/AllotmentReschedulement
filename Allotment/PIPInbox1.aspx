<%@ Page Title="" Language="C#" MasterPageFile="~/MainUserOD.Master" AutoEventWireup="true" CodeBehind="PIPInbox1.aspx.cs" Inherits="Allotment.PIPInbox1" %>
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                ...
                <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="ServiceRequestNo"  datanavigateurlformatstring="PIPAssessment1.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
