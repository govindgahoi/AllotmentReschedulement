...
namespace Allotment
{
    public partial class IAServicesAssessmentApp : System.Web.UI.Page
    {
                ...
                case "4":
                    {
                        ...
                        if (Level == "RM" || Level == "JE"||Level == "CMIA" || Level == "MD" || Level == "JMD")
                        {
        ...
        protected void load_UC(string AllOrFirst)
        {
            ...
            if (Menu_Type == "page")
            {
                ...
                if (Menu_Value1 == "SecondchargeApplicant_Detail")
                {
                    ...
                    UC_ApplicationFinalViewSecondchargeService.ControlID = SWCUnitID;
