<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="ServiceRequestCompletedPossession.aspx.cs" Inherits="Allotment.ServiceRequestCompletedPossession" %>
   ...
   <div class="clearfix"></div>
    ...
    <div class="bg-mywhite table-divinbox">
       ...
       <asp:GridView ID="GridView1" runat="server"
        ...
        <ASP:HYPERLINKFIELD text="View" datanavigateurlfields="ServiceRequestNO"  datanavigateurlformatstring="PossessionAssessmentView.aspx?ServiceReqNo={0}"></ASP:HYPERLINKFIELD>  
                ...
                <asp:BoundField DataField="AppRecDate" HeaderText="Application Date" DataFormatString="{0:dd-M-yyyy}" />
                ...
                <asp:BoundField DataField="ServiceRequestActivityFor" ItemStyle-HorizontalAlign="Justify" HeaderText="Request Regarding" SortExpression="ServiceRequestActivity" />
