<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" Debug="true" CodeBehind="ServiceApplicableChargeMaster.aspx.cs"
    Inherits="Allotment.ServiceApplicableChargeMaster" MaintainScrollPositionOnPostback="true" %>
...
<div class="">
    ...
    <asp:Label ID="RateIdlbl" runat="server" ></asp:Label>
      <div class="panel">
                        <div class="panel-heading font-bold" style="text-align:center;">
                          Service Applicable Charge Master                          
                        </div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10 col-sm-12">
                                                        <asp:DropDownList ID="IaDdl" runat="server"  CssClass="input-sm dropdown-toggle similar-select1" OnSelectedIndexChanged="IaDdl_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                            <hr class="myhrline" />
                                             <div class="form-group">
                                                 <div class="row">
                                                    ...
                                                    <div class="col-md-10 col-sm-12">
                                                          <asp:DropDownList ID="ServiceDropDown" runat="server"  CssClass="input-sm dropdown-toggle similar-select1" AutoPostBack="true" OnSelectedIndexChanged="ServiceDropDown_SelectedIndexChanged"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                            <hr class="myhrline" />
                                             <div class="form-group">
                                                 <div class="row">
                                                    ...
                                                    <div class="col-md-10 col-sm-12">
                                                          <asp:DropDownList ID="PaymentCategoryDropDown" runat="server"  CssClass="input-sm dropdown-toggle similar-select1" AutoPostBack="true" OnSelectedIndexChanged="PaymentCategoryDropDown_SelectedIndexChanged"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10 col-sm-12">
                                                        <asp:TextBox ID="txtApplicableCharge" runat="server" CssClass="input-sm similar-select1" onkeypress="return isDecimalKey(event);"  ></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                     ...
                     <div class="clearfix"></div>
                                    <div class="panel-heading">
                                        <div class="col-md-4" style="margin-top:12px;">
                                            <b>Existing Applicable Charge</b>
                                        </div>
                                        <div class="input-group col-md-8 col-sm-12 text-right" style="padding:2px;">
                                          <asp:TextBox ID="txtSearch" Width="200px" CssClass="similar-select input-sm" runat="server" AutoPostBack="true" OnTextChanged="txtSearch_TextChanged1"    />
                        ...
                        <asp:GridView ID="IARateGrid" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" AllowPaging="true" PageSize="20" CssClass="table table-striped table-bordered table-hover request-table" 
                           PagerStyle-CssClass="pagination-ys" PagerStyle-HorizontalAlign="Right" OnRowCommand="IARateGrid_RowCommand" OnPageIndexChanging="IARateGrid_PageIndexChanging" >
                            <Columns>
                                ...
                                <asp:BoundField DataField="Description" HeaderText="Payment Category" SortExpression="Description" />
                                <asp:BoundField DataField="ApplicableCharge" HeaderText="Applicable Charge" SortExpression="ApplicableCharge" /> 
                             
                                
                                <asp:BoundField DataField="EffectiveFromDate" HeaderText="EffectiveFromDate" SortExpression="EffectiveFromDate" DataFormatString="{0:dd-MMM-yyyy}" />
