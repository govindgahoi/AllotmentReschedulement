...
namespace Allotment
{
    public partial class ServiceRequestUnderObjection : System.Web.UI.Page
    {
        ...
        private void BindServiceRequestGridView()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfBuildingPlanUnderObjection(objServiceTimelinesBEL);
        ...
        private void Bind_Announcement_List_GridView()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationForClarfication(objServiceTimelinesBEL);
        ...
        private void BindServiceRequestGridViewTransfer()
        {
            ...
            try
            {
                ...
                LoginInfo _objLoginInfo = (LoginInfo)Session["objLoginInfo"];
                objServiceTimelinesBEL.UserName = _objLoginInfo.userName;
                ds = objServiceTimelinesBLL.GetApplicationOfTransferUnderObjection(objServiceTimelinesBEL);
                if (ds.Tables[0].Rows.Count > 0)
                {
        ...
        #region Amalgamation
        protected void BindServiceRequestGridViewAmalgamation()
        {
            DataSet ds = new DataSet();
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfAmalgamationUnderObjection(objServiceTimelinesBEL);
                if (ds.Tables[0].Rows.Count > 0)
                {
        ...
        private void BindServiceRequestGridViewSubdividion()
        {
            ...
            try
            {
                ...
                ds = objServiceTimelinesBLL.GetApplicationOfSubDivisionPostAllotmentUnderObjection(objServiceTimelinesBEL);
                if (ds.Tables[0].Rows.Count > 0)
                {
