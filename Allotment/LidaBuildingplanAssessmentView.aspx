<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="true" MasterPageFile="~/MainLidaUser.Master"  CodeBehind="LidaBuildingplanAssessmentView.aspx.cs" Inherits="Allotment.LidaBuildingplanAssessmentView" %>

<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LidaBuildingPlanAssessment.aspx.cs" Inherits="Allotment.LidaBuildingPlanAssessment" %>--%>

<%--<%@ Page Title="" Language="C#"  ValidateRequest="false"  MasterPageFile="~/MainLidaUser.Master"  EnableViewState="true" CodeBehind="LidaBuildingPlanAssessment.aspx.cs" Inherits="Allotment.LidaBuildingPlanAssessment" %>--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <ContentTemplate>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="pull-right border-buttons">
                        ...
                        <asp:Button runat="server" Text="Reject" class="btn btn-primary btn-popup" style="margin-right: 0;"  OnClick="btnReject_Click" OnClientClick="return confirm('Do you want to reject this application?');" ID="btnReject" /><button type="button" class="btn btn-primary btn-popup" data-dismiss="modal" style="margin-right: 0;">Cancel</button>
                    </div>
                </div>
            </div>
        </div>
       ...
       <style>
           #ClarificationModal .modal-header{
                padding: 2px 7px;
                font-size: 11px;
                background: #565656;
                color: #fff;
            ...
            #ClarificationModal .modal-header h4.modal-title {
                font-size: 16px; 
            }
            #ClarificationModal .modal-header .close {
                color:#fff;
            }
           #ClarificationModal .modal-footer {
            padding:0;
           }
           #RejectionModal .modal-header{
            ...
            #RejectionModal .modal-header h4.modal-title {
                font-size: 16px; 
            }
            #RejectionModal .modal-header .close {
                color:#fff;
            }
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Clarification From Applicant</h4>
                </div>
                <div class="modal-body" >
     ...
     <div class="clearfix"></div>
                    <div class="col-md-12" style="font-size: 12px; padding: 4px 15px;">
                        <asp:TextBox runat="server" ID="txtClarification" CssClass="input-sm similar-select1 margin-left-z" placeholder="Enter Clarification Required From Applicant" TextMode="MultiLine" Height="250px" MaxLength="450"></asp:TextBox>
                ...
                <div class="modal-footer">
                    <div class="pull-right border-buttons">
                        ...
                        <%--<asp:Button runat="server" Text="Raise Objection" class="btn btn-primary btn-popup" style="margin-right: 0;"  OnClick="btnClarify_Click"  OnClientClick="return confirm('Do you want to raise objection to allottee?');" ID="btnClarify" />--%><button type="button" class="btn btn-primary btn-popup" data-dismiss="modal" style="margin-right: 0;">Cancel</button>
                    </div>
                </div>
            </div>
        </div>
	...
	<div class="row my-new-heading">
		<div class="text-center my-new-heading">
			<span class="col-md-2 col-sm-4 col-xs-6" style="padding-left: 0px !important; padding-right: 2px !important;">
               <asp:Button ID="Button1" runat="server" Text="Go Back" Style="margin: 6px 126px;display:block;margin-top: -4px;padding: 6px 13px 3px 14px;"  CssClass="btn-primary btn-sm ey-bg pull-right" PostBackUrl="~/LidaServiceRequestNew.aspx" />
		...
		<div class="col-md-12 col-sm-12 col-xs-12" style="padding: 0;">
			<div class="panel panel-default" style="position: relative; min-height: 80%;">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="border: 1px solid #c5c506; margin: 6px 0 0 0px; padding: 2px 0;" >
                    <span class="pull-right"><%--<asp:Button runat="server" Text="Raise Objection" id="btnClarifyM" OnClick="btnClarifyM_Click" class="btn-warning" Visible="false" />--%>
                        &nbsp;<asp:Button runat="server" Text="Reject Application" id="btnRejectM" CssClass="btn-danger" OnClick="btnRejectM_Click" Visible="false"  />&nbsp;<asp:Button runat="server" Text="Approve & Issue Letter" id="btnApprove" class="btn-success" Visible="false" onclick="btnApprove_Click" /></span>
                </div>
...
<asp:HiddenField ID="hid" runat="server" />
    ...
    <script type='text/javascript'>
        ...
        function MessageAndRedirect(par) {
            alert(par);
            window.location.href = 'LidaServiceRequestNew.aspx';
        }
