<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_TransferLAWApplication.ascx.cs" Inherits="Allotment.UC_TransferLAWApplication" %>
...
<div class="form-group">
                ...
                <hr class="myhrline" />
                 ...
                 <span class="pull-right"><asp:Button runat="server" Text="Forward" id="btnSend" class="btn-primary btn-sm margin-left-z" style="margin: 7px 10px;" OnClientClick="javascript:return confirm('Please Check the data before transferring application');" OnClick="btnSend_Click"/></span>
