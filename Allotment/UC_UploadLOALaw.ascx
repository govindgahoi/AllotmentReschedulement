<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_UploadLOALaw.ascx.cs" Inherits="Allotment.UC_UploadLOALaw" %>
        ...
        <div class="col-md-10 col-sm-6 col-xs-6">
             <asp:DropDownList ID="ddlLetterType" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="ddlLetterType_SelectedIndexChanged"  CssClass="margin-left-z input-sm similar-select1" >
                                                                                                 <asp:ListItem>--Select--</asp:ListItem>
                                                                                                   <asp:ListItem Value="1">Issue LOC</asp:ListItem>
...
<div class="form-group" id="resontab" runat="server" visible="false" >
    <label class="col-md-2 col-sm-6 col-xs-6 text-right">Please Choose Reason Details</label>
