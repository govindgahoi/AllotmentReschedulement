<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IAServicesApplication.aspx.cs" Inherits="Allotment.IAServicesApplication" %>
                                        ...
                                        <div class="col-md-2 pad-rt0 pad-rt0">
                                            ...
                                            <asp:Menu
                                                ...
                                                <Items>
                                                    ...
                                                    <asp:MenuItem Text="Accounts Details" Value="10" />
                                                    ...
                                                    <div class="panel panel-default">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <p>
                                                                            <b>
                                                                                <asp:Label ID="lblHead" runat="server" Text="Specification Of Constructed Building For Which Completion Certificate Is Requested"></asp:Label></b>
                                                                        </p>
                                                                    </div>
                                                        ...
                                                        <div class="panel-body ">
                                                            ...
                                                            <div class="table-responsive">
                                                                ...
                                                                <table class="table table-bordered table-hover request-table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">
                                                                                <asp:TextBox ID="txtMumti" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server" ssss></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                ...
                                                                <div>
                                                                    <asp:Button runat="server" Text="Save & Finalise" ID="btnSaveF" CssClass="btn-primary ey-bg" Style="float: right; margin: 8px 0;" OnClick="btnFar_Click" />
                                                                </div>
                                                                <div class="clearfix"></div>
                                                                <hr class="myhrline" />
                                                                ...
                                                                <table class="table table-bordered table-hover request-table" id="datatableService">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox1" CssClass="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><span style="color: Red">* </span>Ground Coverage (in Percentage)</td>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox2" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><span style="color: Red">* </span>Total Covered Area (in SqrMts)</td>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox3" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><span style="color: Red">* </span>Height(In mts)</td>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox4" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="3" style="text-align: left;"><span style="color: Red">* </span>Set Back(In mts)</td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox5" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right;"><span style="color: Red">* </span>Rear
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox6" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right;"><span style="color: Red">* </span>Side1</td>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox7" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right;"><span style="color: Red">* </span>Side2</td>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox8" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="3" style="text-align: left;"><span style="color: Red">* </span>Classification of Indiustries Based on Degree of Hazard</td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">
                                                                                ...
                                                                                <asp:DropDownList ID="DropDownList1" runat="server" Style="width: 100% !important" CssClass="chosen btn btn-default dropdown-toggle input-sm mynewselect">
                                                                                </asp:DropDownList>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">
                                                                                ...
                                                                                <asp:TextBox ID="TextBox9" CssClass="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                ...
                                                                <table class="table table-bordered table-hover request-table">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>BaseMent(in Sqmts)</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox10" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server" Text=''></asp:TextBox>
                                                                            </td>
                                                                            <td style="display: none;">
                                                                                <asp:TextBox ID="TextBox11" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server" Text=''></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Ground Floor(in Sqmts)</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox12" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server" Text=''></asp:TextBox>
                                                                            </td>
                                                                            <td style="display: none;">
                                                                                <asp:TextBox ID="TextBox13" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server" Text=''></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>First Floor(in Sqmts)</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox14" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server" Text=''></asp:TextBox>
                                                                            </td>
                                                                            <td style="display: none;">
                                                                                <asp:TextBox ID="TextBox15" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server" Text=''></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Second Floor(in Sqmts)</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox16" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server" Text=''></asp:TextBox>
                                                                            </td>
                                                                            <td style="display: none;">
                                                                                <asp:TextBox ID="TextBox17" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server" Text=''></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: left;">Mezzanine Floor(in Sqmts)</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox18" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server" Text=''></asp:TextBox>
                                                                            </td>
                                                                            <td style="display: none;">
                                                                                <asp:TextBox ID="TextBox19" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server" Text=''></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: left;">Stilt Floor(in Sqmts)</td>
                                                                            ...
                                                                            <td colspan="2">
                                                                                <asp:TextBox ID="TextBox20" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: left;">Mumti(in Sqmts)</td>
                                                                            ...
                                                                            <td colspan="2">
                                                                                <asp:TextBox ID="TextBox21" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                <table class="table table-bordered table-hover request-table" id="datatableService2">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox22" class="input-sm myyellowbgsmall" runat="server" Text=''></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: left;" colspan="2"><b>Construction Specification</b></td>
                                                                        ...
                                                                        <tr>
                                                                            <td style="text-align: right;">Foundation</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox23" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right;">Walls</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox24" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right;">Floors</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox25" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right;">Roofs</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox26" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right;">Number of storeys</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox27" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right;">Number of latrines</td>
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox28" onkeypress="return isDecimalKey(event);" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right;">Any Previous Construction </td>
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox29" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right;">Source of Water for Building Purpose </td>
                                                                            <td>
                                                                                <asp:TextBox ID="TextBox30" class="input-sm myyellowbgsmall" runat="server"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
