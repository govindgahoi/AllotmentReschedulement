<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="PIPRejected.aspx.cs" Inherits="Allotment.PIPRejected" %>
        ...
        <div class="">
          ...
          <asp:MultiView runat="server" ID="ApplicationView">
            ...
            <Columns>
                ...
                <asp:BoundField DataField = "RejectedOn"       HeaderText = "Rejection Date"       DataFormatString="{0:dd-M-yyyy}" />      
