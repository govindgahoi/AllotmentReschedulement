<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_Document_Report_VG_TEF_Provisional.ascx.cs" Inherits="Allotment.UC_Document_Report_VG_TEF_Provisional" %>
...
<div runat="server" class="row" style="border: 1px solid #c5c506;background: #e4e4e4; margin: 6px 0 0 0px; padding: 2px 0;">
    ...
    <div class="col-md-8 col-sm-8 col-xs-8 hidden"  >
