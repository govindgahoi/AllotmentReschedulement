...
namespace Allotment
{
    public partial class PIPFINAssessmentProcess : System.Web.UI.Page
    {
        ...
        protected void MenuMaker()
        {
            ...
            try
            {
                ...
                DataSet dsAprrovefinal = new DataSet();
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    //string OutStatus = dt.Rows[0]["OutStatus"].ToString();
                    ...
                    if (Convert.ToString(Session["UserName"]) == "KN_Srivastava")
                    {
                        ...
                        dsAprrovefinal = objMbal.CheckIssueletter(objServiceTimelinesBEL);
                        DataTable dt1 = dsAprrovefinal.Tables[0];

                        if (dt1.Rows.Count > 0)
                        {
                            string OutStatus = dt1.Rows[0]["OutStatus"].ToString();
                            if (OutStatus == "Approve")
                            {
