...
namespace Allotment
{
    public partial class RegistrationLogistics : System.Web.UI.Page
    {
        ...
        public void fetchRecordfromdb()
        {
            try
            {
                ...
                {
                    checkQuery = "select * from ServiceRequests where NMRequestID = @RequestID and NMControlID = @ControlID";
                }
                else
                {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        ApplicationID = dt.Rows[i]["ServiceRequestNO"].ToString();
                    }
