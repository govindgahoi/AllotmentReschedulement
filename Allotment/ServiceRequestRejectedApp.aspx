<%@ Page Title="" Language="C#" MasterPageFile="~/MainUserHO.Master" AutoEventWireup="true" CodeBehind="ServiceRequestRejectedApp.aspx.cs" Inherits="Allotment.ServiceRequestRejectedApp" %>
...
<%--                <asp:TemplateField HeaderText="Upload Your Signed Document" ItemStyle-HorizontalAlign="Center" >
        ...
        <%--        <asp:TemplateField HeaderText="Upload Your Signed Document" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
             <asp:HyperLink runat="server" ID="Hyper1" Target="_blank" NavigateUrl='<%# string.Format("~/UploadSignedCopy.aspx?ServiceReqNo={0}&Type=BPR",HttpUtility.UrlEncode(Eval("ServiceRequestNO").ToString())) %>'  Text ='<i class="fa fa-pencil-square-o" aria-hidden="true"></i>' > </asp:HyperLink>
                                </ItemTemplate></asp:TemplateField>--%>
            </Columns>
            <EmptyDataTemplate>
                No Record Available
        ...
        <ASP:HYPERLINKFIELD text="Process" datanavigateurlfields="ServiceRequestNO" Target="_blank" datanavigateurlformatstring="BPServiceRequestInbox.aspx?serviceId={0}"></ASP:HYPERLINKFIELD>  
...
<%--              <asp:TemplateField HeaderText="Upload Your Signed Document" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
             <asp:HyperLink runat="server" ID="Hyper1" Target="_blank" NavigateUrl='<%# string.Format("~/UploadSignedCopy.aspx?ServiceReqNo={0}&Type=TRR",HttpUtility.UrlEncode(Eval("ServiceRequestNO").ToString())) %>'  Text ='<i class="fa fa-pencil-square-o" aria-hidden="true"></i>' > </asp:HyperLink>
                                </ItemTemplate></asp:TemplateField>--%>
            </Columns>
            <EmptyDataTemplate>
                No Record Available
