<%@ Page Title="" Language="C#" MasterPageFile="~/MainUser.Master" AutoEventWireup="true" CodeBehind="PIP_Reports.aspx.cs" Inherits="Allotment.PIP_Reports" %>
        ...
        <div class="form-group" style="background: #dadada; padding: 2px 0; margin-bottom: 3px;">
            ...
            -->
                ...
                <div class="col-md-2 col-sm-2 col-xs-12">
                    ...
                    <%--<asp:DropDownList runat="server" ID="ddlServiceType" Style="background: #fff;" CssClass="input-sm similar-select1">--%>
                        <asp:ListItem Text="Availing Financial Assitance for PIP" Value="1"></asp:ListItem>
                        <asp:ListItem Text="Issuance of Unique For PIP" Value="2"></asp:ListItem>
                ...
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <asp:DropDownList runat="server" ID="ddlService" Style="background: #fff;" CssClass="input-sm similar-select1">
                        ...
                        <asp:ListItem Text="Under Objection" Value="5"></asp:ListItem>
                        <asp:ListItem Text="Pending Beyond SLA" Value="6"></asp:ListItem>
                    </asp:DropDownList>
                </div>
